...
/**
 * API tests for TaxRetentionsApi
 */
@Disabled
public class TaxRetentionsApiTest {

    private static TaxRetentionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TaxRetentionsApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        TaxRetentions response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String linkIn = null;
        TaxRetentionsPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String dateTo = null;
        EnumTaxRetentionType type = null;
        Boolean attachXml = null;
        Boolean saveData = null;
        String omit = null;
        String fields = null;
        List<TaxRetentions> response = api.retrieve(link, dateFrom, dateTo, type)
                .attachXml(attachXml)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
