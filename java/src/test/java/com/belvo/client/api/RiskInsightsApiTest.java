...
/**
 * API tests for RiskInsightsApi
 */
@Disabled
public class RiskInsightsApiTest {

    private static RiskInsightsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new RiskInsightsApi(apiClient);
    }
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RiskInsights> response = api.completeRequest(session, link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RiskInsights> response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String idIn = null;
        String linkIn = null;
        RiskInsightsPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RiskInsights> response = api.retrieve(link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
