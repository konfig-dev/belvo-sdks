...
/**
 * API tests for EmploymentRecordsApi
 */
@Disabled
public class EmploymentRecordsApiTest {

    private static EmploymentRecordsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmploymentRecordsApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        EmploymentRecord response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        EmploymentRecordsPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<EmploymentRecord> response = api.retrieve(link)
                .attachPdf(attachPdf)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
