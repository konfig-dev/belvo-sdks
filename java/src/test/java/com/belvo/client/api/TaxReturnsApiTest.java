...
/**
 * API tests for TaxReturnsApi
 */
@Disabled
public class TaxReturnsApiTest {

    private static TaxReturnsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TaxReturnsApi(apiClient);
    }
    ...
    public void listTest() throws ApiException {
        ...
        String ejercicioLt = null;
        String ejercicioLte = null;
        String ejercicioGt = null;
        String ejercicioGte = null;
        String ejercicioRange = null;
        String tipoDeclaracion = null;
        String tipoDeclaracionIn = null;
        String linkIn = null;
    ...
    public void retrieveTest() throws ApiException {
        String omit = null;
        String fields = null;
        List<Object> response = api.retrieve()
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
