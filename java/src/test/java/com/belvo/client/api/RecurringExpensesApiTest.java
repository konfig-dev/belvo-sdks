...
/**
 * API tests for RecurringExpensesApi
 */
@Disabled
public class RecurringExpensesApiTest {

    private static RecurringExpensesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new RecurringExpensesApi(apiClient);
    }
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RecurringExpenses> response = api.completeRequest(session, link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RecurringExpenses> response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String idIn = null;
        String linkIn = null;
        RecurringExpensesPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<RecurringExpenses> response = api.retrieve(link)
                .token(token)
                .saveData(saveData)
                .dateFrom(dateFrom)
                .dateTo(dateTo)
