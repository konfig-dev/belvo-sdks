...
public class PaymentTransactionsApiTest {
    ...
    private static PaymentTransactionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PaymentTransactionsApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        UUID id = null;
        PaymentTransaction response = api.getDetails(id)
                .execute();
    ...
    public void listTest() throws ApiException {
        ...
        PaymentsTransactionsPaginatedResponse response = api.list()
                .page(page)
                .idIn(idIn)
                .createdAt(createdAt)
