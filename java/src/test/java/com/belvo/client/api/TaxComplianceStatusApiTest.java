...
/**
 * API tests for TaxComplianceStatusApi
 */
@Disabled
public class TaxComplianceStatusApiTest {

    private static TaxComplianceStatusApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TaxComplianceStatusApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        TaxComplianceStatus response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String idIn = null;
        String linkIn = null;
        TaxComplianceStatusPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        TaxComplianceStatus response = api.retrieve(link)
                .attachPdf(attachPdf)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
