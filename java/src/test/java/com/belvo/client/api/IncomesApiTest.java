...
public class IncomesApiTest {
    ...
    private static IncomesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new IncomesApi(apiClient);
    }
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<Income> response = api.completeRequest(session, link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<Income> response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String link = null;
        String linkIn = null;
        IncomesPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        UUID link = null;
        List<EnumInvoiceAllowedIncomeTypesRequest> allowedIncomeTypes = null;
        EnumIncomeMinimumConfidenceLevelRequest minimumConfidenceLevel = null;
        ...
        String omit = null;
        String fields = null;
        Income response = api.retrieve(link)
