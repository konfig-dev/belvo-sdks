...
/**
 * API tests for CategorizationApi
 */
@Disabled
public class CategorizationApiTest {

    private static CategorizationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CategorizationApi(apiClient);
    }
    ...
    public void categorizeTransactionsTest() throws ApiException {
        ...
        List<CategorizationBodyRequest> transactions = null;
        Categorization response = api.categorizeTransactions(language, transactions)
                .execute();
