...
public class TransactionsApiTest {
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<Transaction> response = api.completeRequest(session, link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        Transaction response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String fields = null;
        UUID account = null;
        String accountBalanceAvailable = null;
        String accountBalanceAvailableLt = null;
        String accountBalanceAvailableLte = null;
        String accountBalanceAvailableRange = null;
        String accountBalanceCurrent = null;
        String accountBalanceCurrentGt = null;
        String accountBalanceCurrentGte = null;
        String accountBalanceCurrentLt = null;
        String accountBalanceCurrentLte = null;
        String accountBalanceCurrentRange = null;
        String accountIn = null;
        String accountType = null;
        String accountTypeIn = null;
        String accountingDate = null;
        String accountingDateGt = null;
        String accountingDateGte = null;
        String accountingDateLt = null;
        String accountingDateLte = null;
        String accountingDateRange = null;
        String amount = null;
        ...
        String collectedAtGt = null;
        String collectedAtGte = null;
        String collectedAtLt = null;
        String collectedAtLte = null;
        String collectedAtRange = null;
        ...
        String creditCardDataBillNameIn = null;
        ...
        TransactionsPaginatedResponse response = api.list(link)
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String token = null;
        Boolean saveData = null;
        String xBelvoRequestMode = null;
        String omit = null;
        String fields = null;
        List<Transaction> response = api.retrieve(link, dateFrom, dateTo)
                .account(account)
                .token(token)
                .saveData(saveData)
