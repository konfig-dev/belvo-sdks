...
/**
 * API tests for PaymentInstitutionsApi
 */
@Disabled
public class PaymentInstitutionsApiTest {

    private static PaymentInstitutionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PaymentInstitutionsApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        UUID id = null;
        PaymentInstitution response = api.getDetails(id)
                .execute();
    ...
    public void listTest() throws ApiException {
        ...
        PaymentsInstitutionsPaginatedResponse response = api.list()
                .page(page)
                .country(country)
                .countryIn(countryIn)
                .createdAt(createdAt)
