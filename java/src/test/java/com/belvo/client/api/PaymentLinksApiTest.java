...
import com.belvo.client.model.PaymentLinkPaginatedResponse;
...
public class PaymentLinksApiTest {
    ...
    private static PaymentLinksApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PaymentLinksApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        ...
        Object response = api.getDetails(accessToken)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        String search = null;
        PaymentLinkPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .createdAt(createdAt)
