...
/**
 * API tests for TaxStatusApi
 */
@Disabled
public class TaxStatusApiTest {

    private static TaxStatusApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TaxStatusApi(apiClient);
    }
    ...
    public void listTest() throws ApiException {
        ...
        String idIn = null;
        String linkIn = null;
        TaxStatusPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        Object response = api.retrieve(link)
                .attachPdf(attachPdf)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
