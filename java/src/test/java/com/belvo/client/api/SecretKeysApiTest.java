...
import com.belvo.client.model.PaymentsRequestApiKeysResponse;
import com.belvo.client.model.SecretKeysPaginatedResponse;
...
/**
 * API tests for SecretKeysApi
 */
@Disabled
public class SecretKeysApiTest {

    private static SecretKeysApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SecretKeysApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        List<PaymentsRequestApiKeysResponse> response = api.create()
                .execute();
    ...
    public void listTest() throws ApiException {
        SecretKeysPaginatedResponse response = api.list()
                .execute();
        // TODO: test validations
    }
