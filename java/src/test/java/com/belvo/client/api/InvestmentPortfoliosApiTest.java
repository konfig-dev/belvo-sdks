...
/**
 * API tests for InvestmentPortfoliosApi
 */
@Disabled
public class InvestmentPortfoliosApiTest {

    private static InvestmentPortfoliosApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new InvestmentPortfoliosApi(apiClient);
    }
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        InvestmentsPortfolio response = api.completeRequest(session, link)
                .token(token)
                .omit(omit)
                .fields(fields)
                .execute();
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        InvestmentsPortfolio response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String linkIn = null;
        InvestmentsPortfoliosPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        InvestmentsPortfolio response = api.retrieve(link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
