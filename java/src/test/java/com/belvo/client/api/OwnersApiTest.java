...
public class OwnersApiTest {
    ...
    private static OwnersApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new OwnersApi(apiClient);
    }
    ...
    public void completeRequestTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<Owner> response = api.completeRequest(session, link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        Owner response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        String displayNameIcontains = null;
        String email = null;
        String id = null;
        String idIn = null;
        String link = null;
        String linkIn = null;
        OwnersPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        List<Owner> response = api.retrieve(link)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
