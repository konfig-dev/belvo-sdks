...
/**
 * API tests for IncomeVerificationApi
 */
@Disabled
public class IncomeVerificationApiTest {

    private static IncomeVerificationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new IncomeVerificationApi(apiClient);
    }
    ...
    public void verifyTest() throws ApiException {
        ...
        List<EyodIncomeVerificationBodyRequest> transactions = null;
        ...
        List<Income> response = api.verify(language, transactions)
                .dateFrom(dateFrom)
                .dateTo(dateTo)
