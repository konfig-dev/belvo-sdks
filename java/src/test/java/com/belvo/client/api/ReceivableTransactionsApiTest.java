...
/**
 * API tests for ReceivableTransactionsApi
 */
@Disabled
public class ReceivableTransactionsApiTest {

    private static ReceivableTransactionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ReceivableTransactionsApi(apiClient);
    }
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        ReceivablesTransaction response = api.getDetails(id)
                .omit(omit)
                .fields(fields)
                .execute();
        // TODO: test validations
    ...
    public void listTest() throws ApiException {
        ...
        ReceivablesTransactionsPaginatedResponse response = api.list()
                .page(page)
                .pageSize(pageSize)
                .omit(omit)
                .fields(fields)
    ...
    public void retrieveTest() throws ApiException {
        ...
        String omit = null;
        String fields = null;
        ReceivablesTransaction response = api.retrieve(link, dateFrom, dateTo)
                .token(token)
                .saveData(saveData)
                .omit(omit)
                .fields(fields)
