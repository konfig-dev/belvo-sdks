...
import com.belvo.client.model.DocumentIdIndividual;
...
public class TaxPayerInformationIndividual {
  ...
  public TaxPayerInformationIndividual() {
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "0010", required = true, value = "The main economic activity the tax payer is involved in.")
  ...
  **/
   ...
   * @return the TaxPayerInformationIndividual instance itself
   */
  public TaxPayerInformationIndividual putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxPayerInformationIndividual taxPayerInformationIndividual = (TaxPayerInformationIndividual) o;
    return Objects.equals(this.firstLastName, taxPayerInformationIndividual.firstLastName) &&
        Objects.equals(this.secondLastName, taxPayerInformationIndividual.secondLastName) &&
        Objects.equals(this.firstName, taxPayerInformationIndividual.firstName) &&
        Objects.equals(this.otherNames, taxPayerInformationIndividual.otherNames) &&
        Objects.equals(this.mainEconomicActivity, taxPayerInformationIndividual.mainEconomicActivity) &&
        Objects.equals(this.documentId, taxPayerInformationIndividual.documentId) &&
        Objects.equals(this.reportingId, taxPayerInformationIndividual.reportingId)&&
        Objects.equals(this.additionalProperties, taxPayerInformationIndividual.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstLastName, secondLastName, firstName, otherNames, mainEconomicActivity, documentId, reportingId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TaxPayerInformationIndividual {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxPayerInformationIndividual
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxPayerInformationIndividual.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxPayerInformationIndividual is not found in the empty JSON string", TaxPayerInformationIndividual.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxPayerInformationIndividual.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("first_last_name").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("second_last_name").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("other_names").isJsonPrimitive()) {
      ...
      DocumentIdIndividual.validateJsonObject(jsonObj.getAsJsonObject("document_id"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxPayerInformationIndividual.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxPayerInformationIndividual' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxPayerInformationIndividual> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxPayerInformationIndividual.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxPayerInformationIndividual>() {
           @Override
           public void write(JsonWriter out, TaxPayerInformationIndividual value) throws IOException {
           ...
           @Override
           public TaxPayerInformationIndividual read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxPayerInformationIndividual instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxPayerInformationIndividual given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxPayerInformationIndividual
  * @throws IOException if the JSON string is invalid with respect to TaxPayerInformationIndividual
  */
  public static TaxPayerInformationIndividual fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxPayerInformationIndividual.class);
  }

 /**
  * Convert an instance of TaxPayerInformationIndividual to an JSON string
  *
  * @return JSON string
  */
