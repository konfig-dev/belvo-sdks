...
import com.belvo.client.model.CategorizationBody;
...
public class Categorization {
  ...
  private List<CategorizationBody> transactions = null;
  ...
  public Categorization addTransactionsItem(CategorizationBody transactionsItem) {
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of enriched transaction objects.")

  public List<CategorizationBody> getTransactions() {
    return transactions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactions, categorization.transactions)&&
      ...
      if (jsonObj.get("transactions") != null && !jsonObj.get("transactions").isJsonNull()) {
        ...
        if (jsonArraytransactions != null) {
          ...
          for (int i = 0; i < jsonArraytransactions.size(); i++) {
            CategorizationBody.validateJsonObject(jsonArraytransactions.get(i).getAsJsonObject());
          };
        }
      }
  }
