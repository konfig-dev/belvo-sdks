...
import com.belvo.client.model.PaymentMethodDetailsOfpi;
...
public class CreatePaymentLinkOfpi {
  ...
  **/
  ...
  public CreatePaymentLinkOfpi amount(String amount) {
   ...
   /**
   * Amount to be paid by your customer.    For OFPI, you can send through numbers with up to two decimal points, separated by a &#x60;.&#x60; period. For example: &#x60;\&quot;2853.78\&quot;&#x60; 
   * @return amount
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2853.78", required = true, value = "Amount to be paid by your customer.    For OFPI, you can send through numbers with up to two decimal points, separated by a `.` period. For example: `\"2853.78\"` ")
  ...
  **/
  ...
  public CreatePaymentLinkOfpi addAllowedPaymentMethodTypesItem(EnumPaymentLinkAllowedPaymentMethod allowedPaymentMethodTypesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of payment method types allowed in this payment intent. For OFPI, this value must be set to `open_finance`.")
  ...
  **/
   ...
   * @return the CreatePaymentLinkOfpi instance itself
   */
  public CreatePaymentLinkOfpi putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentLinkOfpi createPaymentLinkOfpi = (CreatePaymentLinkOfpi) o;
    return Objects.equals(this.description, createPaymentLinkOfpi.description) &&
        Objects.equals(this.amount, createPaymentLinkOfpi.amount) &&
        Objects.equals(this.customer, createPaymentLinkOfpi.customer) &&
        Objects.equals(this.allowedPaymentMethodTypes, createPaymentLinkOfpi.allowedPaymentMethodTypes) &&
        Objects.equals(this.provider, createPaymentLinkOfpi.provider) &&
        Objects.equals(this.paymentMethodDetails, createPaymentLinkOfpi.paymentMethodDetails) &&
        Objects.equals(this.callbackUrls, createPaymentLinkOfpi.callbackUrls) &&
        Objects.equals(this.expiresIn, createPaymentLinkOfpi.expiresIn)&&
        Objects.equals(this.additionalProperties, createPaymentLinkOfpi.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePaymentLinkOfpi {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePaymentLinkOfpi
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePaymentLinkOfpi.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePaymentLinkOfpi is not found in the empty JSON string", CreatePaymentLinkOfpi.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePaymentLinkOfpi.openapiRequiredFields) {
      ...
      PaymentMethodDetailsOfpi.validateJsonObject(jsonObj.getAsJsonObject("payment_method_details"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePaymentLinkOfpi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePaymentLinkOfpi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePaymentLinkOfpi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePaymentLinkOfpi.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePaymentLinkOfpi>() {
           @Override
           public void write(JsonWriter out, CreatePaymentLinkOfpi value) throws IOException {
           ...
           @Override
           public CreatePaymentLinkOfpi read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreatePaymentLinkOfpi instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreatePaymentLinkOfpi given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreatePaymentLinkOfpi
  * @throws IOException if the JSON string is invalid with respect to CreatePaymentLinkOfpi
  */
  public static CreatePaymentLinkOfpi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePaymentLinkOfpi.class);
  }

 /**
  * Convert an instance of CreatePaymentLinkOfpi to an JSON string
  *
  * @return JSON string
  */
