...
import com.belvo.client.model.InvoicesPaymentsRelatedDocumentsDian;
...
public class InvoicesPaymentsDian {
  ...
  **/
  ...
  public InvoicesPaymentsDian addRelatedDocumentsItem(InvoicesPaymentsRelatedDocumentsDian relatedDocumentsItem) {
  ...
  **/
   ...
   * @return the InvoicesPaymentsDian instance itself
   */
  public InvoicesPaymentsDian putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoicesPaymentsDian invoicesPaymentsDian = (InvoicesPaymentsDian) o;
    return Objects.equals(this.date, invoicesPaymentsDian.date) &&
        Objects.equals(this.paymentType, invoicesPaymentsDian.paymentType) &&
        Objects.equals(this.currency, invoicesPaymentsDian.currency) &&
        Objects.equals(this.exchangeRate, invoicesPaymentsDian.exchangeRate) &&
        Objects.equals(this.amount, invoicesPaymentsDian.amount) &&
        Objects.equals(this.operationNumber, invoicesPaymentsDian.operationNumber) &&
        Objects.equals(this.beneficiaryRfc, invoicesPaymentsDian.beneficiaryRfc) &&
        Objects.equals(this.beneficiaryAccountNumber, invoicesPaymentsDian.beneficiaryAccountNumber) &&
        Objects.equals(this.payerRfc, invoicesPaymentsDian.payerRfc) &&
        Objects.equals(this.payerAccountNumber, invoicesPaymentsDian.payerAccountNumber) &&
        Objects.equals(this.payerBankName, invoicesPaymentsDian.payerBankName) &&
        Objects.equals(this.relatedDocuments, invoicesPaymentsDian.relatedDocuments)&&
        Objects.equals(this.additionalProperties, invoicesPaymentsDian.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoicesPaymentsDian {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicesPaymentsDian
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicesPaymentsDian.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicesPaymentsDian is not found in the empty JSON string", InvoicesPaymentsDian.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoicesPaymentsDian.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrelatedDocuments.size(); i++) {
        InvoicesPaymentsRelatedDocumentsDian.validateJsonObject(jsonArrayrelatedDocuments.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicesPaymentsDian.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicesPaymentsDian' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicesPaymentsDian> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicesPaymentsDian.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicesPaymentsDian>() {
           @Override
           public void write(JsonWriter out, InvoicesPaymentsDian value) throws IOException {
           ...
           @Override
           public InvoicesPaymentsDian read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicesPaymentsDian instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicesPaymentsDian given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicesPaymentsDian
  * @throws IOException if the JSON string is invalid with respect to InvoicesPaymentsDian
  */
  public static InvoicesPaymentsDian fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicesPaymentsDian.class);
  }

 /**
  * Convert an instance of InvoicesPaymentsDian to an JSON string
  *
  * @return JSON string
  */
