...
public class TaxReturnPersonalMonthly {
  ...
  public static final String SERIALIZED_NAME_IVA = "iva";
  @SerializedName(SERIALIZED_NAME_IVA)
  private Object iva;
  ...
  **/
   ...
   * @return the TaxReturnPersonalMonthly instance itself
   */
  public TaxReturnPersonalMonthly putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, taxReturnPersonalMonthly.id) &&
        ...
        Objects.equals(this.receiptPdf, taxReturnPersonalMonthly.receiptPdf) &&
        Objects.equals(this.type, taxReturnPersonalMonthly.type)&&
        Objects.equals(this.additionalProperties, taxReturnPersonalMonthly.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, collectedAt, createdAt, informacionGeneral, isr, iva, pdf, receiptPdf, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("isr");
    openapiFields.add("iva");
    ...
    openapiRequiredFields.add("isr");
    openapiRequiredFields.add("iva");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxReturnPersonalMonthly
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxReturnPersonalMonthly.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxReturnPersonalMonthly is not found in the empty JSON string", TaxReturnPersonalMonthly.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxReturnPersonalMonthly.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxReturnPersonalMonthly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxReturnPersonalMonthly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxReturnPersonalMonthly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxReturnPersonalMonthly.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxReturnPersonalMonthly>() {
           @Override
           public void write(JsonWriter out, TaxReturnPersonalMonthly value) throws IOException {
           ...
           @Override
           public TaxReturnPersonalMonthly read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxReturnPersonalMonthly instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxReturnPersonalMonthly given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxReturnPersonalMonthly
  * @throws IOException if the JSON string is invalid with respect to TaxReturnPersonalMonthly
  */
  public static TaxReturnPersonalMonthly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxReturnPersonalMonthly.class);
  }

 /**
  * Convert an instance of TaxReturnPersonalMonthly to an JSON string
  *
  * @return JSON string
  */
