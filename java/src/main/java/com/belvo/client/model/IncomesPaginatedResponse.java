...
public class IncomesPaginatedResponse {
  ...
  **/
   ...
   * @return the IncomesPaginatedResponse instance itself
   */
  public IncomesPaginatedResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, incomesPaginatedResponse.count) &&
        Objects.equals(this.next, incomesPaginatedResponse.next) &&
        Objects.equals(this.previous, incomesPaginatedResponse.previous) &&
        Objects.equals(this.results, incomesPaginatedResponse.results)&&
        Objects.equals(this.additionalProperties, incomesPaginatedResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to IncomesPaginatedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncomesPaginatedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IncomesPaginatedResponse is not found in the empty JSON string", IncomesPaginatedResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            Income.validateJsonObject(jsonArrayresults.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IncomesPaginatedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IncomesPaginatedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IncomesPaginatedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IncomesPaginatedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IncomesPaginatedResponse>() {
           @Override
           public void write(JsonWriter out, IncomesPaginatedResponse value) throws IOException {
           ...
           @Override
           public IncomesPaginatedResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IncomesPaginatedResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IncomesPaginatedResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IncomesPaginatedResponse
  * @throws IOException if the JSON string is invalid with respect to IncomesPaginatedResponse
  */
  public static IncomesPaginatedResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IncomesPaginatedResponse.class);
  }

 /**
  * Convert an instance of IncomesPaginatedResponse to an JSON string
  *
  * @return JSON string
  */
