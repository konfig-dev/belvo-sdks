...
import com.belvo.client.model.TaxStatusAddressBetweenStreetSat;
...
public class TaxStatusAddressSat {
  ...
  private List<TaxStatusAddressBetweenStreetSat> betweenStreet = null;

  public TaxStatusAddressSat() {
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "21255", required = true, value = "The postcode of the address. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BUENAVENTURA", value = "The suburb of the tax payer. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "none", value = "The locality of the address. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CDMX DC", value = "The municipality of the address.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Federal", value = "The state that the address is in.")
  ...
  public TaxStatusAddressSat addBetweenStreetItem(TaxStatusAddressBetweenStreetSat betweenStreetItem) {
  ...
  **/
  ...
  public List<TaxStatusAddressBetweenStreetSat> getBetweenStreet() {
    return betweenStreet;
  }
   ...
   * @return the TaxStatusAddressSat instance itself
   */
  public TaxStatusAddressSat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxStatusAddressSat taxStatusAddressSat = (TaxStatusAddressSat) o;
    return Objects.equals(this.postalCode, taxStatusAddressSat.postalCode) &&
        Objects.equals(this.streetType, taxStatusAddressSat.streetType) &&
        Objects.equals(this.street, taxStatusAddressSat.street) &&
        Objects.equals(this.exteriorNumber, taxStatusAddressSat.exteriorNumber) &&
        Objects.equals(this.interiorNumber, taxStatusAddressSat.interiorNumber) &&
        Objects.equals(this.suburb, taxStatusAddressSat.suburb) &&
        Objects.equals(this.locality, taxStatusAddressSat.locality) &&
        Objects.equals(this.municipality, taxStatusAddressSat.municipality) &&
        Objects.equals(this.state, taxStatusAddressSat.state) &&
        Objects.equals(this.betweenStreet, taxStatusAddressSat.betweenStreet)&&
        Objects.equals(this.additionalProperties, taxStatusAddressSat.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxStatusAddressSat {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxStatusAddressSat
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxStatusAddressSat.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxStatusAddressSat is not found in the empty JSON string", TaxStatusAddressSat.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxStatusAddressSat.openapiRequiredFields) {
      ...
      if (jsonObj.get("between_street") != null && !jsonObj.get("between_street").isJsonNull()) {
        ...
        if (jsonArraybetweenStreet != null) {
          ...
          for (int i = 0; i < jsonArraybetweenStreet.size(); i++) {
            TaxStatusAddressBetweenStreetSat.validateJsonObject(jsonArraybetweenStreet.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxStatusAddressSat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxStatusAddressSat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxStatusAddressSat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxStatusAddressSat.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxStatusAddressSat>() {
           @Override
           public void write(JsonWriter out, TaxStatusAddressSat value) throws IOException {
           ...
           @Override
           public TaxStatusAddressSat read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxStatusAddressSat instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxStatusAddressSat given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxStatusAddressSat
  * @throws IOException if the JSON string is invalid with respect to TaxStatusAddressSat
  */
  public static TaxStatusAddressSat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxStatusAddressSat.class);
  }

 /**
  * Convert an instance of TaxStatusAddressSat to an JSON string
  *
  * @return JSON string
  */
