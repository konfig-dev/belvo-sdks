...
import com.belvo.client.model.CategorizationMerchantData;
...
import com.belvo.client.model.EnumCategorizationTransactionCategory;
import com.belvo.client.model.EnumCategorizationTransactionSubcategory;
...
public class CategorizationBody {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3CWE4927CF15355", required = true, value = "The unique ID for the transaction in your system.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "7890098789087", required = true, value = "The unique ID for the account holder in your system.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "BBVACA-89077589", required = true, value = "The unique ID for the account where the transaction occurred in your system.")
  ...
  **/
  ...
  @ApiModelProperty(example = "2345", value = "The four-digit ISO 18245 Merchant Category Code (MCC). We only return this value when `account_type` = `CREDIT_CARD`.")
  ...
  **/
  ...
  public EnumCategorizationTransactionCategory getCategory() {
    return category;
  }
  ...
  **/
  ...
  public EnumCategorizationTransactionSubcategory getSubcategory() {
    return subcategory;
  }
  ...
  **/
   ...
   * @return the CategorizationBody instance itself
   */
  public CategorizationBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CategorizationBody categorizationBody = (CategorizationBody) o;
    return Objects.equals(this.description, categorizationBody.description) &&
        Objects.equals(this.transactionId, categorizationBody.transactionId) &&
        Objects.equals(this.accountHolderType, categorizationBody.accountHolderType) &&
        Objects.equals(this.accountHolderId, categorizationBody.accountHolderId) &&
        Objects.equals(this.accountId, categorizationBody.accountId) &&
        Objects.equals(this.accountCategory, categorizationBody.accountCategory) &&
        Objects.equals(this.valueDate, categorizationBody.valueDate) &&
        Objects.equals(this.type, categorizationBody.type) &&
        Objects.equals(this.amount, categorizationBody.amount) &&
        Objects.equals(this.currency, categorizationBody.currency) &&
        Objects.equals(this.institution, categorizationBody.institution) &&
        Objects.equals(this.mcc, categorizationBody.mcc) &&
        Objects.equals(this.category, categorizationBody.category) &&
        Objects.equals(this.subcategory, categorizationBody.subcategory) &&
        Objects.equals(this.merchant, categorizationBody.merchant)&&
        Objects.equals(this.additionalProperties, categorizationBody.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, transactionId, accountHolderType, accountHolderId, accountId, accountCategory, valueDate, type, amount, currency, institution, mcc, category, subcategory, merchant, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CategorizationBody {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CategorizationBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CategorizationBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CategorizationBody is not found in the empty JSON string", CategorizationBody.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CategorizationBody.openapiRequiredFields) {
      ...
      CategorizationMerchantData.validateJsonObject(jsonObj.getAsJsonObject("merchant"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CategorizationBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CategorizationBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CategorizationBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CategorizationBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CategorizationBody>() {
           @Override
           public void write(JsonWriter out, CategorizationBody value) throws IOException {
           ...
           @Override
           public CategorizationBody read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CategorizationBody instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CategorizationBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CategorizationBody
  * @throws IOException if the JSON string is invalid with respect to CategorizationBody
  */
  public static CategorizationBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CategorizationBody.class);
  }

 /**
  * Convert an instance of CategorizationBody to an JSON string
  *
  * @return JSON string
  */
