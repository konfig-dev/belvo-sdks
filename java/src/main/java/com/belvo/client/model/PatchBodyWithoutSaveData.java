...
public class PatchBodyWithoutSaveData {
  ...
  **/
   ...
   * @return the PatchBodyWithoutSaveData instance itself
   */
  public PatchBodyWithoutSaveData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.session, patchBodyWithoutSaveData.session) &&
        ...
        Objects.equals(this.additionalProperties, patchBodyWithoutSaveData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(session, token, link, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchBodyWithoutSaveData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchBodyWithoutSaveData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchBodyWithoutSaveData is not found in the empty JSON string", PatchBodyWithoutSaveData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchBodyWithoutSaveData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchBodyWithoutSaveData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchBodyWithoutSaveData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchBodyWithoutSaveData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchBodyWithoutSaveData.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchBodyWithoutSaveData>() {
           @Override
           public void write(JsonWriter out, PatchBodyWithoutSaveData value) throws IOException {
           ...
           @Override
           public PatchBodyWithoutSaveData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchBodyWithoutSaveData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchBodyWithoutSaveData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchBodyWithoutSaveData
  * @throws IOException if the JSON string is invalid with respect to PatchBodyWithoutSaveData
  */
  public static PatchBodyWithoutSaveData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchBodyWithoutSaveData.class);
  }

 /**
  * Convert an instance of PatchBodyWithoutSaveData to an JSON string
  *
  * @return JSON string
  */
