...
public class RiskInsightsLoansMetrics {
  ...
  public static final String SERIALIZED_NAME_SUM_LOANS_PRINCIPAL = "sum_loans_principal";
  @SerializedName(SERIALIZED_NAME_SUM_LOANS_PRINCIPAL)
  private Float sumLoansPrincipal;

  public static final String SERIALIZED_NAME_SUM_LOANS_OUTSTANDING_PRINCIPAL = "sum_loans_outstanding_principal";
  @SerializedName(SERIALIZED_NAME_SUM_LOANS_OUTSTANDING_PRINCIPAL)
  private Float sumLoansOutstandingPrincipal;

  public static final String SERIALIZED_NAME_SUM_LOANS_MONTHLY_PAYMENT = "sum_loans_monthly_payment";
  @SerializedName(SERIALIZED_NAME_SUM_LOANS_MONTHLY_PAYMENT)
  ...
  **/
   ...
   * @return the RiskInsightsLoansMetrics instance itself
   */
  public RiskInsightsLoansMetrics putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.numAccounts, riskInsightsLoansMetrics.numAccounts) &&
        ...
        Objects.equals(this.additionalProperties, riskInsightsLoansMetrics.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numAccounts, sumLoansPrincipal, sumLoansOutstandingPrincipal, sumLoansMonthlyPayment, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("sum_loans_principal");
    openapiFields.add("sum_loans_outstanding_principal");
    openapiFields.add("sum_loans_monthly_payment");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("num_accounts");
    openapiRequiredFields.add("sum_loans_principal");
    openapiRequiredFields.add("sum_loans_outstanding_principal");
    openapiRequiredFields.add("sum_loans_monthly_payment");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RiskInsightsLoansMetrics
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RiskInsightsLoansMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RiskInsightsLoansMetrics is not found in the empty JSON string", RiskInsightsLoansMetrics.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RiskInsightsLoansMetrics.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RiskInsightsLoansMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RiskInsightsLoansMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RiskInsightsLoansMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RiskInsightsLoansMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<RiskInsightsLoansMetrics>() {
           @Override
           public void write(JsonWriter out, RiskInsightsLoansMetrics value) throws IOException {
           ...
           @Override
           public RiskInsightsLoansMetrics read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RiskInsightsLoansMetrics instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RiskInsightsLoansMetrics given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RiskInsightsLoansMetrics
  * @throws IOException if the JSON string is invalid with respect to RiskInsightsLoansMetrics
  */
  public static RiskInsightsLoansMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RiskInsightsLoansMetrics.class);
  }

 /**
  * Convert an instance of RiskInsightsLoansMetrics to an JSON string
  *
  * @return JSON string
  */
