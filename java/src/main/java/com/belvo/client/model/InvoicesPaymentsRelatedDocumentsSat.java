...
public class InvoicesPaymentsRelatedDocumentsSat {
  ...
  public InvoicesPaymentsRelatedDocumentsSat() {
  }

  public InvoicesPaymentsRelatedDocumentsSat invoiceIdentification(String invoiceIdentification) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat currency(String currency) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat paymentMethod(String paymentMethod) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat partialityNumber(Integer partialityNumber) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat previousBalance(Float previousBalance) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat amountPaid(Float amountPaid) {
  ...
  **/
  ...
  public InvoicesPaymentsRelatedDocumentsSat outstandingBalance(Float outstandingBalance) {
  ...
  **/
   ...
   * @return the InvoicesPaymentsRelatedDocumentsSat instance itself
   */
  public InvoicesPaymentsRelatedDocumentsSat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoicesPaymentsRelatedDocumentsSat invoicesPaymentsRelatedDocumentsSat = (InvoicesPaymentsRelatedDocumentsSat) o;
    return Objects.equals(this.invoiceIdentification, invoicesPaymentsRelatedDocumentsSat.invoiceIdentification) &&
        Objects.equals(this.currency, invoicesPaymentsRelatedDocumentsSat.currency) &&
        Objects.equals(this.paymentMethod, invoicesPaymentsRelatedDocumentsSat.paymentMethod) &&
        Objects.equals(this.partialityNumber, invoicesPaymentsRelatedDocumentsSat.partialityNumber) &&
        Objects.equals(this.previousBalance, invoicesPaymentsRelatedDocumentsSat.previousBalance) &&
        Objects.equals(this.amountPaid, invoicesPaymentsRelatedDocumentsSat.amountPaid) &&
        Objects.equals(this.outstandingBalance, invoicesPaymentsRelatedDocumentsSat.outstandingBalance)&&
        Objects.equals(this.additionalProperties, invoicesPaymentsRelatedDocumentsSat.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoicesPaymentsRelatedDocumentsSat {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicesPaymentsRelatedDocumentsSat
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicesPaymentsRelatedDocumentsSat.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicesPaymentsRelatedDocumentsSat is not found in the empty JSON string", InvoicesPaymentsRelatedDocumentsSat.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoicesPaymentsRelatedDocumentsSat.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicesPaymentsRelatedDocumentsSat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicesPaymentsRelatedDocumentsSat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicesPaymentsRelatedDocumentsSat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicesPaymentsRelatedDocumentsSat.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicesPaymentsRelatedDocumentsSat>() {
           @Override
           public void write(JsonWriter out, InvoicesPaymentsRelatedDocumentsSat value) throws IOException {
           ...
           @Override
           public InvoicesPaymentsRelatedDocumentsSat read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicesPaymentsRelatedDocumentsSat instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicesPaymentsRelatedDocumentsSat given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicesPaymentsRelatedDocumentsSat
  * @throws IOException if the JSON string is invalid with respect to InvoicesPaymentsRelatedDocumentsSat
  */
  public static InvoicesPaymentsRelatedDocumentsSat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicesPaymentsRelatedDocumentsSat.class);
  }

 /**
  * Convert an instance of InvoicesPaymentsRelatedDocumentsSat to an JSON string
  *
  * @return JSON string
  */
