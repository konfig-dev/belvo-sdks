...
public class PatchBody {
  ...
  public PatchBody session(String session) {
  ...
  **/
  ...
  public PatchBody token(String token) {
  ...
  **/
  ...
  public PatchBody link(UUID link) {
  ...
  **/
  ...
  public PatchBody saveData(Boolean saveData) {
  ...
  **/
   ...
   * @return the PatchBody instance itself
   */
  public PatchBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PatchBody patchBody = (PatchBody) o;
    return Objects.equals(this.session, patchBody.session) &&
        Objects.equals(this.token, patchBody.token) &&
        Objects.equals(this.link, patchBody.link) &&
        Objects.equals(this.saveData, patchBody.saveData)&&
        Objects.equals(this.additionalProperties, patchBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(session, token, link, saveData, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PatchBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PatchBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchBody is not found in the empty JSON string", PatchBody.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PatchBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchBody.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchBody>() {
           @Override
           public void write(JsonWriter out, PatchBody value) throws IOException {
           ...
           @Override
           public PatchBody read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PatchBody instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PatchBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PatchBody
  * @throws IOException if the JSON string is invalid with respect to PatchBody
  */
  public static PatchBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchBody.class);
  }

 /**
  * Convert an instance of PatchBody to an JSON string
  *
  * @return JSON string
  */
