 ...
 */
@JsonAdapter(EnumCategorizationTransactionSubcategory.Adapter.class)
public enum EnumCategorizationTransactionSubcategory {
  ...
  EnumCategorizationTransactionSubcategory(String value) {
    this.value = value;
  }
  ...
  public static EnumCategorizationTransactionSubcategory fromValue(String value) {
    for (EnumCategorizationTransactionSubcategory b : EnumCategorizationTransactionSubcategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumCategorizationTransactionSubcategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumCategorizationTransactionSubcategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumCategorizationTransactionSubcategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumCategorizationTransactionSubcategory.fromValue(value);
    }
  }
}
