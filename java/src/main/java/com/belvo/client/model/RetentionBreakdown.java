...
import com.belvo.client.model.EnumTaxRetentionPaymentStatus;
...
public class RetentionBreakdown {
  ...
  public static final String SERIALIZED_NAME_RETAINED_AMOUNT = "retained_amount";
  @SerializedName(SERIALIZED_NAME_RETAINED_AMOUNT)
  ...
  **/
   ...
   * @return the RetentionBreakdown instance itself
   */
  public RetentionBreakdown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.baseAmount, retentionBreakdown.baseAmount) &&
        ...
        Objects.equals(this.additionalProperties, retentionBreakdown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(baseAmount, taxType, retainedAmount, paymentStatus, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("retained_amount");
    openapiFields.add("payment_status");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("base_amount");
    openapiRequiredFields.add("tax_type");
    openapiRequiredFields.add("retained_amount");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RetentionBreakdown
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RetentionBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetentionBreakdown is not found in the empty JSON string", RetentionBreakdown.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetentionBreakdown.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("tax_type").isJsonNull() && !jsonObj.get("tax_type").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetentionBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetentionBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetentionBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetentionBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<RetentionBreakdown>() {
           @Override
           public void write(JsonWriter out, RetentionBreakdown value) throws IOException {
           ...
           @Override
           public RetentionBreakdown read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RetentionBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RetentionBreakdown given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RetentionBreakdown
  * @throws IOException if the JSON string is invalid with respect to RetentionBreakdown
  */
  public static RetentionBreakdown fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetentionBreakdown.class);
  }

 /**
  * Convert an instance of RetentionBreakdown to an JSON string
  *
  * @return JSON string
  */
