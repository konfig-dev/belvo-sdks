...
public class InstitutionFormField {
  ...
  **/
  ...
  public InstitutionFormField label(String label) {
   ...
   /**
   * The label of the form field. For example: - Document - Clave - Token 
   * @return label
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Document", value = "The label of the form field. For example: - Document - Clave - Token ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Username", value = "The placeholder text in the form field.")
  ...
  **/
  ...
  public InstitutionFormField addValuesItem(InstitutionsFormFieldValues valuesItem) {
    if (this.values == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of additional form field values.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6", value = "Number of digits allowed when the type is `token`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "It indicates whether this form field is optional.")
   ...
   * @return the InstitutionFormField instance itself
   */
  public InstitutionFormField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InstitutionFormField institutionFormField = (InstitutionFormField) o;
    return Objects.equals(this.name, institutionFormField.name) &&
        Objects.equals(this.type, institutionFormField.type) &&
        Objects.equals(this.label, institutionFormField.label) &&
        Objects.equals(this.validation, institutionFormField.validation) &&
        Objects.equals(this.placeholder, institutionFormField.placeholder) &&
        Objects.equals(this.validationMessage, institutionFormField.validationMessage) &&
        Objects.equals(this.values, institutionFormField.values) &&
        Objects.equals(this.length, institutionFormField.length) &&
        Objects.equals(this.optional, institutionFormField.optional)&&
        Objects.equals(this.additionalProperties, institutionFormField.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, label, validation, placeholder, validationMessage, values, length, optional, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InstitutionFormField {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstitutionFormField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstitutionFormField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstitutionFormField is not found in the empty JSON string", InstitutionFormField.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstitutionFormField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstitutionFormField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstitutionFormField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstitutionFormField.class));

       return (TypeAdapter<T>) new TypeAdapter<InstitutionFormField>() {
           @Override
           public void write(JsonWriter out, InstitutionFormField value) throws IOException {
           ...
           @Override
           public InstitutionFormField read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstitutionFormField instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InstitutionFormField given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstitutionFormField
  * @throws IOException if the JSON string is invalid with respect to InstitutionFormField
  */
  public static InstitutionFormField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstitutionFormField.class);
  }

 /**
  * Convert an instance of InstitutionFormField to an JSON string
  *
  * @return JSON string
  */
