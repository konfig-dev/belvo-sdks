...
import com.belvo.client.model.PaymentIntentPse;
...
public class PaymentLinkPse {
  ...
  private PaymentIntentPse paymentIntent;
  ...
  **/
  ...
  public PaymentIntentPse getPaymentIntent() {
    return paymentIntent;
  }
  ...
  **/
   ...
   * @return the PaymentLinkPse instance itself
   */
  public PaymentLinkPse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentLinkPse paymentLinkPse = (PaymentLinkPse) o;
    return Objects.equals(this.id, paymentLinkPse.id) &&
        Objects.equals(this.createdAt, paymentLinkPse.createdAt) &&
        Objects.equals(this.createdBy, paymentLinkPse.createdBy) &&
        Objects.equals(this.paymentUrl, paymentLinkPse.paymentUrl) &&
        Objects.equals(this.accessToken, paymentLinkPse.accessToken) &&
        Objects.equals(this.callbackUrls, paymentLinkPse.callbackUrls) &&
        Objects.equals(this.paymentIntent, paymentLinkPse.paymentIntent) &&
        Objects.equals(this.updatedAt, paymentLinkPse.updatedAt) &&
        Objects.equals(this.status, paymentLinkPse.status) &&
        Objects.equals(this.expiresIn, paymentLinkPse.expiresIn) &&
        Objects.equals(this.expiresAt, paymentLinkPse.expiresAt)&&
        Objects.equals(this.additionalProperties, paymentLinkPse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentLinkPse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentLinkPse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentLinkPse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentLinkPse is not found in the empty JSON string", PaymentLinkPse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentLinkPse.openapiRequiredFields) {
      ...
      if (jsonObj.get("payment_intent") != null && !jsonObj.get("payment_intent").isJsonNull()) {
        PaymentIntentPse.validateJsonObject(jsonObj.getAsJsonObject("payment_intent"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentLinkPse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentLinkPse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentLinkPse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentLinkPse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentLinkPse>() {
           @Override
           public void write(JsonWriter out, PaymentLinkPse value) throws IOException {
           ...
           @Override
           public PaymentLinkPse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentLinkPse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentLinkPse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentLinkPse
  * @throws IOException if the JSON string is invalid with respect to PaymentLinkPse
  */
  public static PaymentLinkPse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentLinkPse.class);
  }

 /**
  * Convert an instance of PaymentLinkPse to an JSON string
  *
  * @return JSON string
  */
