...
public class BankAccountOfpiResponse {
  ...
  public BankAccountOfpiResponse() {
  }
  ...
  **/
   ...
   * @return the BankAccountOfpiResponse instance itself
   */
  public BankAccountOfpiResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BankAccountOfpiResponse bankAccountOfpiResponse = (BankAccountOfpiResponse) o;
    return Objects.equals(this.id, bankAccountOfpiResponse.id) &&
        Objects.equals(this.createdAt, bankAccountOfpiResponse.createdAt) &&
        Objects.equals(this.createdBy, bankAccountOfpiResponse.createdBy) &&
        Objects.equals(this.customer, bankAccountOfpiResponse.customer) &&
        Objects.equals(this.institution, bankAccountOfpiResponse.institution) &&
        Objects.equals(this.details, bankAccountOfpiResponse.details) &&
        Objects.equals(this.holder, bankAccountOfpiResponse.holder)&&
        Objects.equals(this.additionalProperties, bankAccountOfpiResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, createdBy, customer, institution, details, holder, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BankAccountOfpiResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountOfpiResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountOfpiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountOfpiResponse is not found in the empty JSON string", BankAccountOfpiResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BankAccountOfpiResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountOfpiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountOfpiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountOfpiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountOfpiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountOfpiResponse>() {
           @Override
           public void write(JsonWriter out, BankAccountOfpiResponse value) throws IOException {
           ...
           @Override
           public BankAccountOfpiResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BankAccountOfpiResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BankAccountOfpiResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BankAccountOfpiResponse
  * @throws IOException if the JSON string is invalid with respect to BankAccountOfpiResponse
  */
  public static BankAccountOfpiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountOfpiResponse.class);
  }

 /**
  * Convert an instance of BankAccountOfpiResponse to an JSON string
  *
  * @return JSON string
  */
