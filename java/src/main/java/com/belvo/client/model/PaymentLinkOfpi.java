...
import com.belvo.client.model.PaymentIntentOfpi;
...
public class PaymentLinkOfpi {
  ...
  private PaymentIntentOfpi paymentIntent;
  ...
  **/
  ...
  public PaymentIntentOfpi getPaymentIntent() {
    return paymentIntent;
  }
  ...
  **/
   ...
   * @return the PaymentLinkOfpi instance itself
   */
  public PaymentLinkOfpi putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentLinkOfpi paymentLinkOfpi = (PaymentLinkOfpi) o;
    return Objects.equals(this.id, paymentLinkOfpi.id) &&
        Objects.equals(this.createdAt, paymentLinkOfpi.createdAt) &&
        Objects.equals(this.createdBy, paymentLinkOfpi.createdBy) &&
        Objects.equals(this.paymentUrl, paymentLinkOfpi.paymentUrl) &&
        Objects.equals(this.accessToken, paymentLinkOfpi.accessToken) &&
        Objects.equals(this.callbackUrls, paymentLinkOfpi.callbackUrls) &&
        Objects.equals(this.paymentIntent, paymentLinkOfpi.paymentIntent) &&
        Objects.equals(this.updatedAt, paymentLinkOfpi.updatedAt) &&
        Objects.equals(this.status, paymentLinkOfpi.status) &&
        Objects.equals(this.expiresIn, paymentLinkOfpi.expiresIn) &&
        Objects.equals(this.expiresAt, paymentLinkOfpi.expiresAt)&&
        Objects.equals(this.additionalProperties, paymentLinkOfpi.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentLinkOfpi {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentLinkOfpi
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentLinkOfpi.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentLinkOfpi is not found in the empty JSON string", PaymentLinkOfpi.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentLinkOfpi.openapiRequiredFields) {
      ...
      // validate the optional field `payment_intent`
      if (jsonObj.get("payment_intent") != null && !jsonObj.get("payment_intent").isJsonNull()) {
        PaymentIntentOfpi.validateJsonObject(jsonObj.getAsJsonObject("payment_intent"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentLinkOfpi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentLinkOfpi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentLinkOfpi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentLinkOfpi.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentLinkOfpi>() {
           @Override
           public void write(JsonWriter out, PaymentLinkOfpi value) throws IOException {
           ...
           @Override
           public PaymentLinkOfpi read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentLinkOfpi instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentLinkOfpi given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentLinkOfpi
  * @throws IOException if the JSON string is invalid with respect to PaymentLinkOfpi
  */
  public static PaymentLinkOfpi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentLinkOfpi.class);
  }

 /**
  * Convert an instance of PaymentLinkOfpi to an JSON string
  *
  * @return JSON string
  */
