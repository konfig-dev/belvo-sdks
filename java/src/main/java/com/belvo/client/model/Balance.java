...
public class Balance {
  ...
  **/
  ...
  @ApiModelProperty(example = "076c66e5-90f5-4e01-99c7-50e32f65ae42", value = "Belvo's unique ID for the balance request.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Tue Oct 22 17:00:00 PDT 2019", value = "The date when the `balance` was available, in `YYYY-MM-DD` format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "50000", value = "The funds available in the account by the end of the `value_date`.")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "*This field has been deprecated. Please use the `balance` field instead.* ")
  ...
  public Balance statement(String statement) {
   ...
   /**
   * *This field has been deprecated.*  *The ID of the banking statement used to extract the &#x60;balance&#x60;.* 
   * @return statement
   * @deprecated
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "*This field has been deprecated.*  *The ID of the banking statement used to extract the `balance`.* ")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This field has been deprecated.  The ISO-8601 timestamp when the data point was collected. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, balance.id) &&
        ...
        Objects.equals(this.valueDate, balance.valueDate) &&
        Objects.equals(this.balance, balance.balance) &&
        Objects.equals(this.currentBalance, balance.currentBalance) &&
        Objects.equals(this.statement, balance.statement) &&
        Objects.equals(this.collectedAt, balance.collectedAt)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, account, valueDate, balance, currentBalance, statement, collectedAt, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("statement").isJsonNull() && (jsonObj.get("statement") != null && !jsonObj.get("statement").isJsonNull()) && !jsonObj.get("statement").isJsonPrimitive()) {
