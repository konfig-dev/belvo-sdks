...
public class TransactionMerchantData {
  ...
  **/
   ...
   * @return the TransactionMerchantData instance itself
   */
  public TransactionMerchantData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logo, transactionMerchantData.logo) &&
        Objects.equals(this.website, transactionMerchantData.website) &&
        Objects.equals(this.merchantName, transactionMerchantData.merchantName)&&
        Objects.equals(this.additionalProperties, transactionMerchantData.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionMerchantData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionMerchantData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionMerchantData is not found in the empty JSON string", TransactionMerchantData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionMerchantData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionMerchantData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionMerchantData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionMerchantData.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionMerchantData>() {
           @Override
           public void write(JsonWriter out, TransactionMerchantData value) throws IOException {
           ...
           @Override
           public TransactionMerchantData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionMerchantData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionMerchantData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionMerchantData
  * @throws IOException if the JSON string is invalid with respect to TransactionMerchantData
  */
  public static TransactionMerchantData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionMerchantData.class);
  }

 /**
  * Convert an instance of TransactionMerchantData to an JSON string
  *
  * @return JSON string
  */
