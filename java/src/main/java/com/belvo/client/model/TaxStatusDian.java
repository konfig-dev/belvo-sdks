...
import com.belvo.client.model.TaxStatusAddressDian;
import com.belvo.client.model.TaxStatusEconomicActivityDian;
import com.belvo.client.model.TaxStatusObligationsDian;
import com.belvo.client.model.TaxStatusRegimensDian;
import com.belvo.client.model.TaxStatusTaxPayerInformationDian;
...
public class TaxStatusDian {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-08-05/18:55:16", required = true, value = "The date when the tax status was issued. For example, `2020-08-05/18:55:16`.")
  ...
  public TaxStatusDian officialName(String officialName) {
   ...
   /**
   * The name of the business.  Note: For individuals in Colombia, this field will return &#x60;null&#x60;. 
   * @return officialName
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Jar Jar Transport", required = true, value = "The name of the business.  Note: For individuals in Colombia, this field will return `null`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12345678901", required = true, value = "The taxpayer's *Cédula de ciudadanía* (CC) ID. Only applicable for individuals. ")
  ...
  **/
  ...
  public TaxStatusDian addEconomicActivityItem(TaxStatusEconomicActivityDian economicActivityItem) {
  ...
  **/
  ...
  public List<TaxStatusEconomicActivityDian> getEconomicActivity() {
    return economicActivity;
  }
  ...
  public TaxStatusDian addRegimensItem(TaxStatusRegimensDian regimensItem) {
  ...
  **/
  ...
  public List<TaxStatusRegimensDian> getRegimens() {
    return regimens;
  }
  ...
  public TaxStatusDian addObligationsItem(TaxStatusObligationsDian obligationsItem) {
  ...
  **/
  ...
  public List<TaxStatusObligationsDian> getObligations() {
    return obligations;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "\"44701362691\"", required = true, value = "The validation certificate of the document.")
  ...
  **/
   ...
   * @return the TaxStatusDian instance itself
   */
  public TaxStatusDian putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxStatusDian taxStatusDian = (TaxStatusDian) o;
    return Objects.equals(this.id, taxStatusDian.id) &&
        Objects.equals(this.link, taxStatusDian.link) &&
        Objects.equals(this.collectedAt, taxStatusDian.collectedAt) &&
        Objects.equals(this.createdAt, taxStatusDian.createdAt) &&
        Objects.equals(this.placeAndDateOfIssuance, taxStatusDian.placeAndDateOfIssuance) &&
        Objects.equals(this.officialName, taxStatusDian.officialName) &&
        Objects.equals(this.idCif, taxStatusDian.idCif) &&
        Objects.equals(this.taxPayerInformation, taxStatusDian.taxPayerInformation) &&
        Objects.equals(this.address, taxStatusDian.address) &&
        Objects.equals(this.economicActivity, taxStatusDian.economicActivity) &&
        Objects.equals(this.regimens, taxStatusDian.regimens) &&
        Objects.equals(this.obligations, taxStatusDian.obligations) &&
        Objects.equals(this.digitalStamp, taxStatusDian.digitalStamp) &&
        Objects.equals(this.digitalStampChain, taxStatusDian.digitalStampChain) &&
        Objects.equals(this.pdf, taxStatusDian.pdf)&&
        Objects.equals(this.additionalProperties, taxStatusDian.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxStatusDian
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxStatusDian.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxStatusDian is not found in the empty JSON string", TaxStatusDian.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxStatusDian.openapiRequiredFields) {
      ...
      TaxStatusTaxPayerInformationDian.validateJsonObject(jsonObj.getAsJsonObject("tax_payer_information"));
      // validate the required field `address`
      TaxStatusAddressDian.validateJsonObject(jsonObj.getAsJsonObject("address"));
      ...
      for (int i = 0; i < jsonArrayeconomicActivity.size(); i++) {
        TaxStatusEconomicActivityDian.validateJsonObject(jsonArrayeconomicActivity.get(i).getAsJsonObject());
      };
      if (jsonObj.get("regimens") != null && !jsonObj.get("regimens").isJsonNull()) {
        ...
        if (jsonArrayregimens != null) {
          ...
          for (int i = 0; i < jsonArrayregimens.size(); i++) {
            TaxStatusRegimensDian.validateJsonObject(jsonArrayregimens.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayobligations.size(); i++) {
        TaxStatusObligationsDian.validateJsonObject(jsonArrayobligations.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxStatusDian.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxStatusDian' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxStatusDian> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxStatusDian.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxStatusDian>() {
           @Override
           public void write(JsonWriter out, TaxStatusDian value) throws IOException {
           ...
           @Override
           public TaxStatusDian read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxStatusDian instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxStatusDian given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxStatusDian
  * @throws IOException if the JSON string is invalid with respect to TaxStatusDian
  */
  public static TaxStatusDian fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxStatusDian.class);
  }

 /**
  * Convert an instance of TaxStatusDian to an JSON string
  *
  * @return JSON string
  */
