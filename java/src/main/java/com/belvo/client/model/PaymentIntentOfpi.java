...
import com.belvo.client.model.PaymentIntentOfpiPaymentMethodDetails;
import com.belvo.client.model.PaymentMethodInformationOfpi;
...
public class PaymentIntentOfpi {
  ...
  **/
  ...
  public PaymentIntentOfpi addAllowedPaymentMethodTypesItem(String allowedPaymentMethodTypesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of payment method types allowed in this payment intent. For OFPI, the value will be `open_finance`.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1330.56", required = true, value = "Amount to be paid by your customer in this payment intent. ")
  ...
  **/
  ...
  public PaymentIntentOfpi addChargesItem(Charge chargesItem) {
  ...
  **/
   ...
   * @return the PaymentIntentOfpi instance itself
   */
  public PaymentIntentOfpi putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentIntentOfpi paymentIntentOfpi = (PaymentIntentOfpi) o;
    return Objects.equals(this.description, paymentIntentOfpi.description) &&
        Objects.equals(this.id, paymentIntentOfpi.id) &&
        Objects.equals(this.createdAt, paymentIntentOfpi.createdAt) &&
        Objects.equals(this.createdBy, paymentIntentOfpi.createdBy) &&
        Objects.equals(this.customer, paymentIntentOfpi.customer) &&
        Objects.equals(this.allowedPaymentMethodTypes, paymentIntentOfpi.allowedPaymentMethodTypes) &&
        Objects.equals(this.amount, paymentIntentOfpi.amount) &&
        Objects.equals(this.currency, paymentIntentOfpi.currency) &&
        Objects.equals(this.failureCode, paymentIntentOfpi.failureCode) &&
        Objects.equals(this.failureMessage, paymentIntentOfpi.failureMessage) &&
        Objects.equals(this.metadata, paymentIntentOfpi.metadata) &&
        Objects.equals(this.nextStep, paymentIntentOfpi.nextStep) &&
        Objects.equals(this.lastError, paymentIntentOfpi.lastError) &&
        Objects.equals(this.paymentMethodDetails, paymentIntentOfpi.paymentMethodDetails) &&
        Objects.equals(this.paymentMethodInformation, paymentIntentOfpi.paymentMethodInformation) &&
        Objects.equals(this.charges, paymentIntentOfpi.charges) &&
        Objects.equals(this.provider, paymentIntentOfpi.provider) &&
        Objects.equals(this.selectedPaymentMethodType, paymentIntentOfpi.selectedPaymentMethodType) &&
        Objects.equals(this.status, paymentIntentOfpi.status) &&
        Objects.equals(this.updatedAt, paymentIntentOfpi.updatedAt)&&
        Objects.equals(this.additionalProperties, paymentIntentOfpi.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentIntentOfpi {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentIntentOfpi
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentIntentOfpi.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentIntentOfpi is not found in the empty JSON string", PaymentIntentOfpi.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentIntentOfpi.openapiRequiredFields) {
      ...
      PaymentIntentOfpiPaymentMethodDetails.validateJsonObject(jsonObj.getAsJsonObject("payment_method_details"));
      // validate the required field `payment_method_information`
      PaymentMethodInformationOfpi.validateJsonObject(jsonObj.getAsJsonObject("payment_method_information"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentIntentOfpi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentIntentOfpi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentIntentOfpi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentIntentOfpi.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentIntentOfpi>() {
           @Override
           public void write(JsonWriter out, PaymentIntentOfpi value) throws IOException {
           ...
           @Override
           public PaymentIntentOfpi read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentIntentOfpi instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentIntentOfpi given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentIntentOfpi
  * @throws IOException if the JSON string is invalid with respect to PaymentIntentOfpi
  */
  public static PaymentIntentOfpi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentIntentOfpi.class);
  }

 /**
  * Convert an instance of PaymentIntentOfpi to an JSON string
  *
  * @return JSON string
  */
