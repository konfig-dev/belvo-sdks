...
import com.belvo.client.model.AnnualIncomeStatementIndividual;
import com.belvo.client.model.DocumentInformationIndividual;
import com.belvo.client.model.EquityStatementIndividual;
import com.belvo.client.model.PensionIncomeStatementIndividual;
import com.belvo.client.model.TaxAssessmentIndividual;
import com.belvo.client.model.TaxPayerInformationIndividual;
...
public class TaxDeclarationIndividual {
  ...
  public static final String SERIALIZED_NAME_PENSION_INCOME_STATEMENT = "pension_income_statement";
  @SerializedName(SERIALIZED_NAME_PENSION_INCOME_STATEMENT)
  ...
  public TaxDeclarationIndividual() {
  }
  ...
  **/
   ...
   * @return the TaxDeclarationIndividual instance itself
   */
  public TaxDeclarationIndividual putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxDeclarationIndividual taxDeclarationIndividual = (TaxDeclarationIndividual) o;
    return Objects.equals(this.id, taxDeclarationIndividual.id) &&
        Objects.equals(this.link, taxDeclarationIndividual.link) &&
        Objects.equals(this.collectedAt, taxDeclarationIndividual.collectedAt) &&
        Objects.equals(this.createdAt, taxDeclarationIndividual.createdAt) &&
        Objects.equals(this.documentInformation, taxDeclarationIndividual.documentInformation) &&
        Objects.equals(this.taxPayerInformation, taxDeclarationIndividual.taxPayerInformation) &&
        Objects.equals(this.equityStatement, taxDeclarationIndividual.equityStatement) &&
        Objects.equals(this.annualIncomeStatement, taxDeclarationIndividual.annualIncomeStatement) &&
        Objects.equals(this.pensionIncomeStatement, taxDeclarationIndividual.pensionIncomeStatement) &&
        Objects.equals(this.taxAssessment, taxDeclarationIndividual.taxAssessment) &&
        Objects.equals(this.dateIssued, taxDeclarationIndividual.dateIssued) &&
        Objects.equals(this.pdf, taxDeclarationIndividual.pdf)&&
        Objects.equals(this.additionalProperties, taxDeclarationIndividual.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, link, collectedAt, createdAt, documentInformation, taxPayerInformation, equityStatement, annualIncomeStatement, pensionIncomeStatement, taxAssessment, dateIssued, pdf, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TaxDeclarationIndividual {\n");
    ...
    sb.append("    pensionIncomeStatement: ").append(toIndentedString(pensionIncomeStatement)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pension_income_statement");
    ...
    openapiRequiredFields.add("pension_income_statement");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxDeclarationIndividual
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxDeclarationIndividual.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxDeclarationIndividual is not found in the empty JSON string", TaxDeclarationIndividual.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxDeclarationIndividual.openapiRequiredFields) {
      ...
      DocumentInformationIndividual.validateJsonObject(jsonObj.getAsJsonObject("document_information"));
      // validate the required field `tax_payer_information`
      TaxPayerInformationIndividual.validateJsonObject(jsonObj.getAsJsonObject("tax_payer_information"));
      // validate the required field `equity_statement`
      EquityStatementIndividual.validateJsonObject(jsonObj.getAsJsonObject("equity_statement"));
      // validate the required field `annual_income_statement`
      AnnualIncomeStatementIndividual.validateJsonObject(jsonObj.getAsJsonObject("annual_income_statement"));
      // validate the required field `pension_income_statement`
      PensionIncomeStatementIndividual.validateJsonObject(jsonObj.getAsJsonObject("pension_income_statement"));
      // validate the required field `tax_assessment`
      TaxAssessmentIndividual.validateJsonObject(jsonObj.getAsJsonObject("tax_assessment"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxDeclarationIndividual.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxDeclarationIndividual' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxDeclarationIndividual> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxDeclarationIndividual.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxDeclarationIndividual>() {
           @Override
           public void write(JsonWriter out, TaxDeclarationIndividual value) throws IOException {
           ...
           @Override
           public TaxDeclarationIndividual read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxDeclarationIndividual instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxDeclarationIndividual given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxDeclarationIndividual
  * @throws IOException if the JSON string is invalid with respect to TaxDeclarationIndividual
  */
  public static TaxDeclarationIndividual fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxDeclarationIndividual.class);
  }

 /**
  * Convert an instance of TaxDeclarationIndividual to an JSON string
  *
  * @return JSON string
  */
