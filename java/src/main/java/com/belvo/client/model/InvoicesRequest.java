...
public class InvoicesRequest {
  ...
  **/
   ...
   * @return the InvoicesRequest instance itself
   */
  public InvoicesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.link, invoicesRequest.link) &&
        ...
        Objects.equals(this.additionalProperties, invoicesRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicesRequest is not found in the empty JSON string", InvoicesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoicesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicesRequest>() {
           @Override
           public void write(JsonWriter out, InvoicesRequest value) throws IOException {
           ...
           @Override
           public InvoicesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicesRequest
  * @throws IOException if the JSON string is invalid with respect to InvoicesRequest
  */
  public static InvoicesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicesRequest.class);
  }

 /**
  * Convert an instance of InvoicesRequest to an JSON string
  *
  * @return JSON string
  */
