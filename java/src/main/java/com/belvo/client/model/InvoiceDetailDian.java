...
public class InvoiceDetailDian {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AE001", required = true, value = "The identification code of the product or the service, as defined by the legal entity in the country. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", required = true, value = "The quantity of this invoice item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EA", required = true, value = "The unit of measure, as defined by the legal entity in the country. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "cada", required = true, value = "The description of the item, as defined by the legal entity in the country. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5900", required = true, value = "The price of one singular item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "IVA", value = "The item's tax type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5900", required = true, value = "The total price for this item before tax is applied (`quantity` x `unit_amount`).")
  ...
  **/
   ...
   * @return the InvoiceDetailDian instance itself
   */
  public InvoiceDetailDian putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceDetailDian invoiceDetailDian = (InvoiceDetailDian) o;
    return Objects.equals(this.description, invoiceDetailDian.description) &&
        Objects.equals(this.productIdentification, invoiceDetailDian.productIdentification) &&
        Objects.equals(this.quantity, invoiceDetailDian.quantity) &&
        Objects.equals(this.unitCode, invoiceDetailDian.unitCode) &&
        Objects.equals(this.unitDescription, invoiceDetailDian.unitDescription) &&
        Objects.equals(this.unitAmount, invoiceDetailDian.unitAmount) &&
        Objects.equals(this.taxType, invoiceDetailDian.taxType) &&
        Objects.equals(this.preTaxAmount, invoiceDetailDian.preTaxAmount) &&
        Objects.equals(this.taxPercentage, invoiceDetailDian.taxPercentage) &&
        Objects.equals(this.taxAmount, invoiceDetailDian.taxAmount) &&
        Objects.equals(this.totalAmount, invoiceDetailDian.totalAmount) &&
        Objects.equals(this.collectedAt, invoiceDetailDian.collectedAt)&&
        Objects.equals(this.additionalProperties, invoiceDetailDian.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, productIdentification, quantity, unitCode, unitDescription, unitAmount, taxType, preTaxAmount, taxPercentage, taxAmount, totalAmount, collectedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceDetailDian {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceDetailDian
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceDetailDian.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceDetailDian is not found in the empty JSON string", InvoiceDetailDian.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InvoiceDetailDian.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceDetailDian.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceDetailDian' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceDetailDian> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceDetailDian.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceDetailDian>() {
           @Override
           public void write(JsonWriter out, InvoiceDetailDian value) throws IOException {
           ...
           @Override
           public InvoiceDetailDian read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceDetailDian instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceDetailDian given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceDetailDian
  * @throws IOException if the JSON string is invalid with respect to InvoiceDetailDian
  */
  public static InvoiceDetailDian fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceDetailDian.class);
  }

 /**
  * Convert an instance of InvoiceDetailDian to an JSON string
  *
  * @return JSON string
  */
