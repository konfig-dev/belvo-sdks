 ...
 */
@JsonAdapter(EnumTransactionCategory.Adapter.class)
public enum EnumTransactionCategory {
  ...
  EnumTransactionCategory(String value) {
    this.value = value;
  }
  ...
  public static EnumTransactionCategory fromValue(String value) {
    for (EnumTransactionCategory b : EnumTransactionCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumTransactionCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumTransactionCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumTransactionCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumTransactionCategory.fromValue(value);
    }
  }
}
