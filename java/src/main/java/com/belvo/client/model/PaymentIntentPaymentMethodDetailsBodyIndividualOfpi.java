...
public class PaymentIntentPaymentMethodDetailsBodyIndividualOfpi {
  ...
  public PaymentIntentPaymentMethodDetailsBodyIndividualOfpi() {
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "***444777**", value = "The customer's CPF number. Only required when the `customer_type` is `BUSINESS`.  **Note:** This value is obfuscated.")
   ...
   * @return the PaymentIntentPaymentMethodDetailsBodyIndividualOfpi instance itself
   */
  public PaymentIntentPaymentMethodDetailsBodyIndividualOfpi putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentIntentPaymentMethodDetailsBodyIndividualOfpi paymentIntentPaymentMethodDetailsBodyIndividualOfpi = (PaymentIntentPaymentMethodDetailsBodyIndividualOfpi) o;
    return Objects.equals(this.beneficiaryBankAccount, paymentIntentPaymentMethodDetailsBodyIndividualOfpi.beneficiaryBankAccount) &&
        Objects.equals(this.payerInstitution, paymentIntentPaymentMethodDetailsBodyIndividualOfpi.payerInstitution) &&
        Objects.equals(this.callbackUrl, paymentIntentPaymentMethodDetailsBodyIndividualOfpi.callbackUrl) &&
        Objects.equals(this.cpf, paymentIntentPaymentMethodDetailsBodyIndividualOfpi.cpf)&&
        Objects.equals(this.additionalProperties, paymentIntentPaymentMethodDetailsBodyIndividualOfpi.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentIntentPaymentMethodDetailsBodyIndividualOfpi {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentIntentPaymentMethodDetailsBodyIndividualOfpi
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentIntentPaymentMethodDetailsBodyIndividualOfpi is not found in the empty JSON string", PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.openapiRequiredFields) {
      ...
      if (!jsonObj.get("cpf").isJsonNull() && (jsonObj.get("cpf") != null && !jsonObj.get("cpf").isJsonNull()) && !jsonObj.get("cpf").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentIntentPaymentMethodDetailsBodyIndividualOfpi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentIntentPaymentMethodDetailsBodyIndividualOfpi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentIntentPaymentMethodDetailsBodyIndividualOfpi>() {
           @Override
           public void write(JsonWriter out, PaymentIntentPaymentMethodDetailsBodyIndividualOfpi value) throws IOException {
           ...
           @Override
           public PaymentIntentPaymentMethodDetailsBodyIndividualOfpi read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaymentIntentPaymentMethodDetailsBodyIndividualOfpi instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaymentIntentPaymentMethodDetailsBodyIndividualOfpi given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentIntentPaymentMethodDetailsBodyIndividualOfpi
  * @throws IOException if the JSON string is invalid with respect to PaymentIntentPaymentMethodDetailsBodyIndividualOfpi
  */
  public static PaymentIntentPaymentMethodDetailsBodyIndividualOfpi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentIntentPaymentMethodDetailsBodyIndividualOfpi.class);
  }

 /**
  * Convert an instance of PaymentIntentPaymentMethodDetailsBodyIndividualOfpi to an JSON string
  *
  * @return JSON string
  */
