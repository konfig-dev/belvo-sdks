 ...
 */
@ApiModel(description = "Request body for monthly tax returns")
@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TaxReturnsMonthlyRequest {
  ...
  public TaxReturnsMonthlyRequest() {
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of tax return to return. For monthly tax returns, this field must be set to `monthly`. ")
  ...
  **/
   ...
   * @return the TaxReturnsMonthlyRequest instance itself
   */
  public TaxReturnsMonthlyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxReturnsMonthlyRequest taxReturnsMonthlyRequest = (TaxReturnsMonthlyRequest) o;
    return Objects.equals(this.link, taxReturnsMonthlyRequest.link) &&
        Objects.equals(this.attachPdf, taxReturnsMonthlyRequest.attachPdf) &&
        Objects.equals(this.saveData, taxReturnsMonthlyRequest.saveData) &&
        Objects.equals(this.type, taxReturnsMonthlyRequest.type) &&
        Objects.equals(this.dateFrom, taxReturnsMonthlyRequest.dateFrom) &&
        Objects.equals(this.dateTo, taxReturnsMonthlyRequest.dateTo)&&
        Objects.equals(this.additionalProperties, taxReturnsMonthlyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(link, attachPdf, saveData, type, dateFrom, dateTo, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TaxReturnsMonthlyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxReturnsMonthlyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxReturnsMonthlyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxReturnsMonthlyRequest is not found in the empty JSON string", TaxReturnsMonthlyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxReturnsMonthlyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxReturnsMonthlyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxReturnsMonthlyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxReturnsMonthlyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxReturnsMonthlyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxReturnsMonthlyRequest>() {
           @Override
           public void write(JsonWriter out, TaxReturnsMonthlyRequest value) throws IOException {
           ...
           @Override
           public TaxReturnsMonthlyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxReturnsMonthlyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxReturnsMonthlyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxReturnsMonthlyRequest
  * @throws IOException if the JSON string is invalid with respect to TaxReturnsMonthlyRequest
  */
  public static TaxReturnsMonthlyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxReturnsMonthlyRequest.class);
  }

 /**
  * Convert an instance of TaxReturnsMonthlyRequest to an JSON string
  *
  * @return JSON string
  */
