...
public class TokenRequiredResponseTokenGenerationData {
  ...
  public static final String SERIALIZED_NAME_EXPECTS_USER_INPUT = "expects_user_input";
  @SerializedName(SERIALIZED_NAME_EXPECTS_USER_INPUT)
  ...
  **/
   ...
   * @return the TokenRequiredResponseTokenGenerationData instance itself
   */
  public TokenRequiredResponseTokenGenerationData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instructions, tokenRequiredResponseTokenGenerationData.instructions) &&
        ...
        Objects.equals(this.additionalProperties, tokenRequiredResponseTokenGenerationData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instructions, type, value, expectsUserInput, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("expects_user_input");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TokenRequiredResponseTokenGenerationData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TokenRequiredResponseTokenGenerationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenRequiredResponseTokenGenerationData is not found in the empty JSON string", TokenRequiredResponseTokenGenerationData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenRequiredResponseTokenGenerationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenRequiredResponseTokenGenerationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenRequiredResponseTokenGenerationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenRequiredResponseTokenGenerationData.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenRequiredResponseTokenGenerationData>() {
           @Override
           public void write(JsonWriter out, TokenRequiredResponseTokenGenerationData value) throws IOException {
           ...
           @Override
           public TokenRequiredResponseTokenGenerationData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TokenRequiredResponseTokenGenerationData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TokenRequiredResponseTokenGenerationData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenRequiredResponseTokenGenerationData
  * @throws IOException if the JSON string is invalid with respect to TokenRequiredResponseTokenGenerationData
  */
  public static TokenRequiredResponseTokenGenerationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenRequiredResponseTokenGenerationData.class);
  }

 /**
  * Convert an instance of TokenRequiredResponseTokenGenerationData to an JSON string
  *
  * @return JSON string
  */
