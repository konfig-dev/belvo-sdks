...
public class TaxStatusEconomicActivitySat {
  ...
  public TaxStatusEconomicActivitySat() {
  }
  ...
  **/
   ...
   * @return the TaxStatusEconomicActivitySat instance itself
   */
  public TaxStatusEconomicActivitySat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxStatusEconomicActivitySat taxStatusEconomicActivitySat = (TaxStatusEconomicActivitySat) o;
    return Objects.equals(this.economicActivity, taxStatusEconomicActivitySat.economicActivity) &&
        Objects.equals(this.initialDate, taxStatusEconomicActivitySat.initialDate) &&
        Objects.equals(this.endDate, taxStatusEconomicActivitySat.endDate) &&
        Objects.equals(this.order, taxStatusEconomicActivitySat.order) &&
        Objects.equals(this.percentage, taxStatusEconomicActivitySat.percentage)&&
        Objects.equals(this.additionalProperties, taxStatusEconomicActivitySat.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxStatusEconomicActivitySat {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxStatusEconomicActivitySat
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxStatusEconomicActivitySat.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxStatusEconomicActivitySat is not found in the empty JSON string", TaxStatusEconomicActivitySat.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxStatusEconomicActivitySat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxStatusEconomicActivitySat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxStatusEconomicActivitySat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxStatusEconomicActivitySat.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxStatusEconomicActivitySat>() {
           @Override
           public void write(JsonWriter out, TaxStatusEconomicActivitySat value) throws IOException {
           ...
           @Override
           public TaxStatusEconomicActivitySat read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxStatusEconomicActivitySat instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxStatusEconomicActivitySat given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxStatusEconomicActivitySat
  * @throws IOException if the JSON string is invalid with respect to TaxStatusEconomicActivitySat
  */
  public static TaxStatusEconomicActivitySat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxStatusEconomicActivitySat.class);
  }

 /**
  * Convert an instance of TaxStatusEconomicActivitySat to an JSON string
  *
  * @return JSON string
  */
