...
public class InstitutionsFormFieldValues {
  ...
  **/
   ...
   * @return the InstitutionsFormFieldValues instance itself
   */
  public InstitutionsFormFieldValues putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, institutionsFormFieldValues.code) &&
        ...
        Objects.equals(this.additionalProperties, institutionsFormFieldValues.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, label, validation, validationMessage, placeholder, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstitutionsFormFieldValues
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstitutionsFormFieldValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstitutionsFormFieldValues is not found in the empty JSON string", InstitutionsFormFieldValues.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstitutionsFormFieldValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstitutionsFormFieldValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstitutionsFormFieldValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstitutionsFormFieldValues.class));

       return (TypeAdapter<T>) new TypeAdapter<InstitutionsFormFieldValues>() {
           @Override
           public void write(JsonWriter out, InstitutionsFormFieldValues value) throws IOException {
           ...
           @Override
           public InstitutionsFormFieldValues read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstitutionsFormFieldValues instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InstitutionsFormFieldValues given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstitutionsFormFieldValues
  * @throws IOException if the JSON string is invalid with respect to InstitutionsFormFieldValues
  */
  public static InstitutionsFormFieldValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstitutionsFormFieldValues.class);
  }

 /**
  * Convert an instance of InstitutionsFormFieldValues to an JSON string
  *
  * @return JSON string
  */
