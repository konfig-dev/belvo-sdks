...
public class TaxStatusTaxPayerInformationSat {
  ...
  public TaxStatusTaxPayerInformationSat() {
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "BEMP12345G58", required = true, value = "The tax payers's identification number (For Mexico, this is the RFC). ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tax payers's *Clave Única de Registro de Población* (CURP) number. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Date when the tax payer commenced taxable commercial activities. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Status of the taxpayer in the Federal Register of Taxpayers (RFC). Can be `ACTIVO` or `INACTIVO`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Date when `status_padron` was most recently updated. ")
  ...
  **/
   ...
   * @return the TaxStatusTaxPayerInformationSat instance itself
   */
  public TaxStatusTaxPayerInformationSat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TaxStatusTaxPayerInformationSat taxStatusTaxPayerInformationSat = (TaxStatusTaxPayerInformationSat) o;
    return Objects.equals(this.rfc, taxStatusTaxPayerInformationSat.rfc) &&
        Objects.equals(this.curp, taxStatusTaxPayerInformationSat.curp) &&
        Objects.equals(this.name, taxStatusTaxPayerInformationSat.name) &&
        Objects.equals(this.firstLastName, taxStatusTaxPayerInformationSat.firstLastName) &&
        Objects.equals(this.secondLastName, taxStatusTaxPayerInformationSat.secondLastName) &&
        Objects.equals(this.startOperationsDate, taxStatusTaxPayerInformationSat.startOperationsDate) &&
        Objects.equals(this.statusPadron, taxStatusTaxPayerInformationSat.statusPadron) &&
        Objects.equals(this.lastStatusChangeDate, taxStatusTaxPayerInformationSat.lastStatusChangeDate) &&
        Objects.equals(this.commercialName, taxStatusTaxPayerInformationSat.commercialName) &&
        Objects.equals(this.socialName, taxStatusTaxPayerInformationSat.socialName) &&
        Objects.equals(this.email, taxStatusTaxPayerInformationSat.email) &&
        Objects.equals(this.phone, taxStatusTaxPayerInformationSat.phone)&&
        Objects.equals(this.additionalProperties, taxStatusTaxPayerInformationSat.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxStatusTaxPayerInformationSat {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxStatusTaxPayerInformationSat
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxStatusTaxPayerInformationSat.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxStatusTaxPayerInformationSat is not found in the empty JSON string", TaxStatusTaxPayerInformationSat.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxStatusTaxPayerInformationSat.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxStatusTaxPayerInformationSat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxStatusTaxPayerInformationSat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxStatusTaxPayerInformationSat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxStatusTaxPayerInformationSat.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxStatusTaxPayerInformationSat>() {
           @Override
           public void write(JsonWriter out, TaxStatusTaxPayerInformationSat value) throws IOException {
           ...
           @Override
           public TaxStatusTaxPayerInformationSat read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TaxStatusTaxPayerInformationSat instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TaxStatusTaxPayerInformationSat given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxStatusTaxPayerInformationSat
  * @throws IOException if the JSON string is invalid with respect to TaxStatusTaxPayerInformationSat
  */
  public static TaxStatusTaxPayerInformationSat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxStatusTaxPayerInformationSat.class);
  }

 /**
  * Convert an instance of TaxStatusTaxPayerInformationSat to an JSON string
  *
  * @return JSON string
  */
