 ...
 */
@JsonAdapter(EnumRecurringExpenseCategory.Adapter.class)
public enum EnumRecurringExpenseCategory {
  ...
  public static EnumRecurringExpenseCategory fromValue(String value) {
    for (EnumRecurringExpenseCategory b : EnumRecurringExpenseCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumRecurringExpenseCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumRecurringExpenseCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumRecurringExpenseCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumRecurringExpenseCategory.fromValue(value);
    }
  }
}
