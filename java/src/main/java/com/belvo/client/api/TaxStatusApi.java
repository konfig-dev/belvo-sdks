...
import com.belvo.client.model.TaxStatusPaginatedResponse;
import com.belvo.client.model.TaxStatusRequest;
...
public class TaxStatusApi {
    ...
    public TaxStatusApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TaxStatusApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/tax-status/{id}"
     ...
     * @param id the &#x60;tax-status.id&#x60; that you want to delete (required)
     ...
     * @param id The &#x60;tax-status.id&#x60; you want to get detailed information about. (required)
     * @return GetDetailsRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/tax-status";
    ...
    private ApiResponse<TaxStatusPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<TaxStatusPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn, final ApiCallback<TaxStatusPaginatedResponse> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set createdAtGt
         * @param createdAtGt Return tax statuses that were last updated in Belvo&#39;s database after this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtGte
         * @param createdAtGte Return tax statuses that were last updated in Belvo&#39;s database after or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLt
         * @param createdAtLt Return tax statuses that were last updated in Belvo&#39;s database before this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLte
         * @param createdAtLte Return tax statuses that were last updated in Belvo&#39;s database before or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtRange
         * @param createdAtRange Return tax statuses that were last updated in Belvo&#39;s database between two dates (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set id
         * @param id Return information for this &#x60;tax-status.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set idIn
         * @param idIn Return information for these &#x60;tax-status.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
         ...
         * @return TaxStatusPaginatedResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public TaxStatusPaginatedResponse execute() throws ApiException {
            ApiResponse<TaxStatusPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;TaxStatusPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TaxStatusPaginatedResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TaxStatusPaginatedResponse> _callback) throws ApiException {
    ...
    private okhttp3.Call retrieveCall(TaxStatusRequest taxStatusRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = taxStatusRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveValidateBeforeCall(TaxStatusRequest taxStatusRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'taxStatusRequest' is set
        if (taxStatusRequest == null) {
            throw new ApiException("Missing the required parameter 'taxStatusRequest' when calling retrieve(Async)");
        }

        return retrieveCall(taxStatusRequest, omit, fields, _callback);

    }


    private ApiResponse<Object> retrieveWithHttpInfo(TaxStatusRequest taxStatusRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxStatusRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(TaxStatusRequest taxStatusRequest, String omit, String fields, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxStatusRequest, omit, fields, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class RetrieveRequestBuilder {
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TaxStatusRequest taxStatusRequest = buildBodyParams();
            return retrieveCall(taxStatusRequest, omit, fields, _callback);
        }

        private TaxStatusRequest buildBodyParams() {
            TaxStatusRequest taxStatusRequest = new TaxStatusRequest();
            taxStatusRequest.link(this.link);
            taxStatusRequest.attachPdf(this.attachPdf);
            taxStatusRequest.saveData(this.saveData);
            return taxStatusRequest;
        }
        ...
        public Object execute() throws ApiException {
            TaxStatusRequest taxStatusRequest = buildBodyParams();
            ApiResponse<Object> localVarResp = retrieveWithHttpInfo(taxStatusRequest, omit, fields);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            TaxStatusRequest taxStatusRequest = buildBodyParams();
            return retrieveWithHttpInfo(taxStatusRequest, omit, fields);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            TaxStatusRequest taxStatusRequest = buildBodyParams();
            return retrieveAsync(taxStatusRequest, omit, fields, _callback);
        }
    }
     ...
     * @param taxStatusRequest  (required)
     * @return RetrieveRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
