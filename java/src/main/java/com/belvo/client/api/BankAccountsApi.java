...
import com.belvo.client.model.BankAccountPaginatedResponse;
...
public class BankAccountsApi {
    ...
    public BankAccountsApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public BankAccountsApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createCall(Object body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/payments/bank-accounts";
    ...
    private okhttp3.Call getDetailsCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payments/bank-accounts/{id}"
     ...
     * @param id The &#x60;bank-account.id&#x60; you want to get detailed information about. (required)
    ...
    private okhttp3.Call listCall(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String number, String numberIn, String customer, String institution, String holderType, String holderTypeIn, String providers, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (holderType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("holder__type", holderType));
        }

        if (holderTypeIn != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("holder__type__in", holderTypeIn));
        }
    ...
    private okhttp3.Call listValidateBeforeCall(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String number, String numberIn, String customer, String institution, String holderType, String holderTypeIn, String providers, final ApiCallback _callback) throws ApiException {
        return listCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers, _callback);

    }


    private ApiResponse<BankAccountPaginatedResponse> listWithHttpInfo(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String number, String numberIn, String customer, String institution, String holderType, String holderTypeIn, String providers) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers, null);
        Type localVarReturnType = new TypeToken<BankAccountPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String number, String numberIn, String customer, String institution, String holderType, String holderTypeIn, String providers, final ApiCallback<BankAccountPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers, _callback);
        Type localVarReturnType = new TypeToken<BankAccountPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set idIn
         * @param idIn One or more &#x60;bank-account.id&#x60;s (comma separated) that you want to get results for. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set number
         * @param number Return results that exactly match a value. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set numberIn
         * @param numberIn Return results for listed numbers. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set institution
         * @param institution The &#x60;institution.id&#x60; you want to get results for. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set holderType
         * @param holderType Return results for a matched value type. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder holderType(String holderType) {
        ...
        /**
         * Set holderTypeIn
         * @param holderTypeIn Return results for listed holder types. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder holderTypeIn(String holderTypeIn) {
        ...
        /**
         * Set providers
         * @param providers Return results only for this value. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder providers(String providers) {
         ...
         * @return BankAccountPaginatedResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public BankAccountPaginatedResponse execute() throws ApiException {
            ApiResponse<BankAccountPaginatedResponse> localVarResp = listWithHttpInfo(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;BankAccountPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<BankAccountPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<BankAccountPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, number, numberIn, customer, institution, holderType, holderTypeIn, providers, _callback);
        }
    }
