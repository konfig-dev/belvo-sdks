...
import com.belvo.client.model.RiskInsights;
import com.belvo.client.model.RiskInsightsPaginatedResponse;
...
public class RiskInsightsApi {
    ...
    public RiskInsightsApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RiskInsightsApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call completeRequestCall(PatchBody patchBody, String omit, String fields, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/risk-insights";
    ...
    private ApiResponse<List<RiskInsights>> completeRequestWithHttpInfo(PatchBody patchBody, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = completeRequestValidateBeforeCall(patchBody, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<RiskInsights>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call completeRequestAsync(PatchBody patchBody, String omit, String fields, final ApiCallback<List<RiskInsights>> _callback) throws ApiException {
    ...
    public class CompleteRequestRequestBuilder {
         ...
         */
        public List<RiskInsights> execute() throws ApiException {
            PatchBody patchBody = buildBodyParams();
            ApiResponse<List<RiskInsights>> localVarResp = completeRequestWithHttpInfo(patchBody, omit, fields);
            return localVarResp.getData();
        }

        /**
         * Execute completeRequest request with HTTP info returned
         * @return ApiResponse&lt;List&lt;RiskInsights&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<RiskInsights>> executeWithHttpInfo() throws ApiException {
            PatchBody patchBody = buildBodyParams();
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<RiskInsights>> _callback) throws ApiException {
            PatchBody patchBody = buildBodyParams();
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/risk-insights/{id}"
    ...
    private ApiResponse<List<RiskInsights>> getDetailsWithHttpInfo(UUID id, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(id, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<RiskInsights>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(UUID id, String omit, String fields, final ApiCallback<List<RiskInsights>> _callback) throws ApiException {
    ...
    public class GetDetailsRequestBuilder {
         ...
         */
        public List<RiskInsights> execute() throws ApiException {
            ApiResponse<List<RiskInsights>> localVarResp = getDetailsWithHttpInfo(id, omit, fields);
            return localVarResp.getData();
        }
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String id, String idIn, String linkIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String id, String idIn, String linkIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, pageSize, omit, fields, link, id, idIn, linkIn, _callback);

    }


    private ApiResponse<RiskInsightsPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID link, String id, String idIn, String linkIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, id, idIn, linkIn, null);
        Type localVarReturnType = new TypeToken<RiskInsightsPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID link, String id, String idIn, String linkIn, final ApiCallback<RiskInsightsPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, id, idIn, linkIn, _callback);
        Type localVarReturnType = new TypeToken<RiskInsightsPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set id
         * @param id Return information for this &#x60;risk-insight.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set idIn
         * @param idIn Return information for these &#x60;risk-insight.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
         ...
         */
        public RiskInsightsPaginatedResponse execute() throws ApiException {
            ApiResponse<RiskInsightsPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, link, id, idIn, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;RiskInsightsPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RiskInsightsPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, pageSize, omit, fields, link, id, idIn, linkIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RiskInsightsPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, pageSize, omit, fields, link, id, idIn, linkIn, _callback);
        }
    }
    ...
    private ApiResponse<List<RiskInsights>> retrieveWithHttpInfo(StandardRequest standardRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(standardRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<RiskInsights>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(StandardRequest standardRequest, String omit, String fields, final ApiCallback<List<RiskInsights>> _callback) throws ApiException {
    ...
    public class RetrieveRequestBuilder {
        ...
        public List<RiskInsights> execute() throws ApiException {
            StandardRequest standardRequest = buildBodyParams();
            ApiResponse<List<RiskInsights>> localVarResp = retrieveWithHttpInfo(standardRequest, omit, fields);
            return localVarResp.getData();
        }
