...
import com.belvo.client.model.TaxRetentions;
import com.belvo.client.model.TaxRetentionsPaginatedResponse;
import com.belvo.client.model.TaxRetentionsRequest;
...
public class TaxRetentionsApi {
    ...
    public TaxRetentionsApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TaxRetentionsApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/tax-retentions/{id}"
    ...
    private ApiResponse<TaxRetentions> getDetailsWithHttpInfo(UUID id, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(id, omit, fields, null);
        Type localVarReturnType = new TypeToken<TaxRetentions>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(UUID id, String omit, String fields, final ApiCallback<TaxRetentions> _callback) throws ApiException {
    ...
    public class GetDetailsRequestBuilder {
         ...
         */
        public TaxRetentions execute() throws ApiException {
            ApiResponse<TaxRetentions> localVarResp = getDetailsWithHttpInfo(id, omit, fields);
            return localVarResp.getData();
        }

        /**
         * Execute getDetails request with HTTP info returned
         * @return ApiResponse&lt;TaxRetentions&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TaxRetentions> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TaxRetentions> _callback) throws ApiException {
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String linkIn, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/tax-retentions";
    ...
    private ApiResponse<TaxRetentionsPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String linkIn) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<TaxRetentionsPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String linkIn, final ApiCallback<TaxRetentionsPaginatedResponse> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set createdAtGt
         * @param createdAtGt Return tax retentions that were last updated in Belvo&#39;s database after this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtGte
         * @param createdAtGte Return tax retentions that were last updated in Belvo&#39;s database after or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLt
         * @param createdAtLt Return tax retentions that were last updated in Belvo&#39;s database before this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLte
         * @param createdAtLte Return tax retentions that were last updated in Belvo&#39;s database before or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtRange
         * @param createdAtRange Return tax retentions that were last updated in Belvo&#39;s database between two dates (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
         ...
         */
        public TaxRetentionsPaginatedResponse execute() throws ApiException {
            ApiResponse<TaxRetentionsPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;TaxRetentionsPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TaxRetentionsPaginatedResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TaxRetentionsPaginatedResponse> _callback) throws ApiException {
    ...
    private okhttp3.Call retrieveCall(TaxRetentionsRequest taxRetentionsRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveValidateBeforeCall(TaxRetentionsRequest taxRetentionsRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'taxRetentionsRequest' is set
        if (taxRetentionsRequest == null) {
            throw new ApiException("Missing the required parameter 'taxRetentionsRequest' when calling retrieve(Async)");
        }

        return retrieveCall(taxRetentionsRequest, omit, fields, _callback);

    }


    private ApiResponse<List<TaxRetentions>> retrieveWithHttpInfo(TaxRetentionsRequest taxRetentionsRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxRetentionsRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<TaxRetentions>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(TaxRetentionsRequest taxRetentionsRequest, String omit, String fields, final ApiCallback<List<TaxRetentions>> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxRetentionsRequest, omit, fields, _callback);
        Type localVarReturnType = new TypeToken<List<TaxRetentions>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class RetrieveRequestBuilder {
        ...
        private RetrieveRequestBuilder(UUID link, String dateFrom, String dateTo, EnumTaxRetentionType type) {
            this.link = link;
        ...
        /**
         * Set attachXml
         * @param attachXml When set to &#x60;true&#x60;, you will receive the XML tax retention in the response. (optional, default to true)
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TaxRetentionsRequest taxRetentionsRequest = buildBodyParams();
            return retrieveCall(taxRetentionsRequest, omit, fields, _callback);
        }

        private TaxRetentionsRequest buildBodyParams() {
            TaxRetentionsRequest taxRetentionsRequest = new TaxRetentionsRequest();
            taxRetentionsRequest.link(this.link);
            taxRetentionsRequest.dateFrom(this.dateFrom);
            taxRetentionsRequest.dateTo(this.dateTo);
            taxRetentionsRequest.type(this.type);
            taxRetentionsRequest.attachXml(this.attachXml);
            taxRetentionsRequest.saveData(this.saveData);
            return taxRetentionsRequest;
        }
         ...
         */
        public List<TaxRetentions> execute() throws ApiException {
            TaxRetentionsRequest taxRetentionsRequest = buildBodyParams();
            ApiResponse<List<TaxRetentions>> localVarResp = retrieveWithHttpInfo(taxRetentionsRequest, omit, fields);
            return localVarResp.getData();
        }

        /**
         * Execute retrieve request with HTTP info returned
         * @return ApiResponse&lt;List&lt;TaxRetentions&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<TaxRetentions>> executeWithHttpInfo() throws ApiException {
            TaxRetentionsRequest taxRetentionsRequest = buildBodyParams();
            return retrieveWithHttpInfo(taxRetentionsRequest, omit, fields);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<TaxRetentions>> _callback) throws ApiException {
            TaxRetentionsRequest taxRetentionsRequest = buildBodyParams();
            return retrieveAsync(taxRetentionsRequest, omit, fields, _callback);
        }
    }
     ...
     */
    public RetrieveRequestBuilder retrieve(UUID link, String dateFrom, String dateTo, EnumTaxRetentionType type) throws IllegalArgumentException {
