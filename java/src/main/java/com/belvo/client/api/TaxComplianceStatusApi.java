...
import com.belvo.client.model.TaxComplianceStatus;
import com.belvo.client.model.TaxComplianceStatusPaginatedResponse;
import com.belvo.client.model.TaxComplianceStatusRequest;
...
public class TaxComplianceStatusApi {
    ...
    public TaxComplianceStatusApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TaxComplianceStatusApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/tax-compliance-status/{id}"
    ...
    private ApiResponse<TaxComplianceStatus> getDetailsWithHttpInfo(UUID id, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(id, omit, fields, null);
        Type localVarReturnType = new TypeToken<TaxComplianceStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(UUID id, String omit, String fields, final ApiCallback<TaxComplianceStatus> _callback) throws ApiException {
    ...
    public class GetDetailsRequestBuilder {
         ...
         */
        public TaxComplianceStatus execute() throws ApiException {
            ApiResponse<TaxComplianceStatus> localVarResp = getDetailsWithHttpInfo(id, omit, fields);
            return localVarResp.getData();
        }

        /**
         * Execute getDetails request with HTTP info returned
         * @return ApiResponse&lt;TaxComplianceStatus&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TaxComplianceStatus> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TaxComplianceStatus> _callback) throws ApiException {
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/tax-compliance-status";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn, _callback);

    }


    private ApiResponse<TaxComplianceStatusPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn, null);
        Type localVarReturnType = new TypeToken<TaxComplianceStatusPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String linkIn, final ApiCallback<TaxComplianceStatusPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn, _callback);
        Type localVarReturnType = new TypeToken<TaxComplianceStatusPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set createdAtGt
         * @param createdAtGt Return tax compliance statuses that were last updated in Belvo&#39;s database after this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtGte
         * @param createdAtGte Return tax compliance statuses that were last updated in Belvo&#39;s database after or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLt
         * @param createdAtLt Return tax compliance statuses that were last updated in Belvo&#39;s database before this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLte
         * @param createdAtLte Return tax compliance statuses that were last updated in Belvo&#39;s database before or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtRange
         * @param createdAtRange Return tax compliance statuses that were last updated in Belvo&#39;s database between two dates (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set id
         * @param id Return information for this &#x60;tax-compliance-status.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set idIn
         * @param idIn Return information for these &#x60;tax-compliance-status.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
         ...
         */
        public TaxComplianceStatusPaginatedResponse execute() throws ApiException {
            ApiResponse<TaxComplianceStatusPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;TaxComplianceStatusPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<TaxComplianceStatusPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TaxComplianceStatusPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, linkIn, _callback);
        }
    }
    ...
    private okhttp3.Call retrieveCall(TaxComplianceStatusRequest taxComplianceStatusRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveValidateBeforeCall(TaxComplianceStatusRequest taxComplianceStatusRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'taxComplianceStatusRequest' is set
        if (taxComplianceStatusRequest == null) {
            throw new ApiException("Missing the required parameter 'taxComplianceStatusRequest' when calling retrieve(Async)");
        }

        return retrieveCall(taxComplianceStatusRequest, omit, fields, _callback);

    }


    private ApiResponse<TaxComplianceStatus> retrieveWithHttpInfo(TaxComplianceStatusRequest taxComplianceStatusRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxComplianceStatusRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<TaxComplianceStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(TaxComplianceStatusRequest taxComplianceStatusRequest, String omit, String fields, final ApiCallback<TaxComplianceStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveValidateBeforeCall(taxComplianceStatusRequest, omit, fields, _callback);
        Type localVarReturnType = new TypeToken<TaxComplianceStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class RetrieveRequestBuilder {
        ...
        /**
         * Set attachPdf
         * @param attachPdf When set to &#x60;true&#x60;, you will receive the PDF in binary format in the response. (optional, default to false)
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            TaxComplianceStatusRequest taxComplianceStatusRequest = buildBodyParams();
            return retrieveCall(taxComplianceStatusRequest, omit, fields, _callback);
        }

        private TaxComplianceStatusRequest buildBodyParams() {
            TaxComplianceStatusRequest taxComplianceStatusRequest = new TaxComplianceStatusRequest();
            taxComplianceStatusRequest.link(this.link);
            taxComplianceStatusRequest.attachPdf(this.attachPdf);
            taxComplianceStatusRequest.saveData(this.saveData);
            return taxComplianceStatusRequest;
        }
        ...
        public TaxComplianceStatus execute() throws ApiException {
            TaxComplianceStatusRequest taxComplianceStatusRequest = buildBodyParams();
            ApiResponse<TaxComplianceStatus> localVarResp = retrieveWithHttpInfo(taxComplianceStatusRequest, omit, fields);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<TaxComplianceStatus> executeWithHttpInfo() throws ApiException {
            TaxComplianceStatusRequest taxComplianceStatusRequest = buildBodyParams();
            return retrieveWithHttpInfo(taxComplianceStatusRequest, omit, fields);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<TaxComplianceStatus> _callback) throws ApiException {
            TaxComplianceStatusRequest taxComplianceStatusRequest = buildBodyParams();
            return retrieveAsync(taxComplianceStatusRequest, omit, fields, _callback);
        }
    }
