...
public class PaymentIntentsApi {
    ...
    public PaymentIntentsApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PaymentIntentsApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call completeCall(UUID id, PatchPaymentIntentPse patchPaymentIntentPse, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = patchPaymentIntentPse;

        // create path and map variables
        String localVarPath = "/payments/payment-intents/{id}"
    ...
    private okhttp3.Call completeValidateBeforeCall(UUID id, PatchPaymentIntentPse patchPaymentIntentPse, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling complete(Async)");
        }

        return completeCall(id, patchPaymentIntentPse, _callback);

    }


    private ApiResponse<Object> completeWithHttpInfo(UUID id, PatchPaymentIntentPse patchPaymentIntentPse) throws ApiException {
        okhttp3.Call localVarCall = completeValidateBeforeCall(id, patchPaymentIntentPse, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call completeAsync(UUID id, PatchPaymentIntentPse patchPaymentIntentPse, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = completeValidateBeforeCall(id, patchPaymentIntentPse, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
    ...
    public class CompleteRequestBuilder {
        private final Object paymentMethodDetails;
        private final UUID id;
        private Boolean confirm;

        private CompleteRequestBuilder(Object paymentMethodDetails, UUID id) {
        ...
        /**
         * Set confirm
         * @param confirm Boolean that indicates whether this request confirms the payment intent.   **Note:** You&#39;ll need to send this parameter set to &#x60;true&#x60; when the payment intent next_step returns &#x60;ready_to_confirm: true&#x60;, meaning the payment intent is ready to be confirmed.  (optional)
         * @return CompleteRequestBuilder
         */
        public CompleteRequestBuilder confirm(Boolean confirm) {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> OK (Created) </td><td>  -  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            PatchPaymentIntentPse patchPaymentIntentPse = buildBodyParams();
            return completeCall(id, patchPaymentIntentPse, _callback);
        }

        private PatchPaymentIntentPse buildBodyParams() {
            PatchPaymentIntentPse patchPaymentIntentPse = new PatchPaymentIntentPse();
            patchPaymentIntentPse.paymentMethodDetails(this.paymentMethodDetails);
            patchPaymentIntentPse.confirm(this.confirm);
            return patchPaymentIntentPse;
        }
        ...
        public Object execute() throws ApiException {
            PatchPaymentIntentPse patchPaymentIntentPse = buildBodyParams();
            ApiResponse<Object> localVarResp = completeWithHttpInfo(id, patchPaymentIntentPse);
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            PatchPaymentIntentPse patchPaymentIntentPse = buildBodyParams();
            return completeWithHttpInfo(id, patchPaymentIntentPse);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            PatchPaymentIntentPse patchPaymentIntentPse = buildBodyParams();
            return completeAsync(id, patchPaymentIntentPse, _callback);
        }
    }
     ...
     * @param id The &#x60;payment-intent.id&#x60; you want to get detailed information about. (required)
     * @return CompleteRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public CompleteRequestBuilder complete(Object paymentMethodDetails, UUID id) throws IllegalArgumentException {
        
        if (id == null) throw new IllegalArgumentException("\"id\" is required but got null");
        return new CompleteRequestBuilder(paymentMethodDetails, id);
    }
    private okhttp3.Call createCall(Object body, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/payments/payment-intents";
    ...
    private okhttp3.Call listCall(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String provider, String paymentMethodType, String customer, String customerIn, String amount, String amountGt, String amountGte, String amountLt, String amountLte, String status, String statusIn, final ApiCallback _callback) throws ApiException {
        ...
        if (paymentMethodType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("payment_method_type", paymentMethodType));
        }
        ...
        if (customerIn != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("customer__in", customerIn));
        }
    ...
    private okhttp3.Call listValidateBeforeCall(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String provider, String paymentMethodType, String customer, String customerIn, String amount, String amountGt, String amountGte, String amountLt, String amountLte, String status, String statusIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn, _callback);

    }


    private ApiResponse<PaymentIntentPaginatedResponse> listWithHttpInfo(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String provider, String paymentMethodType, String customer, String customerIn, String amount, String amountGt, String amountGte, String amountLt, String amountLte, String status, String statusIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn, null);
        Type localVarReturnType = new TypeToken<PaymentIntentPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, String idIn, String createdAt, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String provider, String paymentMethodType, String customer, String customerIn, String amount, String amountGt, String amountGte, String amountLt, String amountLte, String status, String statusIn, final ApiCallback<PaymentIntentPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn, _callback);
        Type localVarReturnType = new TypeToken<PaymentIntentPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set idIn
         * @param idIn One or more &#x60;payment-intent.id&#x60;s (comma separated) that you want to get results for. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set provider
         * @param provider Return results only for this value. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder provider(String provider) {
         ...
         * @param paymentMethodType Return results only for this value. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder paymentMethodType(String paymentMethodType) {
        ...
        /**
         * Set customer
         * @param customer The &#x60;customer.id&#x60; you want to get results for. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder customer(String customer) {
        ...
        /**
         * Set customerIn
         * @param customerIn One or more &#x60;customer.id&#x60;s (comma separated) that you want to get results for. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder customerIn(String customerIn) {
        ...
        /**
         * Set status
         * @param status Return results only for this value. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set statusIn
         * @param statusIn Return results for listed status. (optional)
         * @return ListRequestBuilder
         */
         ...
         * @return PaymentIntentPaginatedResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public PaymentIntentPaginatedResponse execute() throws ApiException {
            ApiResponse<PaymentIntentPaginatedResponse> localVarResp = listWithHttpInfo(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;PaymentIntentPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<PaymentIntentPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PaymentIntentPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, idIn, createdAt, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, provider, paymentMethodType, customer, customerIn, amount, amountGt, amountGte, amountLt, amountLte, status, statusIn, _callback);
        }
    }
