...
public class TaxReturnsApi {
    ...
    public TaxReturnsApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public TaxReturnsApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/tax-returns/{id}"
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String ejercicio, String ejercicioLt, String ejercicioLte, String ejercicioGt, String ejercicioGte, String ejercicioRange, String tipoDeclaracion, String tipoDeclaracionIn, String linkIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/tax-returns";
        ...
        if (ejercicio != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio", ejercicio));
        }

        if (ejercicioLt != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio__lt", ejercicioLt));
        }

        if (ejercicioLte != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio__lte", ejercicioLte));
        }

        if (ejercicioGt != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio__gt", ejercicioGt));
        }

        if (ejercicioGte != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio__gte", ejercicioGte));
        }

        if (ejercicioRange != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ejercicio__range", ejercicioRange));
        }

        if (tipoDeclaracion != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("tipo_declaracion", tipoDeclaracion));
        }

        if (tipoDeclaracionIn != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("tipo_declaracion__in", tipoDeclaracionIn));
        }
    ...
    private okhttp3.Call listValidateBeforeCall(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String ejercicio, String ejercicioLt, String ejercicioLte, String ejercicioGt, String ejercicioGte, String ejercicioRange, String tipoDeclaracion, String tipoDeclaracionIn, String linkIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn, _callback);

    }


    private ApiResponse<Object> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String ejercicio, String ejercicioLt, String ejercicioLte, String ejercicioGt, String ejercicioGte, String ejercicioRange, String tipoDeclaracion, String tipoDeclaracionIn, String linkIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID link, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String id, String idIn, String ejercicio, String ejercicioLt, String ejercicioLte, String ejercicioGt, String ejercicioGte, String ejercicioRange, String tipoDeclaracion, String tipoDeclaracionIn, String linkIn, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private String ejercicioLt;
        private String ejercicioLte;
        private String ejercicioGt;
        private String ejercicioGte;
        private String ejercicioRange;
        private String tipoDeclaracion;
        private String tipoDeclaracionIn;
        ...
        /**
         * Set createdAtGt
         * @param createdAtGt Return tax returns that were last updated in Belvo&#39;s database after this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtGte
         * @param createdAtGte Return tax returns that were last updated in Belvo&#39;s database after or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLt
         * @param createdAtLt Return tax returns that were last updated in Belvo&#39;s database before this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLte
         * @param createdAtLte Return tax returns that were last updated in Belvo&#39;s database before or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtRange
         * @param createdAtRange Return tax returns that were last updated in Belvo&#39;s database between two dates (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set id
         * @param id Return information for this &#x60;tax-return.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set idIn
         * @param idIn Return information for these &#x60;tax-return.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set ejercicio
         * @param ejercicio Return tax returns for exactly this year (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicio(String ejercicio) {
        ...
        /**
         * Set ejercicioLt
         * @param ejercicioLt Return tax returns for before this year (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicioLt(String ejercicioLt) {
        ...
        /**
         * Set ejercicioLte
         * @param ejercicioLte Return tax returns for this year and earlier (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicioLte(String ejercicioLte) {
        ...
        /**
         * Set ejercicioGt
         * @param ejercicioGt Return tax returns for after this year (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicioGt(String ejercicioGt) {
        ...
        /**
         * Set ejercicioGte
         * @param ejercicioGte Return tax returns for this year or later (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicioGte(String ejercicioGte) {
        ...
        /**
         * Set ejercicioRange
         * @param ejercicioRange Return tax returns for this range of years (&#x60;YYYY&#x60;). (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder ejercicioRange(String ejercicioRange) {
        ...
        /**
         * Set tipoDeclaracion
         * @param tipoDeclaracion Return tax returns with this declaration type. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder tipoDeclaracion(String tipoDeclaracion) {
            this.tipoDeclaracion = tipoDeclaracion;
            return this;
        }
        
        /**
         * Set tipoDeclaracionIn
         * @param tipoDeclaracionIn Return tax returns with these declaration types. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder tipoDeclaracionIn(String tipoDeclaracionIn) {
         ...
         */
        public Object execute() throws ApiException {
            ApiResponse<Object> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            return listAsync(page, pageSize, omit, fields, link, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, id, idIn, ejercicio, ejercicioLt, ejercicioLte, ejercicioGt, ejercicioGte, ejercicioRange, tipoDeclaracion, tipoDeclaracionIn, linkIn, _callback);
        }
    }
    ...
    private okhttp3.Call retrieveCall(Object body, String omit, String fields, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveValidateBeforeCall(Object body, String omit, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling retrieve(Async)");
        }

        return retrieveCall(body, omit, fields, _callback);

    }


    private ApiResponse<List<Object>> retrieveWithHttpInfo(Object body, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(body, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(Object body, String omit, String fields, final ApiCallback<List<Object>> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveValidateBeforeCall(body, omit, fields, _callback);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class RetrieveRequestBuilder {
        ...
        public List<Object> execute() throws ApiException {
            Object body = buildBodyParams();
            ApiResponse<List<Object>> localVarResp = retrieveWithHttpInfo(body, omit, fields);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<List<Object>> executeWithHttpInfo() throws ApiException {
            Object body = buildBodyParams();
            return retrieveWithHttpInfo(body, omit, fields);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<Object>> _callback) throws ApiException {
            Object body = buildBodyParams();
            return retrieveAsync(body, omit, fields, _callback);
        }
    }
     ...
     */
    public RetrieveRequestBuilder retrieve() throws IllegalArgumentException {
