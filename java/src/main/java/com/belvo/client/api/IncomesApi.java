...
import com.belvo.client.model.IncomesPaginatedResponse;
import com.belvo.client.model.IncomesRequest;
...
public class IncomesApi {
    ...
    public IncomesApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public IncomesApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<List<Income>> completeRequestWithHttpInfo(PatchBody patchBody, String omit, String fields) throws ApiException {
    ...
    private okhttp3.Call completeRequestAsync(PatchBody patchBody, String omit, String fields, final ApiCallback<List<Income>> _callback) throws ApiException {
    ...
    public class CompleteRequestRequestBuilder {
        ...
        public List<Income> execute() throws ApiException {
            PatchBody patchBody = buildBodyParams();
            ApiResponse<List<Income>> localVarResp = completeRequestWithHttpInfo(patchBody, omit, fields);
    ...
    private ApiResponse<List<Income>> getDetailsWithHttpInfo(UUID id, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(id, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<Income>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(UUID id, String omit, String fields, final ApiCallback<List<Income>> _callback) throws ApiException {
    ...
    public class GetDetailsRequestBuilder {
         ...
         */
        public List<Income> execute() throws ApiException {
            ApiResponse<List<Income>> localVarResp = getDetailsWithHttpInfo(id, omit, fields);
            return localVarResp.getData();
        }
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, UUID account, String accountIn, String link, String linkIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer page, Integer pageSize, String omit, String fields, UUID account, String accountIn, String link, String linkIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, pageSize, omit, fields, account, accountIn, link, linkIn, _callback);

    }


    private ApiResponse<IncomesPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, UUID account, String accountIn, String link, String linkIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, account, accountIn, link, linkIn, null);
        Type localVarReturnType = new TypeToken<IncomesPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, UUID account, String accountIn, String link, String linkIn, final ApiCallback<IncomesPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, account, accountIn, link, linkIn, _callback);
        Type localVarReturnType = new TypeToken<IncomesPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        /**
         * Set accountIn
         * @param accountIn Return incomes for these &#x60;account.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set linkIn
         * @param linkIn Return incomes only for these &#x60;link.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
         ...
         */
        public IncomesPaginatedResponse execute() throws ApiException {
            ApiResponse<IncomesPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, account, accountIn, link, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;IncomesPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<IncomesPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, pageSize, omit, fields, account, accountIn, link, linkIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<IncomesPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, pageSize, omit, fields, account, accountIn, link, linkIn, _callback);
        }
    }
    ...
    private okhttp3.Call retrieveCall(IncomesRequest incomesRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveValidateBeforeCall(IncomesRequest incomesRequest, String omit, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'incomesRequest' is set
        if (incomesRequest == null) {
            throw new ApiException("Missing the required parameter 'incomesRequest' when calling retrieve(Async)");
        }

        return retrieveCall(incomesRequest, omit, fields, _callback);

    }


    private ApiResponse<Income> retrieveWithHttpInfo(IncomesRequest incomesRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(incomesRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<Income>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(IncomesRequest incomesRequest, String omit, String fields, final ApiCallback<Income> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveValidateBeforeCall(incomesRequest, omit, fields, _callback);
        Type localVarReturnType = new TypeToken<Income>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class RetrieveRequestBuilder {
         ...
         */
        public RetrieveRequestBuilder allowedIncomeTypes(List<EnumInvoiceAllowedIncomeTypesRequest> allowedIncomeTypes) {
         ...
         * @return RetrieveRequestBuilder
         */
        public RetrieveRequestBuilder minimumConfidenceLevel(EnumIncomeMinimumConfidenceLevelRequest minimumConfidenceLevel) {
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            IncomesRequest incomesRequest = buildBodyParams();
            return retrieveCall(incomesRequest, omit, fields, _callback);
        }

        private IncomesRequest buildBodyParams() {
            IncomesRequest incomesRequest = new IncomesRequest();
            incomesRequest.link(this.link);
            incomesRequest.allowedIncomeTypes(this.allowedIncomeTypes);
            incomesRequest.minimumConfidenceLevel(this.minimumConfidenceLevel);
            incomesRequest.dateFrom(this.dateFrom);
            incomesRequest.dateTo(this.dateTo);
            incomesRequest.token(this.token);
            incomesRequest.saveData(this.saveData);
            return incomesRequest;
        }
         ...
         */
        public Income execute() throws ApiException {
            IncomesRequest incomesRequest = buildBodyParams();
            ApiResponse<Income> localVarResp = retrieveWithHttpInfo(incomesRequest, omit, fields);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<Income> executeWithHttpInfo() throws ApiException {
            IncomesRequest incomesRequest = buildBodyParams();
            return retrieveWithHttpInfo(incomesRequest, omit, fields);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Income> _callback) throws ApiException {
            IncomesRequest incomesRequest = buildBodyParams();
            return retrieveAsync(incomesRequest, omit, fields, _callback);
        }
    }
