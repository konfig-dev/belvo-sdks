...
import com.belvo.client.model.Owner;
import com.belvo.client.model.OwnersPaginatedResponse;
...
public class OwnersApi {
    ...
    public OwnersApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public OwnersApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call completeRequestCall(PatchBody patchBody, String omit, String fields, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/owners";
    ...
    private ApiResponse<List<Owner>> completeRequestWithHttpInfo(PatchBody patchBody, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = completeRequestValidateBeforeCall(patchBody, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<Owner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call completeRequestAsync(PatchBody patchBody, String omit, String fields, final ApiCallback<List<Owner>> _callback) throws ApiException {
    ...
    public class CompleteRequestRequestBuilder {
         ...
         */
        public List<Owner> execute() throws ApiException {
            PatchBody patchBody = buildBodyParams();
            ApiResponse<List<Owner>> localVarResp = completeRequestWithHttpInfo(patchBody, omit, fields);
            return localVarResp.getData();
        }

        /**
         * Execute completeRequest request with HTTP info returned
         * @return ApiResponse&lt;List&lt;Owner&gt;&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<List<Owner>> executeWithHttpInfo() throws ApiException {
            PatchBody patchBody = buildBodyParams();
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<Owner>> _callback) throws ApiException {
            PatchBody patchBody = buildBodyParams();
    ...
    private okhttp3.Call deleteCall(UUID id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/owners/{id}"
     ...
     * @param id The &#x60;owner.id&#x60; that you want to delete. (required)
    ...
    private ApiResponse<Owner> getDetailsWithHttpInfo(UUID id, String omit, String fields) throws ApiException {
    ...
    private okhttp3.Call getDetailsAsync(UUID id, String omit, String fields, final ApiCallback<Owner> _callback) throws ApiException {
    ...
    public class GetDetailsRequestBuilder {
         ...
         */
        public Owner execute() throws ApiException {
            ApiResponse<Owner> localVarResp = getDetailsWithHttpInfo(id, omit, fields);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<Owner> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Owner> _callback) throws ApiException {
     ...
     * @param id The &#x60;owner.id&#x60; you want to get detailed information about. (required)
     * @return GetDetailsRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    private okhttp3.Call listCall(Integer page, Integer pageSize, String omit, String fields, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String displayNameIcontains, String email, String id, String idIn, String link, String linkIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (displayNameIcontains != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("display_name__icontains", displayNameIcontains));
        }
    ...
    private okhttp3.Call listValidateBeforeCall(Integer page, Integer pageSize, String omit, String fields, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String displayNameIcontains, String email, String id, String idIn, String link, String linkIn, final ApiCallback _callback) throws ApiException {
        return listCall(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn, _callback);

    }


    private ApiResponse<OwnersPaginatedResponse> listWithHttpInfo(Integer page, Integer pageSize, String omit, String fields, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String displayNameIcontains, String email, String id, String idIn, String link, String linkIn) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn, null);
        Type localVarReturnType = new TypeToken<OwnersPaginatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer page, Integer pageSize, String omit, String fields, String createdAtGt, String createdAtGte, String createdAtLt, String createdAtLte, String createdAtRange, String displayNameIcontains, String email, String id, String idIn, String link, String linkIn, final ApiCallback<OwnersPaginatedResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn, _callback);
        Type localVarReturnType = new TypeToken<OwnersPaginatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private String displayNameIcontains;
        ...
        /**
         * Set createdAtGt
         * @param createdAtGt Return owners that were last updated in Belvo&#39;s database after this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtGte
         * @param createdAtGte Return owners that were last updated in Belvo&#39;s database after or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLt
         * @param createdAtLt Return owners that were last updated in Belvo&#39;s database before this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtLte
         * @param createdAtLte Return owners that were last updated in Belvo&#39;s database before or on this date (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set createdAtRange
         * @param createdAtRange Return owners that were last updated in Belvo&#39;s database between two dates (&#x60;YYYY-MM-DD&#x60; or full &#x60;ISO-8601&#x60; timestamp). (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set displayNameIcontains
         * @param displayNameIcontains Return owners whose full display name partially matches your query. For example, &#x60;mar&#x60; will return results for Mark, Maria, Neymar, Remarque, and so on. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder displayNameIcontains(String displayNameIcontains) {
        ...
        /**
         * Set email
         * @param email Returns owners whose email address match your query. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set id
         * @param id Return information only for this &#x60;owner.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set idIn
         * @param idIn Return information only for these &#x60;owner.id&#x60;s. (optional)
         * @return ListRequestBuilder
         */
        ...
        /**
         * Set link
         * @param link Return information only for this &#x60;link.id&#x60;. (optional)
         * @return ListRequestBuilder
         */
        public ListRequestBuilder link(String link) {
            this.link = link;
            return this;
        }
         ...
         * @return OwnersPaginatedResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public OwnersPaginatedResponse execute() throws ApiException {
            ApiResponse<OwnersPaginatedResponse> localVarResp = listWithHttpInfo(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn);
            return localVarResp.getData();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;OwnersPaginatedResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<OwnersPaginatedResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OwnersPaginatedResponse> _callback) throws ApiException {
            return listAsync(page, pageSize, omit, fields, createdAtGt, createdAtGte, createdAtLt, createdAtLte, createdAtRange, displayNameIcontains, email, id, idIn, link, linkIn, _callback);
        }
    }
    ...
    private ApiResponse<List<Owner>> retrieveWithHttpInfo(StandardRequest standardRequest, String omit, String fields) throws ApiException {
        okhttp3.Call localVarCall = retrieveValidateBeforeCall(standardRequest, omit, fields, null);
        Type localVarReturnType = new TypeToken<List<Owner>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call retrieveAsync(StandardRequest standardRequest, String omit, String fields, final ApiCallback<List<Owner>> _callback) throws ApiException {
    ...
    public class RetrieveRequestBuilder {
        ...
        public List<Owner> execute() throws ApiException {
            StandardRequest standardRequest = buildBodyParams();
            ApiResponse<List<Owner>> localVarResp = retrieveWithHttpInfo(standardRequest, omit, fields);
            return localVarResp.getData();
        }
