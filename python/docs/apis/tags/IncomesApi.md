...
> IncomesCompleteRequestResponse complete_request(patch_body)
...
> IncomesGetDetailsResponse get_details(id)
...
# **retrieve**
<a name="retrieve"></a>
> Income retrieve(incomes_request)
