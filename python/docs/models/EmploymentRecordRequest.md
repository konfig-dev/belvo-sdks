# belvo_client.model.employment_record_request.EmploymentRecordRequest
...
------------ | ------------- | ------------- | ------------- | -------------
**link** | str, uuid.UUID,  | str,  | The &#x60;link.id&#x60; you want to retrieve employment records for. | value must be a uuid
