# belvo_client.model.employment_records_paginated_response.EmploymentRecordsPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of employment record objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of employment record objects. | 
