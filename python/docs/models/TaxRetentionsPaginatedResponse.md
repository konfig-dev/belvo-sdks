# belvo_client.model.tax_retentions_paginated_response.TaxRetentionsPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of tax retentions objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of tax retentions objects. | 
