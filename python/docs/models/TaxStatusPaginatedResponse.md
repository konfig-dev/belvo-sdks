# belvo_client.model.tax_status_paginated_response.TaxStatusPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of tax status objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of tax status objects. | 
