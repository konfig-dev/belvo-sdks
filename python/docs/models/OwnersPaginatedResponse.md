# belvo_client.model.owners_paginated_response.OwnersPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of owner objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of owner objects. | 
