# belvo_client.model.transactions_request.TransactionsRequest
...
**account** | str, uuid.UUID,  | str,  | If provided, we return transactions only from this account. | [optional] value must be a uuid
