# belvo_client.model.tax_returns_personal_monthly_paginated.TaxReturnsPersonalMonthlyPaginated
...
**[results](#results)** | list, tuple,  | tuple,  | Array of Monthly Personal Tax Return objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of Monthly Personal Tax Return objects. | 
