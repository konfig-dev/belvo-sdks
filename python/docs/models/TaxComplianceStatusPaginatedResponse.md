# belvo_client.model.tax_compliance_status_paginated_response.TaxComplianceStatusPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of tax compliance status objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of tax compliance status objects. | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**TaxComplianceStatus**](TaxComplianceStatus.md) | [**TaxComplianceStatus**](TaxComplianceStatus.md) | [**TaxComplianceStatus**](TaxComplianceStatus.md) |  | 
