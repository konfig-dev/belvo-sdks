# belvo_client.model.secret_keys_paginated_response.SecretKeysPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of secret keys objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of secret keys objects. | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**SecretKeys**](SecretKeys.md) | [**SecretKeys**](SecretKeys.md) | [**SecretKeys**](SecretKeys.md) |  | 
