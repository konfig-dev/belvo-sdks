# belvo_client.model.customer_paginated_response.CustomerPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of customer objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of customer objects. | 
