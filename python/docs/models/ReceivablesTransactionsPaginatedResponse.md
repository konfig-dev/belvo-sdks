# belvo_client.model.receivables_transactions_paginated_response.ReceivablesTransactionsPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of receivables objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of receivables objects. | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**ReceivablesTransaction**](ReceivablesTransaction.md) | [**ReceivablesTransaction**](ReceivablesTransaction.md) | [**ReceivablesTransaction**](ReceivablesTransaction.md) |  | 
