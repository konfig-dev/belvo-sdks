# belvo_client.model.payment_intent_paginated_response.PaymentIntentPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of payment intent objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of payment intent objects. | 
...
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[PaymentIntentPse](PaymentIntentPse.md) | [**PaymentIntentPse**](PaymentIntentPse.md) | [**PaymentIntentPse**](PaymentIntentPse.md) |  | 
