# belvo_client.model.risk_insights_paginated_response.RiskInsightsPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of risk insights objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of risk insights objects. | 
