# belvo_client.model.tax_returns_personal_paginated.TaxReturnsPersonalPaginated
...
**[results](#results)** | list, tuple,  | tuple,  | Array of Personal Tax Return objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of Personal Tax Return objects. | 
