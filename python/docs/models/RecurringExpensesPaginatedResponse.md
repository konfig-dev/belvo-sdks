# belvo_client.model.recurring_expenses_paginated_response.RecurringExpensesPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | Array of recurring expense objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of recurring expense objects. | 
