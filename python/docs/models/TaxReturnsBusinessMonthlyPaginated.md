# belvo_client.model.tax_returns_business_monthly_paginated.TaxReturnsBusinessMonthlyPaginated
...
**[results](#results)** | list, tuple,  | tuple,  | Array of Monthly Business Tax Return objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of Monthly Business Tax Return objects. | 
