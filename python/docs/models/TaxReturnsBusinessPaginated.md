# belvo_client.model.tax_returns_business_paginated.TaxReturnsBusinessPaginated
...
**[results](#results)** | list, tuple,  | tuple,  | Array of Business Tax Return objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Array of Business Tax Return objects. | 
