# belvo_client.model.accounts_paginated_response.AccountsPaginatedResponse
...
**[results](#results)** | list, tuple,  | tuple,  | An array of Account objects. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | An array of Account objects. | 
