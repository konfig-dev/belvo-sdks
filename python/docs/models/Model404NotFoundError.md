# belvo_client.model.model404_not_found_error.Model404NotFoundError
...
------------ | ------------- | ------------- | ------------- | -------------
**code** | str,  | str,  | A unique error code (&#x60;not_found&#x60;) that allows you to classify and handle the error programmatically. | [optional] 
