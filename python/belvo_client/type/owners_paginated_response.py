...
class RequiredOwnersPaginatedResponse(TypedDict):
    pass

class OptionalOwnersPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[Owner]

class OwnersPaginatedResponse(RequiredOwnersPaginatedResponse, OptionalOwnersPaginatedResponse):
    pass
