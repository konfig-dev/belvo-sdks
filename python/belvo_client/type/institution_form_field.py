...
from belvo_client.type.institutions_form_field_values import InstitutionsFormFieldValues

class RequiredInstitutionFormField(TypedDict):
    pass

class OptionalInstitutionFormField(TypedDict, total=False):
    ...
    values: typing.List[InstitutionsFormFieldValues]
...
class InstitutionFormField(RequiredInstitutionFormField, OptionalInstitutionFormField):
    pass
