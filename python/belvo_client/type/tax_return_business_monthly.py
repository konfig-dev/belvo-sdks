...
class RequiredTaxReturnBusinessMonthly(TypedDict):
    ...
    determinacion_isr: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]

    # Information on the monthly provisional payments for the income tax.
    detalle_pago_isr: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]

    # Information used to calculate the provisional VAT tax for the period.
    determinacion_iva: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]

    # Information on the monthly provisional payments for the VAT tax.
    detalle_pago_iva: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]
...
class OptionalTaxReturnBusinessMonthly(TypedDict, total=False):
...
class TaxReturnBusinessMonthly(RequiredTaxReturnBusinessMonthly, OptionalTaxReturnBusinessMonthly):
    pass
