...
from belvo_client.type.recurring_expenses import RecurringExpenses

class RequiredRecurringExpensesPaginatedResponse(TypedDict):
    pass

class OptionalRecurringExpensesPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[RecurringExpenses]

class RecurringExpensesPaginatedResponse(RequiredRecurringExpensesPaginatedResponse, OptionalRecurringExpensesPaginatedResponse):
    pass
