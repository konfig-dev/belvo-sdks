...
from belvo_client.type.tax_return_business import TaxReturnBusiness

class RequiredTaxReturnsBusinessPaginated(TypedDict):
    pass

class OptionalTaxReturnsBusinessPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxReturnBusiness]

class TaxReturnsBusinessPaginated(RequiredTaxReturnsBusinessPaginated, OptionalTaxReturnsBusinessPaginated):
    pass
