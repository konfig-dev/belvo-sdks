...
from belvo_client.type.tax_return_personal_monthly import TaxReturnPersonalMonthly

class RequiredTaxReturnsPersonalMonthlyPaginated(TypedDict):
    pass

class OptionalTaxReturnsPersonalMonthlyPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxReturnPersonalMonthly]

class TaxReturnsPersonalMonthlyPaginated(RequiredTaxReturnsPersonalMonthlyPaginated, OptionalTaxReturnsPersonalMonthlyPaginated):
    pass
