...
from belvo_client.type.token_required_response_token_generation_data import TokenRequiredResponseTokenGenerationData

class RequiredTokenRequiredResponse(TypedDict):
    pass

class OptionalTokenRequiredResponse(TypedDict, total=False):
    ...
    token_generation_data: TokenRequiredResponseTokenGenerationData

class TokenRequiredResponse(RequiredTokenRequiredResponse, OptionalTokenRequiredResponse):
    pass
