...
class RequiredTaxStatusRequest(TypedDict):
    # The fiscal `link.id` to use.
    link: str

class OptionalTaxStatusRequest(TypedDict, total=False):
...
class TaxStatusRequest(RequiredTaxStatusRequest, OptionalTaxStatusRequest):
    pass
