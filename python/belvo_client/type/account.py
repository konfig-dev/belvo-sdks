...
from belvo_client.type.accounts_balance import AccountsBalance
from belvo_client.type.accounts_credit_data import AccountsCreditData
from belvo_client.type.accounts_funds_data import AccountsFundsData
from belvo_client.type.accounts_loan_data import AccountsLoanData
from belvo_client.type.accounts_receivables_data import AccountsReceivablesData
from belvo_client.type.enum_account_category import EnumAccountCategory
from belvo_client.type.institution_account import InstitutionAccount
...
class RequiredAccount(TypedDict):
    ...
    balance_type: typing.Optional[str]
    ...
    public_identification_name: typing.Optional[str]
    ...
    public_identification_value: typing.Optional[str]
...
class OptionalAccount(TypedDict, total=False):
    ...
    funds_data: typing.Optional[typing.List[AccountsFundsData]]

    receivables_data: AccountsReceivablesData

    # *This field has been deprecated.*  *The institution's product ID for the account type.* 
    bank_product_id: typing.Optional[str]

    # *This field has been deprecated.*  *The institution's internal identification for the account.* 
    internal_identification: typing.Optional[str]
