...
class RequiredPaymentLinkCallbackUrlsResponse(TypedDict):
    pass

class OptionalPaymentLinkCallbackUrlsResponse(TypedDict, total=False):
...
class PaymentLinkCallbackUrlsResponse(RequiredPaymentLinkCallbackUrlsResponse, OptionalPaymentLinkCallbackUrlsResponse):
    pass
