...
class RequiredPaginatedResponseLink(TypedDict):
    pass

class OptionalPaginatedResponseLink(TypedDict, total=False):
    ...
    results: typing.List[Link]

class PaginatedResponseLink(RequiredPaginatedResponseLink, OptionalPaginatedResponseLink):
    pass
