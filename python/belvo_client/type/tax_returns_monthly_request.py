...
class RequiredTaxReturnsMonthlyRequest(TypedDict):
...
class OptionalTaxReturnsMonthlyRequest(TypedDict, total=False):
...
class TaxReturnsMonthlyRequest(RequiredTaxReturnsMonthlyRequest, OptionalTaxReturnsMonthlyRequest):
    pass
