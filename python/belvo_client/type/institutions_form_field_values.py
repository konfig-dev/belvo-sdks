...
class RequiredInstitutionsFormFieldValues(TypedDict):
    pass

class OptionalInstitutionsFormFieldValues(TypedDict, total=False):
...
class InstitutionsFormFieldValues(RequiredInstitutionsFormFieldValues, OptionalInstitutionsFormFieldValues):
    pass
