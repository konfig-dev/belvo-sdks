...
from belvo_client.type.accounts_loan_data_fees import AccountsLoanDataFees
from belvo_client.type.accounts_loan_data_interest_rate import AccountsLoanDataInterestRate

class RequiredAccountsLoanData(TypedDict):
    # The ISO-8601 timestamp when the data point was collected.
    collected_at: datetime

    # Total amount of the loan (the amount the user receives).
    principal: typing.Optional[typing.Union[int, float]]

    # The amount remaining to pay in total, including interest.
    outstanding_balance: typing.Optional[typing.Union[int, float]]

    # The recurrent monthly payment, if applicable.
    monthly_payment: typing.Optional[typing.Union[int, float]]

    # Breakdown of the interest applied to the loan.
    interest_rates: typing.Optional[typing.List[AccountsLoanDataInterestRate]]

class OptionalAccountsLoanData(TypedDict, total=False):
