...
class RequiredReceivableTransactionRequest(TypedDict):
...
class OptionalReceivableTransactionRequest(TypedDict, total=False):
...
class ReceivableTransactionRequest(RequiredReceivableTransactionRequest, OptionalReceivableTransactionRequest):
    pass
