...
from belvo_client.type.risk_insights import RiskInsights

class RequiredRiskInsightsPaginatedResponse(TypedDict):
    pass

class OptionalRiskInsightsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[RiskInsights]

class RiskInsightsPaginatedResponse(RequiredRiskInsightsPaginatedResponse, OptionalRiskInsightsPaginatedResponse):
    pass
