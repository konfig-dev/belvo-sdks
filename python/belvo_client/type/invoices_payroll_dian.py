...
class RequiredInvoicesPayrollDian(TypedDict):
    ...
    # **Note**: This field is not applicable for DIAN Colombia and will return `null`. 
    payment_date: typing.Optional[date]

class OptionalInvoicesPayrollDian(TypedDict, total=False):
    # **Note**: This field is not applicable for DIAN Colombia and will return `null`.
    collected_at: typing.Optional[datetime]

class InvoicesPayrollDian(RequiredInvoicesPayrollDian, OptionalInvoicesPayrollDian):
    pass
