...
class RequiredTooManySessionsError(TypedDict):
    pass

class OptionalTooManySessionsError(TypedDict, total=False):
...
class TooManySessionsError(RequiredTooManySessionsError, OptionalTooManySessionsError):
    pass
