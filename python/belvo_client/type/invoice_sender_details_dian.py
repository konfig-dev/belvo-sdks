...
class RequiredInvoiceSenderDetailsDian(TypedDict):
    pass

class OptionalInvoiceSenderDetailsDian(TypedDict, total=False):
...
class InvoiceSenderDetailsDian(RequiredInvoiceSenderDetailsDian, OptionalInvoiceSenderDetailsDian):
    pass
