...
class RequiredTaxAssessmentBusiness(TypedDict):
    ...
    net_income_tax: typing.Union[int, float]

    # After further deductions, this is the final calculated tax that the taxpayer is required to pay.
    total_tax_due: typing.Union[int, float]

    # How much the tax payer has already paid througout the fiscal year.
    total_withholdings_for_the_taxable_year_to_be_declared: typing.Union[int, float]

    # How much the tax payer is required to pay.
    total_balance_payable: typing.Union[int, float]

    # How much the tax payer is expected to receive.
    total_balance_in_favor: typing.Union[int, float]

    # The total the tax payer is required to pay, taking into account deductions and fiscal credits.
    total_payment: typing.Union[int, float]

class OptionalTaxAssessmentBusiness(TypedDict, total=False):
    pass

class TaxAssessmentBusiness(RequiredTaxAssessmentBusiness, OptionalTaxAssessmentBusiness):
    pass
