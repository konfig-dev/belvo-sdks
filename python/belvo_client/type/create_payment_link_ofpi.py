...
from belvo_client.type.payment_method_details_ofpi import PaymentMethodDetailsOfpi

class RequiredCreatePaymentLinkOfpi(TypedDict):
...
class OptionalCreatePaymentLinkOfpi(TypedDict, total=False):
...
class CreatePaymentLinkOfpi(RequiredCreatePaymentLinkOfpi, OptionalCreatePaymentLinkOfpi):
    pass
