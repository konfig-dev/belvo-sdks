...
class RequiredInvoicesRequest(TypedDict):
...
class OptionalInvoicesRequest(TypedDict, total=False):
...
class InvoicesRequest(RequiredInvoicesRequest, OptionalInvoicesRequest):
    pass
