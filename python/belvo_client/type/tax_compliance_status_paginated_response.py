...
class RequiredTaxComplianceStatusPaginatedResponse(TypedDict):
    pass

class OptionalTaxComplianceStatusPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[TaxComplianceStatus]

class TaxComplianceStatusPaginatedResponse(RequiredTaxComplianceStatusPaginatedResponse, OptionalTaxComplianceStatusPaginatedResponse):
    pass
