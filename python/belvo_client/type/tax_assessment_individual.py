...
class RequiredTaxAssessmentIndividual(TypedDict):
    ...
    previous_year_balance: typing.Union[int, float]

    # The total tax already withheld in the current fiscal year.
    total_withheld_tax: typing.Union[int, float]

    # How much the tax payer is required to pay.
    balance_payable: typing.Union[int, float]
    ...
    balance_refundable: typing.Union[int, float]
...
class OptionalTaxAssessmentIndividual(TypedDict, total=False):
    pass

class TaxAssessmentIndividual(RequiredTaxAssessmentIndividual, OptionalTaxAssessmentIndividual):
    pass
