...
from belvo_client.type.institution_form_field import InstitutionFormField

class RequiredPaymentInstitution(TypedDict):
    pass

class OptionalPaymentInstitution(TypedDict, total=False):
    ...
    form_fields: typing.List[InstitutionFormField]

class PaymentInstitution(RequiredPaymentInstitution, OptionalPaymentInstitution):
    pass
