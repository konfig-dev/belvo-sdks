...
class RequiredCreatePaymentIntentPse(TypedDict):
...
class OptionalCreatePaymentIntentPse(TypedDict, total=False):
...
class CreatePaymentIntentPse(RequiredCreatePaymentIntentPse, OptionalCreatePaymentIntentPse):
    pass
