...
class RequiredNonTaxableIncomeIndividual(TypedDict):
    ...
    non_labor_income: typing.Union[int, float]

class OptionalNonTaxableIncomeIndividual(TypedDict, total=False):
    pass

class NonTaxableIncomeIndividual(RequiredNonTaxableIncomeIndividual, OptionalNonTaxableIncomeIndividual):
    pass
