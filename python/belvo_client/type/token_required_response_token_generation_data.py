...
class RequiredTokenRequiredResponseTokenGenerationData(TypedDict):
    pass

class OptionalTokenRequiredResponseTokenGenerationData(TypedDict, total=False):
...
class TokenRequiredResponseTokenGenerationData(RequiredTokenRequiredResponseTokenGenerationData, OptionalTokenRequiredResponseTokenGenerationData):
    pass
