...
class RequiredRecurringExpenseSourceTransaction(TypedDict):
...
class OptionalRecurringExpenseSourceTransaction(TypedDict, total=False):
    pass

class RecurringExpenseSourceTransaction(RequiredRecurringExpenseSourceTransaction, OptionalRecurringExpenseSourceTransaction):
    pass
