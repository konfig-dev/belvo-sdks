...
from belvo_client.type.invoice_detail_retained_tax_sat import InvoiceDetailRetainedTaxSat

class RequiredInvoiceDetailSat(TypedDict):
    ...
    product_identification: typing.Optional[str]
    ...
    unit_description: typing.Optional[str]

    # The price of one a singular item.
    unit_amount: typing.Optional[typing.Union[int, float]]

    # The total price for this item before tax is applied (`quantity` x `unit_amount`).
    pre_tax_amount: typing.Optional[typing.Union[int, float]]

    # The tax percentage to apply.
    tax_percentage: typing.Optional[typing.Union[int, float]]
...
class OptionalInvoiceDetailSat(TypedDict, total=False):
    ...
    retained_taxes: typing.List[InvoiceDetailRetainedTaxSat]

    # The ISO-8601 timestamp when the data point was collected.
    collected_at: typing.Optional[datetime]

class InvoiceDetailSat(RequiredInvoiceDetailSat, OptionalInvoiceDetailSat):
    pass
