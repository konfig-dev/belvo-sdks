...
class RequiredReceivablesTransactionsPaginatedResponse(TypedDict):
    pass

class OptionalReceivablesTransactionsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[ReceivablesTransaction]

class ReceivablesTransactionsPaginatedResponse(RequiredReceivablesTransactionsPaginatedResponse, OptionalReceivablesTransactionsPaginatedResponse):
    pass
