...
class RequiredInvestmentsPortfoliosPaginatedResponse(TypedDict):
    pass

class OptionalInvestmentsPortfoliosPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[InvestmentsPortfolio]

class InvestmentsPortfoliosPaginatedResponse(RequiredInvestmentsPortfoliosPaginatedResponse, OptionalInvestmentsPortfoliosPaginatedResponse):
    pass
