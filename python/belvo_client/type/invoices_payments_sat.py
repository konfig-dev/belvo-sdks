...
from belvo_client.type.invoices_payments_related_documents_sat import InvoicesPaymentsRelatedDocumentsSat

class RequiredInvoicesPaymentsSat(TypedDict):
    ...
    related_documents: typing.List[InvoicesPaymentsRelatedDocumentsSat]

class OptionalInvoicesPaymentsSat(TypedDict, total=False):
    # The fiscal ID of the payment beneficiary. 
    beneficiary_rfc: typing.Optional[str]

class InvoicesPaymentsSat(RequiredInvoicesPaymentsSat, OptionalInvoicesPaymentsSat):
    pass
