...
class RequiredPaymentLinkListPse(TypedDict):
...
class OptionalPaymentLinkListPse(TypedDict, total=False):
...
class PaymentLinkListPse(RequiredPaymentLinkListPse, OptionalPaymentLinkListPse):
    pass
