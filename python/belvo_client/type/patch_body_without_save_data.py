...
class RequiredPatchBodyWithoutSaveData(TypedDict):
...
class OptionalPatchBodyWithoutSaveData(TypedDict, total=False):
    # The MFA token generated by the institution and required to continue a session.
    token: str

class PatchBodyWithoutSaveData(RequiredPatchBodyWithoutSaveData, OptionalPatchBodyWithoutSaveData):
    pass
