...
from belvo_client.type.tax_declaration_business import TaxDeclarationBusiness

class RequiredTaxDeclarationBusinessPaginated(TypedDict):
    pass

class OptionalTaxDeclarationBusinessPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxDeclarationBusiness]

class TaxDeclarationBusinessPaginated(RequiredTaxDeclarationBusinessPaginated, OptionalTaxDeclarationBusinessPaginated):
    pass
