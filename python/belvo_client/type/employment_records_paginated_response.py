...
class RequiredEmploymentRecordsPaginatedResponse(TypedDict):
    pass

class OptionalEmploymentRecordsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[EmploymentRecord]

class EmploymentRecordsPaginatedResponse(RequiredEmploymentRecordsPaginatedResponse, OptionalEmploymentRecordsPaginatedResponse):
    pass
