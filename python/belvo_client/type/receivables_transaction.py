...
from belvo_client.type.enum_receivable_transaction_status import EnumReceivableTransactionStatus
from belvo_client.type.enum_receivable_transaction_type import EnumReceivableTransactionType
from belvo_client.type.receivables_transaction_account import ReceivablesTransactionAccount
from belvo_client.type.receivables_transaction_number_of_installments import ReceivablesTransactionNumberOfInstallments
from belvo_client.type.recevables_transaction_fees import RecevablesTransactionFees

class RequiredReceivablesTransaction(TypedDict):
    ...
    institution_transaction_id: str
    ...
    gross_amount: typing.Optional[typing.Union[int, float]]

    # The net amount of the transaction.
    net_amount: typing.Optional[typing.Union[int, float]]
...
class OptionalReceivablesTransaction(TypedDict, total=False):
    pass

class ReceivablesTransaction(RequiredReceivablesTransaction, OptionalReceivablesTransaction):
    pass
