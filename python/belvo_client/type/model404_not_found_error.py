...
class RequiredModel404NotFoundError(TypedDict):
    pass

class OptionalModel404NotFoundError(TypedDict, total=False):
...
class Model404NotFoundError(RequiredModel404NotFoundError, OptionalModel404NotFoundError):
    pass
