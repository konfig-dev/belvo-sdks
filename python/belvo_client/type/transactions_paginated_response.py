...
class RequiredTransactionsPaginatedResponse(TypedDict):
    pass

class OptionalTransactionsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[Transaction]

class TransactionsPaginatedResponse(RequiredTransactionsPaginatedResponse, OptionalTransactionsPaginatedResponse):
    pass
