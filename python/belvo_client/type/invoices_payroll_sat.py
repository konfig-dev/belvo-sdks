...
class RequiredInvoicesPayrollSat(TypedDict):
...
class OptionalInvoicesPayrollSat(TypedDict, total=False):
    # The ISO-8601 timestamp when the data point was collected.
    collected_at: typing.Optional[datetime]

class InvoicesPayrollSat(RequiredInvoicesPayrollSat, OptionalInvoicesPayrollSat):
    pass
