...
from belvo_client.type.enum_investment_portfolio_type import EnumInvestmentPortfolioType
from belvo_client.type.investments_portfolio_instrument import InvestmentsPortfolioInstrument

class RequiredInvestmentsPortfolio(TypedDict):
...
class OptionalInvestmentsPortfolio(TypedDict, total=False):
    ...
    instruments: typing.Optional[typing.List[InvestmentsPortfolioInstrument]]

class InvestmentsPortfolio(RequiredInvestmentsPortfolio, OptionalInvestmentsPortfolio):
    pass
