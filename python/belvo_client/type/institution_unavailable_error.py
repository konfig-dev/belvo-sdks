...
class RequiredInstitutionUnavailableError(TypedDict):
    pass

class OptionalInstitutionUnavailableError(TypedDict, total=False):
...
class InstitutionUnavailableError(RequiredInstitutionUnavailableError, OptionalInstitutionUnavailableError):
    pass
