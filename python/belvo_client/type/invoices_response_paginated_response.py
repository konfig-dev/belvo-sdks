...
from belvo_client.type.invoice_dian import InvoiceDian
from belvo_client.type.invoice_with_id_sat import InvoiceWithIdSat

class RequiredInvoicesResponsePaginatedResponse(TypedDict):
    pass

class OptionalInvoicesResponsePaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[typing.Union[typing.List[InvoiceWithIdSat], typing.List[InvoiceDian]]]

class InvoicesResponsePaginatedResponse(RequiredInvoicesResponsePaginatedResponse, OptionalInvoicesResponsePaginatedResponse):
    pass
