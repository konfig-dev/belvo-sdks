...
class RequiredInstitutionsFormField(TypedDict):
    pass

class OptionalInstitutionsFormField(TypedDict, total=False):
...
class InstitutionsFormField(RequiredInstitutionsFormField, OptionalInstitutionsFormField):
    pass
