...
class RequiredDocumentInformationBusiness(TypedDict):
...
class OptionalDocumentInformationBusiness(TypedDict, total=False):
    pass

class DocumentInformationBusiness(RequiredDocumentInformationBusiness, OptionalDocumentInformationBusiness):
    pass
