...
class RequiredInstitutionsPaginatedResponse(TypedDict):
    pass

class OptionalInstitutionsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[Institution]

class InstitutionsPaginatedResponse(RequiredInstitutionsPaginatedResponse, OptionalInstitutionsPaginatedResponse):
    pass
