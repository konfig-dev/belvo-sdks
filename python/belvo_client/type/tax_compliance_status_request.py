...
class RequiredTaxComplianceStatusRequest(TypedDict):
    # The fiscal `link.id` to use.
    link: str

class OptionalTaxComplianceStatusRequest(TypedDict, total=False):
...
class TaxComplianceStatusRequest(RequiredTaxComplianceStatusRequest, OptionalTaxComplianceStatusRequest):
    pass
