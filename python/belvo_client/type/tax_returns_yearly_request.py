...
class RequiredTaxReturnsYearlyRequest(TypedDict):
...
class OptionalTaxReturnsYearlyRequest(TypedDict, total=False):
...
class TaxReturnsYearlyRequest(RequiredTaxReturnsYearlyRequest, OptionalTaxReturnsYearlyRequest):
    pass
