...
class RequiredTaxRetentionsPaginatedResponse(TypedDict):
    pass

class OptionalTaxRetentionsPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[TaxRetentions]

class TaxRetentionsPaginatedResponse(RequiredTaxRetentionsPaginatedResponse, OptionalTaxRetentionsPaginatedResponse):
    pass
