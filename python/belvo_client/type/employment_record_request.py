...
class RequiredEmploymentRecordRequest(TypedDict):
    # The `link.id` you want to retrieve employment records for.
    link: str

class OptionalEmploymentRecordRequest(TypedDict, total=False):
...
class EmploymentRecordRequest(RequiredEmploymentRecordRequest, OptionalEmploymentRecordRequest):
    pass
