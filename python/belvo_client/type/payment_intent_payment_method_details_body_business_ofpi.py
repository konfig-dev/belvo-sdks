...
class RequiredPaymentIntentPaymentMethodDetailsBodyBusinessOfpi(TypedDict):
...
class OptionalPaymentIntentPaymentMethodDetailsBodyBusinessOfpi(TypedDict, total=False):
    pass

class PaymentIntentPaymentMethodDetailsBodyBusinessOfpi(RequiredPaymentIntentPaymentMethodDetailsBodyBusinessOfpi, OptionalPaymentIntentPaymentMethodDetailsBodyBusinessOfpi):
    pass
