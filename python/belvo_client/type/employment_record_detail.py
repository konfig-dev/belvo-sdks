...
from belvo_client.type.employment_record_employment_status_updates import EmploymentRecordEmploymentStatusUpdates

class RequiredEmploymentRecordDetail(TypedDict):
    pass

class OptionalEmploymentRecordDetail(TypedDict, total=False):
    ...
    most_recent_base_salary: typing.Union[int, float]

    # The monthly salary of the individual, including any additional perks. 
    monthly_salary: typing.Union[int, float]

    # The three-letter currency code in which the salary is paid. 
    currency: str

    # Details regarding any employment changes of the individual.
    employment_status_updates: typing.List[EmploymentRecordEmploymentStatusUpdates]

class EmploymentRecordDetail(RequiredEmploymentRecordDetail, OptionalEmploymentRecordDetail):
    pass
