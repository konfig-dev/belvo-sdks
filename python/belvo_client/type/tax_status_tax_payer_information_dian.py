...
class RequiredTaxStatusTaxPayerInformationDian(TypedDict):
    # The tax payers's identification number (NIT). 
    rfc: typing.Optional[str]

    # **Note**: This field is not applicable for DIAN Colombia and will return `null`. 
    start_operations_date: typing.Optional[date]

    # **Note**: This field is not applicable for DIAN Colombia and will return `null`.
    status_padron: typing.Optional[str]

    # **Note**: This field is not applicable for DIAN Colombia and will return `null`. 
    last_status_change_date: typing.Optional[date]

class OptionalTaxStatusTaxPayerInformationDian(TypedDict, total=False):
    # **Note**: This field is not applicable for DIAN Colombia and will return `null`. 
    curp: typing.Optional[str]

    # The tax payers's first name.
    name: typing.Optional[str]

    # The tax payers's first last name.
    first_last_name: typing.Optional[str]

    # The tax payers's second last name.
    second_last_name: typing.Optional[str]

    # The name of the business designated for consumers and the general public.  **Note**: Only applicable for businesses. 
    commercial_name: typing.Optional[str]
    ...
    social_name: typing.Optional[str]
...
class TaxStatusTaxPayerInformationDian(RequiredTaxStatusTaxPayerInformationDian, OptionalTaxStatusTaxPayerInformationDian):
    pass
