...
from belvo_client.type.enum_recurring_expense_category import EnumRecurringExpenseCategory
from belvo_client.type.enum_recurring_expense_frequency import EnumRecurringExpenseFrequency
from belvo_client.type.enum_recurring_expense_payment_type import EnumRecurringExpensePaymentType
from belvo_client.type.recurring_expense_source_transaction import RecurringExpenseSourceTransaction

class RequiredRecurringExpenses(TypedDict):
    account: Account
    ...
    transactions: typing.List[RecurringExpenseSourceTransaction]

    frequency: EnumRecurringExpenseFrequency

    # The average transaction amount of the recurring expense.
    average_transaction_amount: typing.Union[int, float]

    # The median transaction amount of the recurring expense.
    median_transaction_amount: typing.Union[int, float]
...
class OptionalRecurringExpenses(TypedDict, total=False):
    # Belvo's unique identifier used to reference the current recurring expense.
    id: str

class RecurringExpenses(RequiredRecurringExpenses, OptionalRecurringExpenses):
    pass
