...
from belvo_client.type.tax_declaration_individual import TaxDeclarationIndividual

class RequiredTaxDeclarationIndividualPaginated(TypedDict):
    pass

class OptionalTaxDeclarationIndividualPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxDeclarationIndividual]

class TaxDeclarationIndividualPaginated(RequiredTaxDeclarationIndividualPaginated, OptionalTaxDeclarationIndividualPaginated):
    pass
