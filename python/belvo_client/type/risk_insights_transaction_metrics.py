...
class RequiredRiskInsightsTransactionMetrics(TypedDict):
    ...
    sum_incoming_amount_1w: typing.Optional[typing.Union[int, float]]

    # The total sum of all inflow transactions for the last month. 
    sum_incoming_amount_1m: typing.Optional[typing.Union[int, float]]

    # The total sum of all inflow transactions for the last three months. 
    sum_incoming_amount_3m: typing.Optional[typing.Union[int, float]]

    # The total sum of all outflow transactions for the last week. 
    sum_outgoing_amount_1w: typing.Optional[typing.Union[int, float]]

    # The total sum of all outflow transactions for the last month. 
    sum_outgoing_amount_1m: typing.Optional[typing.Union[int, float]]

    # The total sum of all outflow transactions for the last three months. 
    sum_outgoing_amount_3m: typing.Optional[typing.Union[int, float]]

    # The highest value inflow transaction in the last week. 
    max_incoming_amount_1w: typing.Optional[typing.Union[int, float]]

    # The highest value inflow transaction in the last month. 
    max_incoming_amount_1m: typing.Optional[typing.Union[int, float]]

    # The highest value inflow transaction in the last three months. 
    max_incoming_amount_3m: typing.Optional[typing.Union[int, float]]

    # The highest value outflow transaction in the last week. 
    max_outgoing_amount_1w: typing.Optional[typing.Union[int, float]]

    # The highest value outflow transaction in the last month. 
    max_outgoing_amount_1m: typing.Optional[typing.Union[int, float]]

    # The highest value outflow transaction in the last three months. 
    max_outgoing_amount_3m: typing.Optional[typing.Union[int, float]]

    # The mean incoming value of all transactions in the last week. 
    mean_incoming_amount_1w: typing.Optional[typing.Union[int, float]]

    # The mean incoming value of all transactions in the last month. 
    mean_incoming_amount_1m: typing.Optional[typing.Union[int, float]]

    # The mean incoming value of all transactions in the last three months. 
    mean_incoming_amount_3m: typing.Optional[typing.Union[int, float]]

    # The mean outgoing value of all transaction in the last week. 
    mean_outgoing_amount_1w: typing.Optional[typing.Union[int, float]]

    # The mean outgoing value of all transaction in the last month. 
    mean_outgoing_amount_1m: typing.Optional[typing.Union[int, float]]

    # The mean outgoing value of all transaction in the last three months. 
    mean_outgoing_amount_3m: typing.Optional[typing.Union[int, float]]

class OptionalRiskInsightsTransactionMetrics(TypedDict, total=False):
    pass

class RiskInsightsTransactionMetrics(RequiredRiskInsightsTransactionMetrics, OptionalRiskInsightsTransactionMetrics):
    pass
