...
class RequiredIncomesPaginatedResponse(TypedDict):
    pass

class OptionalIncomesPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[Income]

class IncomesPaginatedResponse(RequiredIncomesPaginatedResponse, OptionalIncomesPaginatedResponse):
    pass
