...
class RequiredTaxStatusTaxPayerInformationSat(TypedDict):
...
class OptionalTaxStatusTaxPayerInformationSat(TypedDict, total=False):
...
class TaxStatusTaxPayerInformationSat(RequiredTaxStatusTaxPayerInformationSat, OptionalTaxStatusTaxPayerInformationSat):
    pass
