...
from belvo_client.type.enum_invoice_sat_invoice_type import EnumInvoiceSatInvoiceType
from belvo_client.type.enum_invoice_sat_payment_method import EnumInvoiceSatPaymentMethod
from belvo_client.type.enum_invoice_type import EnumInvoiceType
from belvo_client.type.invoice_detail_sat import InvoiceDetailSat
from belvo_client.type.invoice_warnings_sat import InvoiceWarningsSat
from belvo_client.type.invoices_payments_sat import InvoicesPaymentsSat
from belvo_client.type.invoices_payroll_sat import InvoicesPayrollSat

class RequiredInvoiceWithIdSat(TypedDict):
    ...
    invoice_details: typing.List[InvoiceDetailSat]
    ...
    payments: typing.List[InvoicesPaymentsSat]

    payroll: InvoicesPayrollSat

class OptionalInvoiceWithIdSat(TypedDict, total=False):
    ...
    payment_method: EnumInvoiceSatPaymentMethod
    ...
    warnings: InvoiceWarningsSat

    # This field has been deprecated. Please use `sender_tax_fraud_status` instead. 
    sender_blacklist_status: typing.Optional[str]

    # This field has been deprecated. Please use `receiver_tax_fraud_status` instead. 
    receiver_blacklist_status: typing.Optional[str]

class InvoiceWithIdSat(RequiredInvoiceWithIdSat, OptionalInvoiceWithIdSat):
    pass
