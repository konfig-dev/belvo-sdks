...
from belvo_client.type.enum_income_source_type import EnumIncomeSourceType
from belvo_client.type.income_streams_body import IncomeStreamsBody
...
class RequiredIncome(TypedDict):
    ...
    income_streams: typing.List[IncomeStreamsBody]
    ...
    first_transaction_date: typing.Optional[date]
...
class OptionalIncome(TypedDict, total=False):
    ...
    total_irregular_income_amount: typing.Union[int, float]
