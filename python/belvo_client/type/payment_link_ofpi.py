...
from belvo_client.type.enum_payment_links_status import EnumPaymentLinksStatus
from belvo_client.type.payment_intent_ofpi import PaymentIntentOfpi
from belvo_client.type.payment_link_callback_urls_response import PaymentLinkCallbackUrlsResponse

class RequiredPaymentLinkOfpi(TypedDict):
...
class OptionalPaymentLinkOfpi(TypedDict, total=False):
    ...
    payment_intent: PaymentIntentOfpi

    # The ISO-8601 timestamp of when the payment link was last updated. 
    updated_at: typing.Optional[datetime]

class PaymentLinkOfpi(RequiredPaymentLinkOfpi, OptionalPaymentLinkOfpi):
    pass
