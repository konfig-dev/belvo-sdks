...
class RequiredRiskInsightsCashflowMetrics(TypedDict):
    ...
    sum_negative_3m: typing.Optional[typing.Union[int, float]]
    ...
    positive_to_negative_ratio_1w: typing.Optional[typing.Union[int, float]]
    ...
    positive_to_negative_ratio_1m: typing.Optional[typing.Union[int, float]]
    ...
    positive_to_negative_ratio_3m: typing.Optional[typing.Union[int, float]]

class OptionalRiskInsightsCashflowMetrics(TypedDict, total=False):
    pass

class RiskInsightsCashflowMetrics(RequiredRiskInsightsCashflowMetrics, OptionalRiskInsightsCashflowMetrics):
    pass
