...
from belvo_client.type.tax_status_dian import TaxStatusDian
from belvo_client.type.tax_status_sat import TaxStatusSat

class RequiredTaxStatusPaginatedResponse(TypedDict):
    pass

class OptionalTaxStatusPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[typing.Union[typing.List[TaxStatusSat], typing.List[TaxStatusDian]]]

class TaxStatusPaginatedResponse(RequiredTaxStatusPaginatedResponse, OptionalTaxStatusPaginatedResponse):
    pass
