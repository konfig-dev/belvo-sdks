...
from belvo_client.type.display_token_required_content_pse import DisplayTokenRequiredContentPse

class RequiredNextStepDisplayTokenRequiredPse(TypedDict):
    pass

class OptionalNextStepDisplayTokenRequiredPse(TypedDict, total=False):
...
class NextStepDisplayTokenRequiredPse(RequiredNextStepDisplayTokenRequiredPse, OptionalNextStepDisplayTokenRequiredPse):
    pass
