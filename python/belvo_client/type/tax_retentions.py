...
from belvo_client.type.enum_tax_retention_receiver_nationality import EnumTaxRetentionReceiverNationality
from belvo_client.type.retention_breakdown import RetentionBreakdown

class RequiredTaxRetentions(TypedDict):
    ...
    issued_at: typing.Optional[datetime]

    # The ISO-8601 timestamp of when the tax retention was certified. 
    certified_at: typing.Optional[datetime]
    ...
    total_invoice_amount: typing.Optional[typing.Union[int, float]]

    # Total amount that is exempt from taxation. 
    total_exempt_amount: typing.Optional[typing.Union[int, float]]

    # Total tax retained. 
    total_retained_amount: typing.Optional[typing.Union[int, float]]

    # The total amount that can be taxed. Calculated as `total_invoice_amount` - `total_exempt_amount`. 
    total_taxable_amount: typing.Optional[typing.Union[int, float]]

    # A breakdown of the retained taxes.
    retention_breakdown: typing.Optional[typing.List[RetentionBreakdown]]

    # The tax retention document in XML form. 
    xml: typing.Optional[str]

class OptionalTaxRetentions(TypedDict, total=False):
...
class TaxRetentions(RequiredTaxRetentions, OptionalTaxRetentions):
    pass
