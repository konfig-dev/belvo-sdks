...
class RequiredTaxReturnPersonalMonthly(TypedDict):
    ...
    isr: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]

    # Information used to calculate the monthly provisional payments of the VAT tax.
    iva: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]
...
class OptionalTaxReturnPersonalMonthly(TypedDict, total=False):
...
class TaxReturnPersonalMonthly(RequiredTaxReturnPersonalMonthly, OptionalTaxReturnPersonalMonthly):
    pass
