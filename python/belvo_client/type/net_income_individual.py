...
class RequiredNetIncomeIndividual(TypedDict):
...
class OptionalNetIncomeIndividual(TypedDict, total=False):
    pass

class NetIncomeIndividual(RequiredNetIncomeIndividual, OptionalNetIncomeIndividual):
    pass
