...
class RequiredPaymentIntentPaymentMethodDetailsBodyPse(TypedDict):
...
class OptionalPaymentIntentPaymentMethodDetailsBodyPse(TypedDict, total=False):
...
class PaymentIntentPaymentMethodDetailsBodyPse(RequiredPaymentIntentPaymentMethodDetailsBodyPse, OptionalPaymentIntentPaymentMethodDetailsBodyPse):
    pass
