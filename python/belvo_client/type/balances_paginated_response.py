...
class RequiredBalancesPaginatedResponse(TypedDict):
    pass

class OptionalBalancesPaginatedResponse(TypedDict, total=False):
    ...
    results: typing.List[Balance]

class BalancesPaginatedResponse(RequiredBalancesPaginatedResponse, OptionalBalancesPaginatedResponse):
    pass
