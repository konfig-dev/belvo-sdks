...
from belvo_client.type.tax_return_personal import TaxReturnPersonal

class RequiredTaxReturnsPersonalPaginated(TypedDict):
    pass

class OptionalTaxReturnsPersonalPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxReturnPersonal]

class TaxReturnsPersonalPaginated(RequiredTaxReturnsPersonalPaginated, OptionalTaxReturnsPersonalPaginated):
    pass
