...
class RequiredInstitutionAccount(TypedDict):
    pass

class OptionalInstitutionAccount(TypedDict, total=False):
...
class InstitutionAccount(RequiredInstitutionAccount, OptionalInstitutionAccount):
    pass
