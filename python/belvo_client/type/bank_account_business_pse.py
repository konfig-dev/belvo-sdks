...
class RequiredBankAccountBusinessPse(TypedDict):
...
class OptionalBankAccountBusinessPse(TypedDict, total=False):
...
class BankAccountBusinessPse(RequiredBankAccountBusinessPse, OptionalBankAccountBusinessPse):
    pass
