...
class RequiredRiskInsightsBalanceMetrics(TypedDict):
    ...
    days_balance_below_x_1w: typing.Optional[int]
    ...
    days_balance_below_x_1m: typing.Optional[int]
    ...
    days_balance_below_x_3m: typing.Optional[int]
    ...
    balance_threshold_x: typing.Union[int, float]

class OptionalRiskInsightsBalanceMetrics(TypedDict, total=False):
    pass

class RiskInsightsBalanceMetrics(RequiredRiskInsightsBalanceMetrics, OptionalRiskInsightsBalanceMetrics):
    pass
