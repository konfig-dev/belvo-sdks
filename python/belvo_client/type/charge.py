...
from belvo_client.type.charge_payment_method_details_ofpi import ChargePaymentMethodDetailsOfpi
from belvo_client.type.charge_payment_method_details_pse import ChargePaymentMethodDetailsPse
...
class RequiredCharge(TypedDict):
    ...
    payment_method_details: typing.Union[ChargePaymentMethodDetailsPse, ChargePaymentMethodDetailsOfpi]

    payment_method_information: typing.Union[PaymentMethodInformationPse]
