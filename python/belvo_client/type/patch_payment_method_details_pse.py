...
class RequiredPatchPaymentMethodDetailsPse(TypedDict):
    pass

class OptionalPatchPaymentMethodDetailsPse(TypedDict, total=False):
...
class PatchPaymentMethodDetailsPse(RequiredPatchPaymentMethodDetailsPse, OptionalPatchPaymentMethodDetailsPse):
    pass
