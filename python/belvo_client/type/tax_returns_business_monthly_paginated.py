...
from belvo_client.type.tax_return_business_monthly import TaxReturnBusinessMonthly

class RequiredTaxReturnsBusinessMonthlyPaginated(TypedDict):
    pass

class OptionalTaxReturnsBusinessMonthlyPaginated(TypedDict, total=False):
    ...
    results: typing.List[TaxReturnBusinessMonthly]

class TaxReturnsBusinessMonthlyPaginated(RequiredTaxReturnsBusinessMonthlyPaginated, OptionalTaxReturnsBusinessMonthlyPaginated):
    pass
