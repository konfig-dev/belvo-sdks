...
class RequiredCreateBankAccountPse(TypedDict):
    # Information regarding the business bank account holder.
    holder: typing.Union[HolderBusinessPse]
    ...
    providers: typing.Union[ProvidersPse]

class OptionalCreateBankAccountPse(TypedDict, total=False):
...
class CreateBankAccountPse(RequiredCreateBankAccountPse, OptionalCreateBankAccountPse):
    pass
