...
class RequiredTaxStatusEconomicActivityDian(TypedDict):
    pass

class OptionalTaxStatusEconomicActivityDian(TypedDict, total=False):
    ...
    economic_activity: typing.Optional[str]

    # The start date of the economic activity.
    initial_date: typing.Optional[date]
    ...
    # **Note**: This field is not applicable for DIAN Colombia and will return `null`. 
    percentage: typing.Optional[str]

class TaxStatusEconomicActivityDian(RequiredTaxStatusEconomicActivityDian, OptionalTaxStatusEconomicActivityDian):
    pass
