...
class RequiredPaymentIntentPaymentMethodDetailsBodyIndividualOfpi(TypedDict):
...
class OptionalPaymentIntentPaymentMethodDetailsBodyIndividualOfpi(TypedDict, total=False):
    # The customer's CPF number. Only required when the `customer_type` is `BUSINESS`.  **Note:** This value is obfuscated.
    cpf: typing.Optional[str]

class PaymentIntentPaymentMethodDetailsBodyIndividualOfpi(RequiredPaymentIntentPaymentMethodDetailsBodyIndividualOfpi, OptionalPaymentIntentPaymentMethodDetailsBodyIndividualOfpi):
    pass
