...
class RequiredAccountsPaginatedResponse(TypedDict):
    pass

class OptionalAccountsPaginatedResponse(TypedDict, total=False):
...
class AccountsPaginatedResponse(RequiredAccountsPaginatedResponse, OptionalAccountsPaginatedResponse):
    pass
