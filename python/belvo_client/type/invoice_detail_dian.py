...
class RequiredInvoiceDetailDian(TypedDict):
...
class OptionalInvoiceDetailDian(TypedDict, total=False):
    # The item's tax type.
...
class InvoiceDetailDian(RequiredInvoiceDetailDian, OptionalInvoiceDetailDian):
    pass
