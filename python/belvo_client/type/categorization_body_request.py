...
class RequiredCategorizationBodyRequest(TypedDict):
...
class OptionalCategorizationBodyRequest(TypedDict, total=False):
...
class CategorizationBodyRequest(RequiredCategorizationBodyRequest, OptionalCategorizationBodyRequest):
    pass
