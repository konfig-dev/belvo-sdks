...
from belvo_client.type.enum_income_verification_account_category import EnumIncomeVerificationAccountCategory
from belvo_client.type.enum_income_verification_account_holder_type import EnumIncomeVerificationAccountHolderType
from belvo_client.type.enum_income_verification_type import EnumIncomeVerificationType

class RequiredEyodIncomeVerificationBodyRequest(TypedDict):
...
class OptionalEyodIncomeVerificationBodyRequest(TypedDict, total=False):
    pass

class EyodIncomeVerificationBodyRequest(RequiredEyodIncomeVerificationBodyRequest, OptionalEyodIncomeVerificationBodyRequest):
    pass
