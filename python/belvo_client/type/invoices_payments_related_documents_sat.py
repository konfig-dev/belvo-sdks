...
class RequiredInvoicesPaymentsRelatedDocumentsSat(TypedDict):
...
class OptionalInvoicesPaymentsRelatedDocumentsSat(TypedDict, total=False):
    # The payment installment number. 
    partiality_number: int

class InvoicesPaymentsRelatedDocumentsSat(RequiredInvoicesPaymentsRelatedDocumentsSat, OptionalInvoicesPaymentsRelatedDocumentsSat):
    pass
