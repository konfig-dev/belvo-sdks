...
class RequiredPaymentLinkListOfpi(TypedDict):
...
class OptionalPaymentLinkListOfpi(TypedDict, total=False):
...
class PaymentLinkListOfpi(RequiredPaymentLinkListOfpi, OptionalPaymentLinkListOfpi):
    pass
