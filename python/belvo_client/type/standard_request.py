...
class RequiredStandardRequest(TypedDict):
    # The `link.id` that you want to get information for.
    link: str

class OptionalStandardRequest(TypedDict, total=False):
...
class StandardRequest(RequiredStandardRequest, OptionalStandardRequest):
    pass
