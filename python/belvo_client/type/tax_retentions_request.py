...
class RequiredTaxRetentionsRequest(TypedDict):
...
class OptionalTaxRetentionsRequest(TypedDict, total=False):
...
class TaxRetentionsRequest(RequiredTaxRetentionsRequest, OptionalTaxRetentionsRequest):
    pass
