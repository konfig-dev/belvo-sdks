...
class RequiredCreatePaymentLinkPse(TypedDict):
...
class OptionalCreatePaymentLinkPse(TypedDict, total=False):
...
class CreatePaymentLinkPse(RequiredCreatePaymentLinkPse, OptionalCreatePaymentLinkPse):
    pass
