...
class RequiredTransactionsRequest(TypedDict):
...
class OptionalTransactionsRequest(TypedDict, total=False):
...
class TransactionsRequest(RequiredTransactionsRequest, OptionalTransactionsRequest):
    pass
