...
class Belvo:
    ...
    def __init__(self, configuration: Configuration = None, **kwargs):
        ...
        self.balances = BalancesApi(api_client)
        self.bank_accounts = BankAccountsApi(api_client)
        self.categorization = CategorizationApi(api_client)
        self.customers = CustomersApi(api_client)
        self.employment_records = EmploymentRecordsApi(api_client)
        self.income_verification = IncomeVerificationApi(api_client)
        self.incomes = IncomesApi(api_client)
        self.institutions = InstitutionsApi(api_client)
        self.investment_portfolios = InvestmentPortfoliosApi(api_client)
        self.invoices = InvoicesApi(api_client)
        self.links = LinksApi(api_client)
        self.owners = OwnersApi(api_client)
        self.payment_institutions = PaymentInstitutionsApi(api_client)
        self.payment_intents = PaymentIntentsApi(api_client)
        self.payment_links = PaymentLinksApi(api_client)
        self.payment_transactions = PaymentTransactionsApi(api_client)
        self.receivable_transactions = ReceivableTransactionsApi(api_client)
        self.recurring_expenses = RecurringExpensesApi(api_client)
        self.risk_insights = RiskInsightsApi(api_client)
        self.secret_keys = SecretKeysApi(api_client)
        self.tax_compliance_status = TaxComplianceStatusApi(api_client)
        self.tax_declarations = TaxDeclarationsApi(api_client)
        self.tax_retentions = TaxRetentionsApi(api_client)
        self.tax_returns = TaxReturnsApi(api_client)
        self.tax_status = TaxStatusApi(api_client)
