...
from belvo_client.model.payments_transactions_paginated_response import PaymentsTransactionsPaginatedResponse as PaymentsTransactionsPaginatedResponseSchema
from belvo_client.model.payment_transactions_list_response import PaymentTransactionsListResponse as PaymentTransactionsListResponseSchema

from belvo_client.type.payment_transactions_list_response import PaymentTransactionsListResponse
from belvo_client.type.payments_transactions_paginated_response import PaymentsTransactionsPaginatedResponse
...
ChargeInSchema = schemas.StrSchema
BeneficiarySchema = schemas.StrSchema
BeneficiaryInSchema = schemas.StrSchema
PayerSchema = schemas.StrSchema
PayerInSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'charge__in': typing.Union[ChargeInSchema, str, ],
        'beneficiary': typing.Union[BeneficiarySchema, str, ],
        'beneficiary__in': typing.Union[BeneficiaryInSchema, str, ],
        'payer': typing.Union[PayerSchema, str, ],
        'payer__in': typing.Union[PayerInSchema, str, ],
        'transaction__type': typing.Union[TransactionTypeSchema, str, ],
...
request_query_charge__in = api_client.QueryParameter(
    name="charge__in",
    style=api_client.ParameterStyle.FORM,
    schema=ChargeInSchema,
    explode=True,
)
request_query_beneficiary = api_client.QueryParameter(
    name="beneficiary",
    style=api_client.ParameterStyle.FORM,
    schema=BeneficiarySchema,
    explode=True,
)
request_query_beneficiary__in = api_client.QueryParameter(
    name="beneficiary__in",
    style=api_client.ParameterStyle.FORM,
    schema=BeneficiaryInSchema,
    explode=True,
)
request_query_payer = api_client.QueryParameter(
    name="payer",
    style=api_client.ParameterStyle.FORM,
    schema=PayerSchema,
    explode=True,
)
request_query_payer__in = api_client.QueryParameter(
    name="payer__in",
    style=api_client.ParameterStyle.FORM,
    schema=PayerInSchema,
    explode=True,
)
request_query_transaction__type = api_client.QueryParameter(
...
SchemaFor200ResponseBodyApplicationJson = PaymentsTransactionsPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentsTransactionsPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = PaymentTransactionsListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: PaymentTransactionsListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        charge__in: typing.Optional[str] = None,
        beneficiary: typing.Optional[str] = None,
        beneficiary__in: typing.Optional[str] = None,
        payer: typing.Optional[str] = None,
        payer__in: typing.Optional[str] = None,
        transaction__type: typing.Optional[str] = None,
        ...
        if charge__in is not None:
            _query_params["charge__in"] = charge__in
        if beneficiary is not None:
            _query_params["beneficiary"] = beneficiary
        if beneficiary__in is not None:
            _query_params["beneficiary__in"] = beneficiary__in
        if payer is not None:
            _query_params["payer"] = payer
        if payer__in is not None:
            _query_params["payer__in"] = payer__in
        if transaction__type is not None:
            _query_params["transaction__type"] = transaction__type
    ...
    async def _alist_oapg(
        ...
        for parameter in (
            ...
            request_query_charge__in,
            request_query_beneficiary,
            request_query_beneficiary__in,
            request_query_payer,
            request_query_payer__in,
            request_query_transaction__type,
...
class List(BaseApi):
    ...
    async def alist(
        ...
        args = self._list_mapped_args(
            ...
            charge=charge,
            charge__in=charge__in,
            beneficiary=beneficiary,
            beneficiary__in=beneficiary__in,
            payer=payer,
            payer__in=payer__in,
