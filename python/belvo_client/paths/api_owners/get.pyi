...
from belvo_client.model.owners_list_response import OwnersListResponse as OwnersListResponseSchema
from belvo_client.model.owners_paginated_response import OwnersPaginatedResponse as OwnersPaginatedResponseSchema

from belvo_client.type.owners_paginated_response import OwnersPaginatedResponse
from belvo_client.type.owners_list_response import OwnersListResponse
...
DisplayNameIcontainsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'display_name__icontains': typing.Union[DisplayNameIcontainsSchema, str, ],
        'email': typing.Union[EmailSchema, str, ],
        'id': typing.Union[IdSchema, str, ],
        'id__in': typing.Union[IdInSchema, str, ],
        'link': typing.Union[LinkSchema, str, ],
...
request_query_display_name__icontains = api_client.QueryParameter(
    name="display_name__icontains",
    style=api_client.ParameterStyle.FORM,
    schema=DisplayNameIcontainsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = OwnersPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OwnersPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = OwnersListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OwnersListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        display_name__icontains: typing.Optional[str] = None,
        ...
        if display_name__icontains is not None:
            _query_params["display_name__icontains"] = display_name__icontains
    ...
    async def _alist_oapg(
        ...
        for parameter in (
            ...
            request_query_display_name__icontains,
            request_query_email,
            request_query_id,
