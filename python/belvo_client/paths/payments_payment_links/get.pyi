...
from belvo_client.model.payment_link_paginated_response import PaymentLinkPaginatedResponse as PaymentLinkPaginatedResponseSchema
from belvo_client.model.payment_links_list_response import PaymentLinksListResponse as PaymentLinksListResponseSchema

from belvo_client.type.payment_links_list_response import PaymentLinksListResponse
from belvo_client.type.payment_link_paginated_response import PaymentLinkPaginatedResponse
...
SchemaFor200ResponseBodyApplicationJson = PaymentLinkPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentLinkPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = PaymentLinksListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: PaymentLinksListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        if ordering is not None:
            _query_params["ordering"] = ordering
