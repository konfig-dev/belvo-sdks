...
from belvo_client.model.customer_paginated_response import CustomerPaginatedResponse as CustomerPaginatedResponseSchema
from belvo_client.model.customers_list_response import CustomersListResponse as CustomersListResponseSchema

from belvo_client.type.customer_paginated_response import CustomerPaginatedResponse
from belvo_client.type.customers_list_response import CustomersListResponse
...
CustomerTypeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'customer__type': typing.Union[CustomerTypeSchema, str, ],
...
request_query_customer__type = api_client.QueryParameter(
    name="customer__type",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = CustomerPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomerPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = CustomersListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CustomersListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        customer__type: typing.Optional[str] = None,
        ...
        if customer__type is not None:
            _query_params["customer__type"] = customer__type
