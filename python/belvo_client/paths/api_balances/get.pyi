...
from belvo_client.model.balances_list_response import BalancesListResponse as BalancesListResponseSchema
from belvo_client.model.balances_paginated_response import BalancesPaginatedResponse as BalancesPaginatedResponseSchema

from belvo_client.type.balances_list_response import BalancesListResponse
from belvo_client.type.balances_paginated_response import BalancesPaginatedResponse
...
SchemaFor200ResponseBodyApplicationJson = BalancesPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BalancesPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = BalancesListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: BalancesListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        account__type: typing.Optional[str] = None,
        account__type__in: typing.Optional[str] = None,
        balance: typing.Optional[str] = None,
        balance__lt: typing.Optional[str] = None,
        balance__lte: typing.Optional[str] = None,
        balance__gt: typing.Optional[str] = None,
        balance__gte: typing.Optional[str] = None,
        balance__range: typing.Optional[str] = None,
        ...
        if account__type is not None:
            _query_params["account__type"] = account__type
        if account__type__in is not None:
            _query_params["account__type__in"] = account__type__in
        if balance is not None:
            _query_params["balance"] = balance
        if balance__lt is not None:
            _query_params["balance__lt"] = balance__lt
        if balance__lte is not None:
            _query_params["balance__lte"] = balance__lte
        if balance__gt is not None:
            _query_params["balance__gt"] = balance__gt
        if balance__gte is not None:
            _query_params["balance__gte"] = balance__gte
        if balance__range is not None:
            _query_params["balance__range"] = balance__range
...
class List(BaseApi):
    ...
    async def alist(
        ...
        args = self._list_mapped_args(
            ...
            account__type=account__type,
            account__type__in=account__type__in,
            balance=balance,
            balance__lt=balance__lt,
            balance__lte=balance__lte,
            balance__gt=balance__gt,
            balance__gte=balance__gte,
            balance__range=balance__range,
            currency=currency,
