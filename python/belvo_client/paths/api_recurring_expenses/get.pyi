...
from belvo_client.model.recurring_expenses_list_response import RecurringExpensesListResponse as RecurringExpensesListResponseSchema
from belvo_client.model.recurring_expenses_paginated_response import RecurringExpensesPaginatedResponse as RecurringExpensesPaginatedResponseSchema

from belvo_client.type.recurring_expenses_list_response import RecurringExpensesListResponse
from belvo_client.type.recurring_expenses_paginated_response import RecurringExpensesPaginatedResponse
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'account_in': typing.Union[AccountInSchema, str, ],
...
request_query_account_in = api_client.QueryParameter(
    name="account_in",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = RecurringExpensesPaginatedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RecurringExpensesPaginatedResponse
...
SchemaFor401ResponseBodyApplicationJson = RecurringExpensesListResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: RecurringExpensesListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        if account_in is not None:
            _query_params["account_in"] = account_in
        if id is not None:
            _query_params["id"] = id
