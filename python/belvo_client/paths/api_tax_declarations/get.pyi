...
from belvo_client.model.tax_declarations_list_response import TaxDeclarationsListResponse as TaxDeclarationsListResponseSchema
from belvo_client.model.tax_declarations_list401_response import TaxDeclarationsList401Response as TaxDeclarationsList401ResponseSchema

from belvo_client.type.tax_declarations_list_response import TaxDeclarationsListResponse
from belvo_client.type.tax_declarations_list401_response import TaxDeclarationsList401Response
...
YearGtSchema = schemas.StrSchema
YearGteSchema = schemas.StrSchema
YearLtSchema = schemas.StrSchema
YearLteSchema = schemas.StrSchema
YearRangeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'year__gt': typing.Union[YearGtSchema, str, ],
        'year__gte': typing.Union[YearGteSchema, str, ],
        'year__lt': typing.Union[YearLtSchema, str, ],
        'year__lte': typing.Union[YearLteSchema, str, ],
        'year__range': typing.Union[YearRangeSchema, str, ],
    },
    total=False
)
...
request_query_year__gt = api_client.QueryParameter(
    name="year__gt",
    style=api_client.ParameterStyle.FORM,
    schema=YearGtSchema,
    explode=True,
)
request_query_year__gte = api_client.QueryParameter(
    name="year__gte",
    style=api_client.ParameterStyle.FORM,
    schema=YearGteSchema,
    explode=True,
)
request_query_year__lt = api_client.QueryParameter(
    name="year__lt",
    style=api_client.ParameterStyle.FORM,
    schema=YearLtSchema,
    explode=True,
)
request_query_year__lte = api_client.QueryParameter(
    name="year__lte",
    style=api_client.ParameterStyle.FORM,
    schema=YearLteSchema,
    explode=True,
)
request_query_year__range = api_client.QueryParameter(
    name="year__range",
    style=api_client.ParameterStyle.FORM,
    schema=YearRangeSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = TaxDeclarationsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TaxDeclarationsListResponse
...
SchemaFor401ResponseBodyApplicationJson = TaxDeclarationsList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: TaxDeclarationsList401Response
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        year__gt: typing.Optional[str] = None,
        year__gte: typing.Optional[str] = None,
        year__lt: typing.Optional[str] = None,
        year__lte: typing.Optional[str] = None,
        year__range: typing.Optional[str] = None,
        ...
        if year__gt is not None:
            _query_params["year__gt"] = year__gt
        if year__gte is not None:
            _query_params["year__gte"] = year__gte
        if year__lt is not None:
            _query_params["year__lt"] = year__lt
        if year__lte is not None:
            _query_params["year__lte"] = year__lte
        if year__range is not None:
            _query_params["year__range"] = year__range
    ...
    async def _alist_oapg(
        ...
        for parameter in (
            ...
            request_query_year,
            request_query_year__gt,
            request_query_year__gte,
            request_query_year__lt,
            request_query_year__lte,
            request_query_year__range,
        ):
