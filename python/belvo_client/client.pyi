...
from belvo_client.client_custom import ClientCustom
from belvo_client.configuration import Configuration
from belvo_client.api_client import ApiClient
from belvo_client.type_util import copy_signature
...
class Belvo(ClientCustom):
    ...
    def __init__(self, configuration: typing.Union[Configuration, None] = None, **kwargs):
        ...
        self.categorization: CategorizationApi = CategorizationApi(api_client)
        self.customers: CustomersApi = CustomersApi(api_client)
        self.employment_records: EmploymentRecordsApi = EmploymentRecordsApi(api_client)
        self.income_verification: IncomeVerificationApi = IncomeVerificationApi(api_client)
        self.incomes: IncomesApi = IncomesApi(api_client)
        self.institutions: InstitutionsApi = InstitutionsApi(api_client)
        self.investment_portfolios: InvestmentPortfoliosApi = InvestmentPortfoliosApi(api_client)
        self.invoices: InvoicesApi = InvoicesApi(api_client)
        self.links: LinksApi = LinksApi(api_client)
        self.owners: OwnersApi = OwnersApi(api_client)
        self.payment_institutions: PaymentInstitutionsApi = PaymentInstitutionsApi(api_client)
        self.payment_intents: PaymentIntentsApi = PaymentIntentsApi(api_client)
        self.payment_links: PaymentLinksApi = PaymentLinksApi(api_client)
        self.payment_transactions: PaymentTransactionsApi = PaymentTransactionsApi(api_client)
        self.receivable_transactions: ReceivableTransactionsApi = ReceivableTransactionsApi(api_client)
        self.recurring_expenses: RecurringExpensesApi = RecurringExpensesApi(api_client)
        self.risk_insights: RiskInsightsApi = RiskInsightsApi(api_client)
        self.secret_keys: SecretKeysApi = SecretKeysApi(api_client)
        self.tax_compliance_status: TaxComplianceStatusApi = TaxComplianceStatusApi(api_client)
        self.tax_declarations: TaxDeclarationsApi = TaxDeclarationsApi(api_client)
        self.tax_retentions: TaxRetentionsApi = TaxRetentionsApi(api_client)
        self.tax_returns: TaxReturnsApi = TaxReturnsApi(api_client)
        self.tax_status: TaxStatusApi = TaxStatusApi(api_client)
