...
class ReceivablesTransactionsPaginatedResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReceivablesTransaction']:
                        return ReceivablesTransaction
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReceivablesTransaction'], typing.List['ReceivablesTransaction']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ReceivablesTransaction':
