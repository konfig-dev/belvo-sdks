...
class PaymentLinkCallbackUrlsResponse(
    schemas.DictSchema
):
    """
...
**Note:** This field will return an empty object if your integration only generates payment links through the [Belvo Dashboard](https://dashboard.belvo.com/).
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cancel", "success", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cancel", "success", ], str]):
