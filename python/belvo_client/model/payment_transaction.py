...
class PaymentTransaction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def transaction_type() -> typing.Type['EnumPaymentTransactionType']:
                return EnumPaymentTransactionType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["transaction_type"]) -> 'EnumPaymentTransactionType': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "created_at", "created_by", "amount", "currency", "transaction_type", "beneficiary", "payer", "payment_intent", "customer", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["transaction_type"]) -> 'EnumPaymentTransactionType': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "created_at", "created_by", "amount", "currency", "transaction_type", "beneficiary", "payer", "payment_intent", "customer", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        charge: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        payer: typing.Union[MetaOapg.properties.payer, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
