...
class TaxStatusSat(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tax_payer_information() -> typing.Type['TaxStatusTaxPayerInformationSat']:
                return TaxStatusTaxPayerInformationSat
        
            @staticmethod
            def address() -> typing.Type['TaxStatusAddressSat']:
                return TaxStatusAddressSat
            ...
            class economic_activity(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxStatusEconomicActivitySat']:
                        return TaxStatusEconomicActivitySat
            ...
            class obligations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxStatusObligationsSat']:
                        return TaxStatusObligationsSat
            ...
            class regimens(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxStatusRegimensSat']:
                        return TaxStatusRegimensSat
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tax_payer_information"]) -> 'TaxStatusTaxPayerInformationSat': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'TaxStatusAddressSat': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tax_payer_information"]) -> 'TaxStatusTaxPayerInformationSat': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> 'TaxStatusAddressSat': ...
