...
class TaxDeclarationIndividualPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxDeclarationIndividual']:
                        return TaxDeclarationIndividual
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxDeclarationIndividual'], typing.List['TaxDeclarationIndividual']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxDeclarationIndividual':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count"], typing_extensions.Literal["next"], typing_extensions.Literal["previous"], typing_extensions.Literal["results"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count"], typing_extensions.Literal["next"], typing_extensions.Literal["previous"], typing_extensions.Literal["results"], ]):
