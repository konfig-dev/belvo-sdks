...
class InvestmentsPortfoliosPaginatedResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InvestmentsPortfolio']:
                        return InvestmentsPortfolio
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InvestmentsPortfolio'], typing.List['InvestmentsPortfolio']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'InvestmentsPortfolio':
