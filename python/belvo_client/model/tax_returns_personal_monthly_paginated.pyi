...
class TaxReturnsPersonalMonthlyPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxReturnPersonalMonthly']:
                        return TaxReturnPersonalMonthly
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxReturnPersonalMonthly'], typing.List['TaxReturnPersonalMonthly']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxReturnPersonalMonthly':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count"], typing_extensions.Literal["next"], typing_extensions.Literal["previous"], typing_extensions.Literal["results"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count"], typing_extensions.Literal["next"], typing_extensions.Literal["previous"], typing_extensions.Literal["results"], str, ]):
