...
class LinksPutRequest(
    ...
    institution: schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["password", "password2", "token", "username_type", "certificate", "private_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["password", "password2", "token", "username_type", "certificate", "private_key", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        institution: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        password: typing.Union[MetaOapg.properties.password, str, ],
        username: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
