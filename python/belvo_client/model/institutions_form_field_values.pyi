...
class InstitutionsFormFieldValues(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "label", "validation", "validation_message", "placeholder", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "label", "validation", "validation_message", "placeholder", ], str]):
