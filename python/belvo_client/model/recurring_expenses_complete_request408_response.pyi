...
class RecurringExpensesCompleteRequest408Response(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RequestTimeoutError']:
            return RequestTimeoutError

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['RequestTimeoutError'], typing.List['RequestTimeoutError']],
    ...
    def __getitem__(self, i: int) -> 'RequestTimeoutError':
