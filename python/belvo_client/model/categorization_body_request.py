...
class CategorizationBodyRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "transaction_id", "account_holder_type", "account_holder_id", "account_id", "account_category", "value_date", "type", "amount", "currency", "institution", "mcc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "transaction_id", "account_holder_type", "account_holder_id", "account_id", "account_category", "value_date", "type", "amount", "currency", "institution", "mcc", ], str]):
