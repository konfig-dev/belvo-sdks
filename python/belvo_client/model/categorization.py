        ...
        class properties:
            ...
            class transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CategorizationBody']:
                        return CategorizationBody
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CategorizationBody'], typing.List['CategorizationBody']],
                ...
                def __getitem__(self, i: int) -> 'CategorizationBody':
