...
class InvoicesPayrollSat(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            payment_date = schemas.DateSchema
    ...
    payment_date: MetaOapg.properties.payment_date
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "days", "type", "amount", "date_from", "date_to", "payment_date", "collected_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_date"]) -> MetaOapg.properties.payment_date: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "days", "type", "amount", "date_from", "date_to", "payment_date", "collected_at", ], str]):
