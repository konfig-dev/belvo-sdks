...
class RecevablesTransactionFees(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def type() -> typing.Type['EnumReceivableTransactionFeeType']:
                return EnumReceivableTransactionFeeType
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["type"]) -> 'EnumReceivableTransactionFeeType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["type"]) -> 'EnumReceivableTransactionFeeType': ...
