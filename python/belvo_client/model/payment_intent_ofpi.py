...
class PaymentIntentOfpi(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment_method_information() -> typing.Type['PaymentMethodInformationOfpi']:
                return PaymentMethodInformationOfpi
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_method_information"]) -> 'PaymentMethodInformationOfpi': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_method_information"]) -> 'PaymentMethodInformationOfpi': ...
