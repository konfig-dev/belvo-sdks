...
class Balance(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "account", "value_date", "balance", "current_balance", "statement", "collected_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "account", "value_date", "balance", "current_balance", "statement", "collected_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        value_date: typing.Union[MetaOapg.properties.value_date, str, date, schemas.Unset] = schemas.unset,
        ...
        statement: typing.Union[MetaOapg.properties.statement, None, str, schemas.Unset] = schemas.unset,
