...
class CreatePaymentLinkOfpi(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class amount(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'^(?!0$)(?:0\.\d{1,2}|[1-9]\d{0,11})(?:\.\d{1,2})?$',
                    }]
            ...
            @staticmethod
            def payment_method_details() -> typing.Type['PaymentMethodDetailsOfpi']:
                return PaymentMethodDetailsOfpi
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_method_details"]) -> 'PaymentMethodDetailsOfpi': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "amount", "customer", "allowed_payment_method_types", "provider", "payment_method_details", "callback_urls", "expires_in", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_method_details"]) -> 'PaymentMethodDetailsOfpi': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "amount", "customer", "allowed_payment_method_types", "provider", "payment_method_details", "callback_urls", "expires_in", ], str]):
