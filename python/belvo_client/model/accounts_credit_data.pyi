...
class AccountsCreditData(
    ...
    no_interest_payment: MetaOapg.properties.no_interest_payment
    credit_limit: MetaOapg.properties.credit_limit
    minimum_payment: MetaOapg.properties.minimum_payment
    interest_rate: MetaOapg.properties.interest_rate
    cutting_date: MetaOapg.properties.cutting_date
    collected_at: MetaOapg.properties.collected_at
    next_payment_date: MetaOapg.properties.next_payment_date
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["minimum_payment"]) -> MetaOapg.properties.minimum_payment: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["credit_limit", "collected_at", "cutting_date", "next_payment_date", "minimum_payment", "no_interest_payment", "interest_rate", "end_date", "monthly_payment", "last_payment_date", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["credit_limit"]) -> MetaOapg.properties.credit_limit: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["collected_at"]) -> MetaOapg.properties.collected_at: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cutting_date"]) -> MetaOapg.properties.cutting_date: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["next_payment_date"]) -> MetaOapg.properties.next_payment_date: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["minimum_payment"]) -> MetaOapg.properties.minimum_payment: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["no_interest_payment"]) -> MetaOapg.properties.no_interest_payment: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interest_rate"]) -> MetaOapg.properties.interest_rate: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["credit_limit", "collected_at", "cutting_date", "next_payment_date", "minimum_payment", "no_interest_payment", "interest_rate", "end_date", "monthly_payment", "last_payment_date", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        monthly_payment: typing.Union[MetaOapg.properties.monthly_payment, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
