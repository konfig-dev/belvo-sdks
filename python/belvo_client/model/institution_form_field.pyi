...
class InstitutionFormField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "label", "validation", "placeholder", "validation_message", "values", "length", "optional", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "label", "validation", "placeholder", "validation_message", "values", "length", "optional", ], str]):
