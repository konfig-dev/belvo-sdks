...
class CreatePaymentIntentPse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment_method_details() -> typing.Type['PaymentIntentsPaymentMethodDetailsPse']:
                return PaymentIntentsPaymentMethodDetailsPse
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_method_details"]) -> 'PaymentIntentsPaymentMethodDetailsPse': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "amount", "customer", "allowed_payment_method_types", "payment_method_details", "provider", "metadata", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_method_details"]) -> 'PaymentIntentsPaymentMethodDetailsPse': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "amount", "customer", "allowed_payment_method_types", "payment_method_details", "provider", "metadata", ], str]):
