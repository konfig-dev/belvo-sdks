        ...
        class properties:
            ...
            class related_documents(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InvoicesPaymentsRelatedDocumentsSat']:
                        return InvoicesPaymentsRelatedDocumentsSat
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InvoicesPaymentsRelatedDocumentsSat'], typing.List['InvoicesPaymentsRelatedDocumentsSat']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'related_documents':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'InvoicesPaymentsRelatedDocumentsSat':
