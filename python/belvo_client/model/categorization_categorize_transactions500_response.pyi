...
class CategorizationCategorizeTransactions500Response(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UnexpectedError']:
            return UnexpectedError

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['UnexpectedError'], typing.List['UnexpectedError']],
    ...
    def __getitem__(self, i: int) -> 'UnexpectedError':
