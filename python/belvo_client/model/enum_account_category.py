...
We return one of the following enum values:
  ...
  - `null`
    ...
    @schemas.classproperty
    def INVESTMENT_ACCOUNT(cls):
        return cls("INVESTMENT_ACCOUNT")
    
    @schemas.classproperty
    def LOAN_ACCOUNT(cls):
        return cls("LOAN_ACCOUNT")
    
    @schemas.classproperty
    def PENSION_FUND_ACCOUNT(cls):
        return cls("PENSION_FUND_ACCOUNT")
    
    @schemas.classproperty
    def RECEIVABLES_ACCOUNT(cls):
        return cls("RECEIVABLES_ACCOUNT")
    
    @schemas.classproperty
    def SAVINGS_ACCOUNT(cls):
        return cls("SAVINGS_ACCOUNT")
