...
class EnumInvoiceDianInvoiceType(
    schemas.EnumBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
For Colombia's DIAN, we return one of the following values:
  ...
  - `Factura Electrónica de Venta`
    ...
    class MetaOapg:
        enum_value_to_name = {
            "Factura Electrónica de Venta": "FACTURA_ELECTRNICA_DE_VENTA",
        }
    
    @schemas.classproperty
    def FACTURA_ELECTRNICA_DE_VENTA(cls):
        return cls("Factura Electrónica de Venta")
