...
class PatchPaymentIntentPse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payment_method_details", "confirm", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payment_method_details", "confirm", ], str]):
