...
class PatchBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["session", "link", "token", "save_data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["session", "link", "token", "save_data", ], str]):
