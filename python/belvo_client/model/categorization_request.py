...
class CategorizationRequest(
        ...
        class properties:
            ...
            class transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CategorizationBodyRequest']:
                        return CategorizationBodyRequest
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CategorizationBodyRequest'], typing.List['CategorizationBodyRequest']],
                ...
                def __getitem__(self, i: int) -> 'CategorizationBodyRequest':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["language", "transactions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["language", "transactions", ], str]):
