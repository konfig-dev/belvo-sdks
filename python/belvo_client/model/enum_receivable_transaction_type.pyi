...
class EnumReceivableTransactionType(
    schemas.EnumBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
We return one of the following values:
  ...
  - `null`
    ...
    def VISA_CREDIT(cls):
        return cls("VISA_CREDIT")
    
    @schemas.classproperty
    def VISA_DEBIT(cls):
        return cls("VISA_DEBIT")
    
    @schemas.classproperty
    def MASTERCARD_CREDIT(cls):
        return cls("MASTERCARD_CREDIT")
    
    @schemas.classproperty
    def MASTERCARD_DEBIT(cls):
        return cls("MASTERCARD_DEBIT")
    
    @schemas.classproperty
    def ELO_CREDIT(cls):
        return cls("ELO_CREDIT")
    
    @schemas.classproperty
    def ELO_DEBIT(cls):
        return cls("ELO_DEBIT")
