...
class RecurringExpensesRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link", "token", "save_data", "date_from", "date_to", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link", "token", "save_data", "date_from", "date_to", ], str]):
