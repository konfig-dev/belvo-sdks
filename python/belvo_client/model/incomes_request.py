...
class IncomesRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link", "allowed_income_types", "minimum_confidence_level", "date_from", "date_to", "token", "save_data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link", "allowed_income_types", "minimum_confidence_level", "date_from", "date_to", "token", "save_data", ], str]):
