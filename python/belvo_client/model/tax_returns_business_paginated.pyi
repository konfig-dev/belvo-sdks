...
class TaxReturnsBusinessPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxReturnBusiness']:
                        return TaxReturnBusiness
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxReturnBusiness'], typing.List['TaxReturnBusiness']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxReturnBusiness':
