...
class SecretKeysPaginatedResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SecretKeys']:
                        return SecretKeys
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SecretKeys'], typing.List['SecretKeys']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'SecretKeys':
