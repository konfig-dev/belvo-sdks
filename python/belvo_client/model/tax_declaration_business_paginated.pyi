...
class TaxDeclarationBusinessPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxDeclarationBusiness']:
                        return TaxDeclarationBusiness
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxDeclarationBusiness'], typing.List['TaxDeclarationBusiness']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxDeclarationBusiness':
