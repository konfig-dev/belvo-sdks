...
class TaxReturnsBusinessMonthlyPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxReturnBusinessMonthly']:
                        return TaxReturnBusinessMonthly
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxReturnBusinessMonthly'], typing.List['TaxReturnBusinessMonthly']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxReturnBusinessMonthly':
