...
class AccountsReceivablesData(
    ...
    anticipated: MetaOapg.properties.anticipated
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["anticipated"]) -> MetaOapg.properties.anticipated: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current", "available", "anticipated", "collected_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["anticipated"]) -> MetaOapg.properties.anticipated: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current", "available", "anticipated", "collected_at", ], str]):
