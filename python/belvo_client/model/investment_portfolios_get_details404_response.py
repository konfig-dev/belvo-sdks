...
class InvestmentPortfoliosGetDetails404Response(
    schemas.ListSchema
):
    """NOTE:
  ...
  - used an ID (for a link, account, transaction, and so on) that is not associated with your Belvo account.
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['NotFoundError']:
            return NotFoundError

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['NotFoundError'], typing.List['NotFoundError']],
    ...
    def __getitem__(self, i: int) -> 'NotFoundError':
