...
class RecurringExpenseSourceTransaction(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "amount", "value_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "amount", "value_date", ], str]):
