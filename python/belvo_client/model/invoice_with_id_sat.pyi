...
class InvoiceWithIdSat(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def invoice_type() -> typing.Type['EnumInvoiceSatInvoiceType']:
                return EnumInvoiceSatInvoiceType
            ...
            class invoice_details(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InvoiceDetailSat']:
                        return InvoiceDetailSat
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InvoiceDetailSat'], typing.List['InvoiceDetailSat']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'invoice_details':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'InvoiceDetailSat':
            ...
            class payments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InvoicesPaymentsSat']:
                        return InvoicesPaymentsSat
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InvoicesPaymentsSat'], typing.List['InvoicesPaymentsSat']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'payments':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'InvoicesPaymentsSat':
                    return super().__getitem__(i)
        
            @staticmethod
            def payroll() -> typing.Type['InvoicesPayrollSat']:
                return InvoicesPayrollSat
            ...
            @staticmethod
            def payment_method() -> typing.Type['EnumInvoiceSatPaymentMethod']:
                return EnumInvoiceSatPaymentMethod
            ...
            @staticmethod
            def warnings() -> typing.Type['InvoiceWarningsSat']:
                return InvoiceWarningsSat
            
            
            class sender_blacklist_status(
                schemas.StrBase,
                schemas.NoneBase,
                schemas.Schema,
                schemas.NoneStrMixin
            ...
            class receiver_blacklist_status(
                schemas.StrBase,
                schemas.NoneBase,
                schemas.Schema,
                schemas.NoneStrMixin
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invoice_type"]) -> 'EnumInvoiceSatInvoiceType': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payroll"]) -> 'InvoicesPayrollSat': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment_method"]) -> 'EnumInvoiceSatPaymentMethod': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["warnings"]) -> 'InvoiceWarningsSat': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sender_blacklist_status"]) -> MetaOapg.properties.sender_blacklist_status: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["receiver_blacklist_status"]) -> MetaOapg.properties.receiver_blacklist_status: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collected_at", "invoice_identification", "invoice_date", "status", "invoice_type", "type", "sender_id", "sender_name", "receiver_id", "receiver_name", "cancelation_status", "cancelation_update_date", "certification_date", "certification_authority", "payment_type", "payment_type_description", "invoice_details", "currency", "subtotal_amount", "exchange_rate", "tax_amount", "discount_amount", "total_amount", "payments", "payroll", "version", "id", "link", "created_at", "sender_tax_fraud_status", "receiver_tax_fraud_status", "payment_method", "payment_method_description", "usage", "place_of_issue", "folio", "xml", "warnings", "sender_blacklist_status", "receiver_blacklist_status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["invoice_type"]) -> 'EnumInvoiceSatInvoiceType': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payroll"]) -> 'InvoicesPayrollSat': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_method"]) -> typing.Union['EnumInvoiceSatPaymentMethod', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["warnings"]) -> typing.Union['InvoiceWarningsSat', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sender_blacklist_status"]) -> typing.Union[MetaOapg.properties.sender_blacklist_status, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["receiver_blacklist_status"]) -> typing.Union[MetaOapg.properties.receiver_blacklist_status, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment_method: typing.Union['EnumInvoiceSatPaymentMethod', schemas.Unset] = schemas.unset,
        ...
        warnings: typing.Union['InvoiceWarningsSat', schemas.Unset] = schemas.unset,
        sender_blacklist_status: typing.Union[MetaOapg.properties.sender_blacklist_status, None, str, schemas.Unset] = schemas.unset,
        receiver_blacklist_status: typing.Union[MetaOapg.properties.receiver_blacklist_status, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
