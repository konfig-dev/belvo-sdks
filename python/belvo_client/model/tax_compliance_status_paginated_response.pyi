...
class TaxComplianceStatusPaginatedResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxComplianceStatus']:
                        return TaxComplianceStatus
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxComplianceStatus'], typing.List['TaxComplianceStatus']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxComplianceStatus':
