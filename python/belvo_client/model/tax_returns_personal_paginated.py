...
class TaxReturnsPersonalPaginated(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaxReturnPersonal']:
                        return TaxReturnPersonal
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TaxReturnPersonal'], typing.List['TaxReturnPersonal']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaxReturnPersonal':
