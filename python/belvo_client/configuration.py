...
from belvo_client.exceptions_base import ApiValueError
from belvo_client.exceptions import ClientConfigurationError
from belvo_client.exceptions import InvalidHostConfigurationError
...
conf = belvo_client.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://sandbox.belvo.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("belvo_client")
