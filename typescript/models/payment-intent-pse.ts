...
// May contain unused imports in some cases
// @ts-ignore
import { EnumPaymentIntentStatus } from './enum-payment-intent-status';
// May contain unused imports in some cases
// @ts-ignore
import { EnumPaymentLinkAllowedPaymentMethod } from './enum-payment-link-allowed-payment-method';
// May contain unused imports in some cases
// @ts-ignore
import { EnumPaymentLinkProvider } from './enum-payment-link-provider';
// May contain unused imports in some cases
// @ts-ignore
import { EnumPaymentsCurrency } from './enum-payments-currency';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentPaymentMethodDetailsPse } from './payment-intent-payment-method-details-pse';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentPseLastError } from './payment-intent-pse-last-error';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentPseNextStep } from './payment-intent-pse-next-step';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentMethodInformationPse } from './payment-method-information-pse';

/**
 * 
 * @export
 * @interface PaymentIntentPse
 */
export interface PaymentIntentPse {
    /**
     * The description of the payment. 
     * @type {string}
     * @memberof PaymentIntentPse
     */
    'description': string;
    /**
     ...
     * @type {Array<EnumPaymentLinkAllowedPaymentMethod>}
     * @memberof PaymentIntentPse
     */
    'allowed_payment_method_types': Array<EnumPaymentLinkAllowedPaymentMethod>;
    /**
