...
// @ts-ignore
import { EnumLoanDataInterestRateType } from './enum-loan-data-interest-rate-type';

/**
 * Breakdown of the interest applied to the loan.
 * @export
 * @interface AccountsLoanDataInterestRate
 */
export interface AccountsLoanDataInterestRate {
    /**
     * The name of the type of interest rate applied to the loan.
     * @type {string}
     * @memberof AccountsLoanDataInterestRate
     */
    'name': string | null;
    /**
     * 
     ...
     * @memberof AccountsLoanDataInterestRate
     */
    'type': EnumLoanDataInterestRateType | null;
    /**
