...
// @ts-ignore
import { InvoicesPaymentsRelatedDocumentsSat } from './invoices-payments-related-documents-sat';

/**
 * 
 * @export
 * @interface InvoicesPaymentsSat
 */
export interface InvoicesPaymentsSat {
    /**
     * ISO-8601 timestamp when the payment was made. 
     * @type {string}
     * @memberof InvoicesPaymentsSat
     */
    'date': string | null;
    /**
     ...
     * @type {Array<InvoicesPaymentsRelatedDocumentsSat>}
     * @memberof InvoicesPaymentsSat
     */
    'related_documents': Array<InvoicesPaymentsRelatedDocumentsSat>;
}
