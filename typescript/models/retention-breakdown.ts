...
// @ts-ignore
import { EnumTaxRetentionPaymentStatus } from './enum-tax-retention-payment-status';
...
export interface RetentionBreakdown {
     ...
     * @memberof RetentionBreakdown
     */
    'payment_status': EnumTaxRetentionPaymentStatus | null;
}
