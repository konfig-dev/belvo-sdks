...
// @ts-ignore
import { TaxComplianceStatus } from './tax-compliance-status';

/**
 * 
 * @export
 * @interface TaxComplianceStatusPaginatedResponse
 */
export interface TaxComplianceStatusPaginatedResponse {
    /**
     * The total number of results in your Belvo account.
     * @type {number}
     * @memberof TaxComplianceStatusPaginatedResponse
     */
    'count'?: number;
    /**
     ...
     * @type {Array<TaxComplianceStatus>}
     * @memberof TaxComplianceStatusPaginatedResponse
     */
    'results'?: Array<TaxComplianceStatus>;
}
