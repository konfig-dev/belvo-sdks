...
// May contain unused imports in some cases
// @ts-ignore
import { AccountsCreditData } from './accounts-credit-data';
// May contain unused imports in some cases
// @ts-ignore
import { AccountsFundsData } from './accounts-funds-data';
// May contain unused imports in some cases
// @ts-ignore
import { AccountsLoanData } from './accounts-loan-data';
// May contain unused imports in some cases
// @ts-ignore
import { AccountsReceivablesData } from './accounts-receivables-data';
// May contain unused imports in some cases
// @ts-ignore
import { EnumAccountCategory } from './enum-account-category';
// May contain unused imports in some cases
// @ts-ignore
...
export interface Account {
     ...
     * @memberof Account
     */
    'category': EnumAccountCategory | null;
    /**
     ...
     * @memberof Account
     */
    'credit_data': AccountsCreditData | null;
    /**
     * 
     * @type {AccountsLoanData}
     * @memberof Account
     */
    'loan_data': AccountsLoanData | null;
    /**
     * One or more funds that contribute to the the pension account.
     * @type {Array<AccountsFundsData>}
     * @memberof Account
     */
    'funds_data'?: Array<AccountsFundsData> | null;
    /**
     * 
     * @type {AccountsReceivablesData}
     * @memberof Account
     */
    'receivables_data'?: AccountsReceivablesData | null;
    /**
