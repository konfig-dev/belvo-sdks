...
// @ts-ignore
import { EnumLinkAccessModeResponse } from './enum-link-access-mode-response';
// May contain unused imports in some cases
// @ts-ignore
import { EnumLinkRefreshRate } from './enum-link-refresh-rate';
// May contain unused imports in some cases
// @ts-ignore
import { EnumLinkStatus } from './enum-link-status';
...
export interface Link {
    ...
    /**
     * 
     * @type {EnumLinkAccessModeResponse}
     * @memberof Link
     */
    'access_mode'?: EnumLinkAccessModeResponse | null;
    /**
    ...
    /**
     * 
     * @type {EnumLinkRefreshRate}
     * @memberof Link
     */
    'refresh_rate'?: EnumLinkRefreshRate | null;
}
