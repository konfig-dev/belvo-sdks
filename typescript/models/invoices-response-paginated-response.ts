...
// @ts-ignore
import { InvoicesResponsePaginatedResponseResultsInner } from './invoices-response-paginated-response-results-inner';

/**
 * 
 * @export
 * @interface InvoicesResponsePaginatedResponse
 */
export interface InvoicesResponsePaginatedResponse {
    /**
     * The total number of results in your Belvo account.
     * @type {number}
     * @memberof InvoicesResponsePaginatedResponse
     */
    'count'?: number;
    /**
     ...
     * @type {Array<InvoicesResponsePaginatedResponseResultsInner>}
     * @memberof InvoicesResponsePaginatedResponse
     */
    'results'?: Array<InvoicesResponsePaginatedResponseResultsInner>;
}
