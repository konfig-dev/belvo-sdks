...
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentOfpiLastError } from './payment-intent-ofpi-last-error';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentOfpiNextStep } from './payment-intent-ofpi-next-step';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentOfpiPaymentMethodDetails } from './payment-intent-ofpi-payment-method-details';
// May contain unused imports in some cases
// @ts-ignore
import { PaymentMethodInformationOfpi } from './payment-method-information-ofpi';

/**
 * 
 * @export
 * @interface PaymentIntentOfpi
 */
export interface PaymentIntentOfpi {
    /**
     * The description of the payment. 
     * @type {string}
     * @memberof PaymentIntentOfpi
     */
    'description': string;
    /**
    ...
    /**
     * 
     * @type {PaymentIntentOfpiLastError}
     * @memberof PaymentIntentOfpi
     */
    'last_error': PaymentIntentOfpiLastError;
    /**
     * 
