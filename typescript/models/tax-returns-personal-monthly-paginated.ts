 ...
 * 
 * @export
 * @interface TaxReturnsPersonalMonthlyPaginated
 */
export interface TaxReturnsPersonalMonthlyPaginated {
     ...
     * @type {number}
     * @memberof TaxReturnsPersonalMonthlyPaginated
     */
    'count'?: number;
    /**
     ...
     * @type {Array<TaxReturnPersonalMonthly>}
     * @memberof TaxReturnsPersonalMonthlyPaginated
     */
    'results'?: Array<TaxReturnPersonalMonthly>;
}
