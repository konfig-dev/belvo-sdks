...
// @ts-ignore
import { EnumTaxComplianceStatusOutcome } from './enum-tax-compliance-status-outcome';
...
export interface TaxComplianceStatus {
    ...
    /**
     * 
     * @type {EnumTaxComplianceStatusOutcome}
     * @memberof TaxComplianceStatus
     */
    'outcome'?: EnumTaxComplianceStatusOutcome | null;
}
