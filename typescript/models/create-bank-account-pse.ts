 ...
 * 
 * @export
 * @interface CreateBankAccountPse
 */
export interface CreateBankAccountPse {
    /**
     * 
     * @type {CreateBankAccountPseHolder}
     * @memberof CreateBankAccountPse
     */
    'holder': CreateBankAccountPseHolder;
    /**
     * 
     * @type {CreateBankAccountPseProviders}
     * @memberof CreateBankAccountPse
     */
    'providers': CreateBankAccountPseProviders;
    /**
