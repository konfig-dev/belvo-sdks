...
// May contain unused imports in some cases
// @ts-ignore
import { PaymentIntentsPaymentMethodDetailsPse } from './payment-intents-payment-method-details-pse';

/**
 * 
 * @export
 * @interface CreatePaymentIntentPse
 */
export interface CreatePaymentIntentPse {
    /**
     * The description of the payment. 
     * @type {string}
     * @memberof CreatePaymentIntentPse
     */
    'description': string;
    /**
