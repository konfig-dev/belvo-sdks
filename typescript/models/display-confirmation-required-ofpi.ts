...
// @ts-ignore
import { BeneficiaryBankAccountOfpi } from './beneficiary-bank-account-ofpi';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 * @interface DisplayConfirmationRequiredOfpi
 */
export interface DisplayConfirmationRequiredOfpi {
    /**
     * 
     * @type {BeneficiaryBankAccountOfpi}
     * @memberof DisplayConfirmationRequiredOfpi
     */
