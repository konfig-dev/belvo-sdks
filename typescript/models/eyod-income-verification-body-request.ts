...
// @ts-ignore
import { EnumIncomeVerificationAccountCategory } from './enum-income-verification-account-category';
// May contain unused imports in some cases
// @ts-ignore
import { EnumIncomeVerificationAccountHolderType } from './enum-income-verification-account-holder-type';
// May contain unused imports in some cases
// @ts-ignore
import { EnumIncomeVerificationType } from './enum-income-verification-type';

/**
 * 
 * @export
 * @interface EyodIncomeVerificationBodyRequest
 */
export interface EyodIncomeVerificationBodyRequest {
    /**
     * The description of the income.
     * @type {string}
     * @memberof EyodIncomeVerificationBodyRequest
     */
    'description': string;
    /**
     ...
     * @memberof EyodIncomeVerificationBodyRequest
     */
    'type': EnumIncomeVerificationType | null;
    /**
     * The income amount.
     * @type {number}
     * @memberof EyodIncomeVerificationBodyRequest
