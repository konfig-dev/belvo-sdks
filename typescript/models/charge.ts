...
// @ts-ignore
import { ChargePaymentMethodDetails } from './charge-payment-method-details';
// May contain unused imports in some cases
// @ts-ignore
import { ChargePaymentMethodInformation } from './charge-payment-method-information';
// May contain unused imports in some cases
// @ts-ignore
...
export interface Charge {
    ...
    /**
     * 
     * @type {ChargePaymentMethodInformation}
     * @memberof Charge
     */
    'payment_method_information': ChargePaymentMethodInformation;
    /**
...
type ChargeStatusEnum = 'PENDING' | 'SUCCEEDED' | 'FAILED'
