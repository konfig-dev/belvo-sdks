...
// @ts-ignore
import { EnumTransactionBillStatus } from './enum-transaction-bill-status';

/**
 * Additional data provided by the institution for credit card transactions.
 * @export
 * @interface TransactionCreditCardData
 */
export interface TransactionCreditCardData {
    /**
     * The ISO-8601 timestamp when the data point was collected.
     * @type {string}
     * @memberof TransactionCreditCardData
     */
    ...
    /**
     * 
     * @type {EnumTransactionBillStatus}
     * @memberof TransactionCreditCardData
     */
    'bill_status'?: EnumTransactionBillStatus | null;
    /**
