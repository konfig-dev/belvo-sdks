...
// @ts-ignore
import { TaxRetentions } from './tax-retentions';

/**
 * 
 * @export
 * @interface TaxRetentionsPaginatedResponse
 */
export interface TaxRetentionsPaginatedResponse {
    /**
     * The total number of results in your Belvo account.
     * @type {number}
     * @memberof TaxRetentionsPaginatedResponse
     */
    'count'?: number;
    /**
     ...
     * @type {Array<TaxRetentions>}
     * @memberof TaxRetentionsPaginatedResponse
     */
    'results'?: Array<TaxRetentions>;
}
