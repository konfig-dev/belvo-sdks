...
export interface TaxDeclarationIndividualPaginated {
     ...
     * @type {Array<TaxDeclarationIndividual>}
     * @memberof TaxDeclarationIndividualPaginated
     */
    'results'?: Array<TaxDeclarationIndividual>;
}
