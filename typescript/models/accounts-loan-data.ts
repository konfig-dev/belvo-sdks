...
// @ts-ignore
import { AccountsLoanDataFees } from './accounts-loan-data-fees';
// May contain unused imports in some cases
// @ts-ignore
import { AccountsLoanDataInterestRate } from './accounts-loan-data-interest-rate';

/**
 * The loan options associated with this account.
 * @export
 * @interface AccountsLoanData
 */
export interface AccountsLoanData {
    /**
     * The ISO-8601 timestamp when the data point was collected.
     * @type {string}
     * @memberof AccountsLoanData
     */
    'collected_at': string;
    /**
     ...
     * @type {Array<AccountsLoanDataInterestRate>}
     * @memberof AccountsLoanData
     */
    'interest_rates': Array<AccountsLoanDataInterestRate> | null;
    /**
     * Breakdown of the fees applied to the loan.
     * @type {Array<AccountsLoanDataFees>}
     * @memberof AccountsLoanData
     */
    'fees'?: Array<AccountsLoanDataFees> | null;
    /**
