...
// May contain unused imports in some cases
// @ts-ignore
import { InstitutionFormField } from './institution-form-field';

/**
 * 
 * @export
 * @interface PaymentInstitution
 */
export interface PaymentInstitution {
    /**
     * Belvo\'s unique ID to reference the institution.
     * @type {string}
     * @memberof PaymentInstitution
     */
    'id'?: string;
    /**
    ...
    /**
     * 
     * @type {Array<InstitutionFormField>}
     * @memberof PaymentInstitution
     */
    'form_fields'?: Array<InstitutionFormField>;
}
