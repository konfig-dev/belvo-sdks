...
// @ts-ignore
import { InstitutionsFormFieldValues } from './institutions-form-field-values';

/**
 * 
 * @export
 * @interface InstitutionFormField
 */
export interface InstitutionFormField {
    /**
     * The username, password, or username type field.
     * @type {string}
     * @memberof InstitutionFormField
     */
    'name'?: string;
    /**
     ...
     * @type {Array<InstitutionsFormFieldValues>}
     * @memberof InstitutionFormField
     */
    'values'?: Array<InstitutionsFormFieldValues>;
    /**
