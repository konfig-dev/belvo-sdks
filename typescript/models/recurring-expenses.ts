...
// May contain unused imports in some cases
// @ts-ignore
import { EnumRecurringExpenseCategory } from './enum-recurring-expense-category';
// May contain unused imports in some cases
// @ts-ignore
import { EnumRecurringExpenseFrequency } from './enum-recurring-expense-frequency';
// May contain unused imports in some cases
// @ts-ignore
import { EnumRecurringExpensePaymentType } from './enum-recurring-expense-payment-type';
// May contain unused imports in some cases
// @ts-ignore
import { RecurringExpenseSourceTransaction } from './recurring-expense-source-transaction';
...
export interface RecurringExpenses {
     ...
     * @type {Array<RecurringExpenseSourceTransaction>}
     * @memberof RecurringExpenses
     */
    'transactions': Array<RecurringExpenseSourceTransaction>;
    /**
     * 
     ...
     * @memberof RecurringExpenses
     */
    'payment_type': EnumRecurringExpensePaymentType | null;
}
