 ...
 * @export
 * @interface NextStepDisplayTokenRequiredPse
 */
export interface NextStepDisplayTokenRequiredPse {
    /**
     * The type of `next_step` you need to follow. 
     * @type {string}
     * @memberof NextStepDisplayTokenRequiredPse
     */
    'type'?: NextStepDisplayTokenRequiredPseTypeEnum;
    /**
     * 
     * @type {DisplayTokenRequiredContentPse}
     * @memberof NextStepDisplayTokenRequiredPse
     */
    'pse_display_token_required'?: DisplayTokenRequiredContentPse;
    /**
...
type NextStepDisplayTokenRequiredPseTypeEnum = 'pse_display_payment_method_information' | 'pse_display_credentials_required' | 'pse_display_needs_redirect' | 'pse_display_token_required' | 'pse_display_customer_bank_accounts' | 'pse_display_confirmation_required' | 'pse_display_payment_processing' | 'pse_display_payment_failed' | 'pse_display_payment_succeeded'
