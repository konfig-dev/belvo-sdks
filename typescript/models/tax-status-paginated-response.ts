...
// @ts-ignore
import { TaxStatusPaginatedResponseResultsInner } from './tax-status-paginated-response-results-inner';

/**
 * 
 * @export
 * @interface TaxStatusPaginatedResponse
 */
export interface TaxStatusPaginatedResponse {
    /**
     * The total number of results in your Belvo account.
     * @type {number}
     * @memberof TaxStatusPaginatedResponse
     */
    'count'?: number;
    /**
     ...
     * @type {Array<TaxStatusPaginatedResponseResultsInner>}
     * @memberof TaxStatusPaginatedResponse
     */
    'results'?: Array<TaxStatusPaginatedResponseResultsInner>;
}
