 ...
 * 
 * @export
 * @interface TaxReturnBusinessMonthly
 */
export interface TaxReturnBusinessMonthly {
     ...
     * @type {string}
     * @memberof TaxReturnBusinessMonthly
     */
    'id'?: string;
    /**
