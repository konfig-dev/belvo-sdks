...
export interface EmploymentRecordEntitlement {
    ...
    /**
     * 
     * @type {EnumEmploymentRecordStatus}
     * @memberof EmploymentRecordEntitlement
     */
    'status'?: EnumEmploymentRecordStatus | null;
}
