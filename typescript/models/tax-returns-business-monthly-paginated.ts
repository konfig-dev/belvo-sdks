 ...
 * 
 * @export
 * @interface TaxReturnsBusinessMonthlyPaginated
 */
export interface TaxReturnsBusinessMonthlyPaginated {
     ...
     * @type {number}
     * @memberof TaxReturnsBusinessMonthlyPaginated
     */
    'count'?: number;
    /**
     ...
     * @type {Array<TaxReturnBusinessMonthly>}
     * @memberof TaxReturnsBusinessMonthlyPaginated
     */
    'results'?: Array<TaxReturnBusinessMonthly>;
}
