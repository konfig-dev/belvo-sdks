...
// @ts-ignore
import { EnumInvestmentPortfolioType } from './enum-investment-portfolio-type';
// May contain unused imports in some cases
// @ts-ignore
import { InvestmentsPortfolioInstrument } from './investments-portfolio-instrument';

/**
 * 
 * @export
 * @interface InvestmentsPortfolio
 */
export interface InvestmentsPortfolio {
    /**
     * Belvo\'s unique ID for the current portfolio.
     * @type {string}
     * @memberof InvestmentsPortfolio
     */
    'id'?: string;
    /**
     ...
     * @type {Array<InvestmentsPortfolioInstrument>}
     * @memberof InvestmentsPortfolio
     */
    'instruments'?: Array<InvestmentsPortfolioInstrument> | null;
}
