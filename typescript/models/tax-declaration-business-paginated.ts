...
export interface TaxDeclarationBusinessPaginated {
     ...
     * @type {Array<TaxDeclarationBusiness>}
     * @memberof TaxDeclarationBusinessPaginated
     */
    'results'?: Array<TaxDeclarationBusiness>;
}
