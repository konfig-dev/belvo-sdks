...
// @ts-ignore
import { ReceivablesTransaction } from './receivables-transaction';

/**
 * 
 * @export
 * @interface ReceivablesTransactionsPaginatedResponse
 */
export interface ReceivablesTransactionsPaginatedResponse {
    /**
     * The total number of results in your Belvo account.
     * @type {number}
     * @memberof ReceivablesTransactionsPaginatedResponse
     */
    'count'?: number;
    /**
     ...
     * @type {Array<ReceivablesTransaction>}
     * @memberof ReceivablesTransactionsPaginatedResponse
     */
    'results'?: Array<ReceivablesTransaction>;
}
