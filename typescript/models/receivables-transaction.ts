...
// @ts-ignore
import { EnumReceivableTransactionStatus } from './enum-receivable-transaction-status';
// May contain unused imports in some cases
// @ts-ignore
import { EnumReceivableTransactionType } from './enum-receivable-transaction-type';
// May contain unused imports in some cases
// @ts-ignore
import { ReceivablesTransactionAccount } from './receivables-transaction-account';
// May contain unused imports in some cases
// @ts-ignore
import { ReceivablesTransactionNumberOfInstallments } from './receivables-transaction-number-of-installments';
// May contain unused imports in some cases
// @ts-ignore
import { RecevablesTransactionFees } from './recevables-transaction-fees';

/**
 * 
 * @export
 * @interface ReceivablesTransaction
 */
export interface ReceivablesTransaction {
    /**
     * Belvo\'s unique ID for the current receivable transaction.
     * @type {string}
     * @memberof ReceivablesTransaction
     */
    'id': string;
    /**
     * 
     ...
     * @memberof ReceivablesTransaction
     */
    'type': EnumReceivableTransactionType | null;
    /**
    ...
    /**
     * 
     * @type {Array<RecevablesTransactionFees>}
     * @memberof ReceivablesTransaction
     */
    'fees': Array<RecevablesTransactionFees>;
    /**
     * 
     * @type {EnumReceivableTransactionStatus}
     * @memberof ReceivablesTransaction
     */
    'status': EnumReceivableTransactionStatus | null;
    /**
     * 
     * @type {ReceivablesTransactionNumberOfInstallments}
     * @memberof ReceivablesTransaction
     */
    'number_of_installments': ReceivablesTransactionNumberOfInstallments | null;
}
