...
// May contain unused imports in some cases
// @ts-ignore
import { InvoiceDian } from './invoice-dian';
// May contain unused imports in some cases
// @ts-ignore
...
// May contain unused imports in some cases
// @ts-ignore
import { InvoiceWithIdSat } from './invoice-with-id-sat';
// May contain unused imports in some cases
// @ts-ignore
...
/**
 * @type InvoicesResponsePaginatedResponseResultsInner
 * @export
 */
export type InvoicesResponsePaginatedResponseResultsInner = InvoiceDian | InvoiceWithIdSat;
