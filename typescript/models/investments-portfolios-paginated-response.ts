...
export interface InvestmentsPortfoliosPaginatedResponse {
     ...
     * @type {Array<InvestmentsPortfolio>}
     * @memberof InvestmentsPortfoliosPaginatedResponse
     */
    'results'?: Array<InvestmentsPortfolio>;
}
