...
// @ts-ignore
import { TaxStatusAddressSat } from './tax-status-address-sat';
// May contain unused imports in some cases
// @ts-ignore
import { TaxStatusEconomicActivitySat } from './tax-status-economic-activity-sat';
// May contain unused imports in some cases
// @ts-ignore
import { TaxStatusObligationsSat } from './tax-status-obligations-sat';
// May contain unused imports in some cases
// @ts-ignore
import { TaxStatusRegimensSat } from './tax-status-regimens-sat';
// May contain unused imports in some cases
// @ts-ignore
import { TaxStatusTaxPayerInformationSat } from './tax-status-tax-payer-information-sat';

/**
 * 
 * @export
 * @interface TaxStatusSat
 */
export interface TaxStatusSat {
    /**
     * Unique identifier created by Belvo used to reference the current Tax Status.
     * @type {string}
     * @memberof TaxStatusSat
     */
    'id': string;
    /**
     ...
     * @memberof TaxStatusSat
     */
    'tax_payer_information': TaxStatusTaxPayerInformationSat | null;
    /**
     * 
     * @type {TaxStatusAddressSat}
     * @memberof TaxStatusSat
     */
    'address': TaxStatusAddressSat | null;
    /**
     * A list of economic activity objects. 
     * @type {Array<TaxStatusEconomicActivitySat>}
     * @memberof TaxStatusSat
     */
    'economic_activity': Array<TaxStatusEconomicActivitySat> | null;
    /**
     * A list of regimen objects. 
     * @type {Array<TaxStatusRegimensSat>}
     * @memberof TaxStatusSat
     */
    'regimens'?: Array<TaxStatusRegimensSat> | null;
    /**
     * Details regarding a business\'s obligations.  ℹ️ For non-business accounts, this field will return empty. 
     * @type {Array<TaxStatusObligationsSat>}
     * @memberof TaxStatusSat
     */
    'obligations': Array<TaxStatusObligationsSat> | null;
    /**
