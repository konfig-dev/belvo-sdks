...
const deleteResponse = await belvo.taxDeclarations.delete({
  id: "id_example",
});
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**] | The `tax-declration.id` that you want to delete. | defaults to undefined
...
const getDetailsResponse = await belvo.taxDeclarations.getDetails({
  id: "id_example",
  omit: "link,balance",
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**string**] | The `tax-declaration.id` you want to get detailed information about. | defaults to undefined
...
const listResponse = await belvo.taxDeclarations.list({
  page: 1,
  pageSize: 100,
  omit: "link,balance",
  fields: "link,balance,account",
 ...
 **createdAtGt** | [**string**] | Return tax declarations that were last updated in Belvo\'s database after this date (`YYYY-MM-DD` or full `ISO-8601` timestamp). | (optional) defaults to undefined
 **createdAtGte** | [**string**] | Return tax declarations that were last updated in Belvo\'s database after or on this date (`YYYY-MM-DD` or full `ISO-8601` timestamp). | (optional) defaults to undefined
 **createdAtLt** | [**string**] | Return tax declarations that were last updated in Belvo\'s database before this date (`YYYY-MM-DD` or full `ISO-8601` timestamp). | (optional) defaults to undefined
 **createdAtLte** | [**string**] | Return tax declarations that were last updated in Belvo\'s database before or on this date (`YYYY-MM-DD` or full `ISO-8601` timestamp). | (optional) defaults to undefined
 **createdAtRange** | [**string**] | Return tax declarations that were last updated in Belvo\'s database between two dates (`YYYY-MM-DD` or full `ISO-8601` timestamp). | (optional) defaults to undefined
 **id** | [**string**] | Return information for this `tax-declaration.id`. | (optional) defaults to undefined
 **idIn** | [**string**] | Return information for these `tax-declaration.id`s. | (optional) defaults to undefined
 **year** | [**string**] | Return tax declarations for this year (`YYYY`). | (optional) defaults to undefined
 **yearGt** | [**string**] | Return tax declarations for after this year (`YYYY`). | (optional) defaults to undefined
 **yearGte** | [**string**] | Return tax declarations for this year or after (`YYYY`). | (optional) defaults to undefined
 **yearLt** | [**string**] | Return tax declarations for before this year (`YYYY`). | (optional) defaults to undefined
 **yearLte** | [**string**] | Return tax declarations for this year or earlier (`YYYY`). | (optional) defaults to undefined
 **yearRange** | [**string**] | Return tax declarations between these two years (`YYYY`). | (optional) defaults to undefined
...
const retrieveResponse = await belvo.taxDeclarations.retrieve({
  omit: "link,balance",
  fields: "link,balance,account",
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **taxDeclarationsRequest** | **TaxDeclarationsRequest**|  |
 **omit** | [**string**] | Omit certain fields from being returned in the response. For more information, see our [Filtering responses](https://developers.belvo.com/docs/searching-and-filtering) DevPortal article. | (optional) defaults to undefined
 **fields** | [**string**] | Return only the specified fields in the response. For more information, see our [Filtering responses](https://developers.belvo.com/docs/searching-and-filtering) DevPortal article. | (optional) defaults to undefined
...
**Array<TaxDeclarationsRetrieveResponseInner>**
